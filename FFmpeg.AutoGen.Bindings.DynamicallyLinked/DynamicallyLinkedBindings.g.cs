...
public unsafe static partial class StaticallyLinkedBindings
{
    ...
    [DllImport("avcodec-59", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [DllImport("avdevice-59", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [Obsolete("")]
    [DllImport("avfilter-8", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [DllImport("avformat-59", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    /// <returns>b+c</returns>
    [DllImport("avutil-57", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    [DllImport("postproc-56", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [DllImport("swresample-4", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [DllImport("swscale-6", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    {
        delegates.av_codec_is_decoder = av_codec_is_decoder;
        delegates.av_codec_is_encoder = av_codec_is_encoder;
        delegates.av_codec_iterate = av_codec_iterate;
        delegates.av_cpb_properties_alloc = av_cpb_properties_alloc;
        delegates.av_d3d11va_alloc_context = av_d3d11va_alloc_context;
        delegates.av_fast_padded_malloc = av_fast_padded_malloc;
        delegates.av_fast_padded_mallocz = av_fast_padded_mallocz;
        delegates.av_get_audio_frame_duration = av_get_audio_frame_duration;
        delegates.av_get_audio_frame_duration2 = av_get_audio_frame_duration2;
        delegates.av_get_bits_per_sample = av_get_bits_per_sample;
        delegates.av_get_exact_bits_per_sample = av_get_exact_bits_per_sample;
        delegates.av_get_pcm_codec = av_get_pcm_codec;
        delegates.av_get_profile_name = av_get_profile_name;
        delegates.av_grow_packet = av_grow_packet;
        delegates.av_init_packet = av_init_packet;
        delegates.av_new_packet = av_new_packet;
        delegates.av_packet_add_side_data = av_packet_add_side_data;
        delegates.av_packet_alloc = av_packet_alloc;
        delegates.av_packet_clone = av_packet_clone;
        delegates.av_packet_copy_props = av_packet_copy_props;
        delegates.av_packet_free = av_packet_free;
        delegates.av_packet_free_side_data = av_packet_free_side_data;
        delegates.av_packet_from_data = av_packet_from_data;
        delegates.av_packet_get_side_data = av_packet_get_side_data;
        delegates.av_packet_make_refcounted = av_packet_make_refcounted;
        delegates.av_packet_make_writable = av_packet_make_writable;
        delegates.av_packet_move_ref = av_packet_move_ref;
        delegates.av_packet_new_side_data = av_packet_new_side_data;
        delegates.av_packet_pack_dictionary = av_packet_pack_dictionary;
        delegates.av_packet_ref = av_packet_ref;
        delegates.av_packet_rescale_ts = av_packet_rescale_ts;
        delegates.av_packet_shrink_side_data = av_packet_shrink_side_data;
        delegates.av_packet_side_data_name = av_packet_side_data_name;
        delegates.av_packet_unpack_dictionary = av_packet_unpack_dictionary;
        delegates.av_packet_unref = av_packet_unref;
        delegates.av_parser_close = av_parser_close;
        delegates.av_parser_init = av_parser_init;
        delegates.av_parser_iterate = av_parser_iterate;
        delegates.av_parser_parse2 = av_parser_parse2;
        delegates.av_shrink_packet = av_shrink_packet;
        delegates.av_xiphlacing = av_xiphlacing;
        delegates.avcodec_align_dimensions = avcodec_align_dimensions;
        delegates.avcodec_align_dimensions2 = avcodec_align_dimensions2;
        delegates.avcodec_alloc_context3 = avcodec_alloc_context3;
        delegates.avcodec_chroma_pos_to_enum = avcodec_chroma_pos_to_enum;
        delegates.avcodec_close = avcodec_close;
        delegates.avcodec_configuration = avcodec_configuration;
        delegates.avcodec_decode_subtitle2 = avcodec_decode_subtitle2;
        delegates.avcodec_default_execute = avcodec_default_execute;
        delegates.avcodec_default_execute2 = avcodec_default_execute2;
        delegates.avcodec_default_get_buffer2 = avcodec_default_get_buffer2;
        delegates.avcodec_default_get_encode_buffer = avcodec_default_get_encode_buffer;
        delegates.avcodec_default_get_format = avcodec_default_get_format;
        delegates.avcodec_descriptor_get = avcodec_descriptor_get;
        delegates.avcodec_descriptor_get_by_name = avcodec_descriptor_get_by_name;
        delegates.avcodec_descriptor_next = avcodec_descriptor_next;
        delegates.avcodec_encode_subtitle = avcodec_encode_subtitle;
        delegates.avcodec_enum_to_chroma_pos = avcodec_enum_to_chroma_pos;
        delegates.avcodec_fill_audio_frame = avcodec_fill_audio_frame;
        delegates.avcodec_find_best_pix_fmt_of_list = avcodec_find_best_pix_fmt_of_list;
        delegates.avcodec_find_decoder = avcodec_find_decoder;
        delegates.avcodec_find_decoder_by_name = avcodec_find_decoder_by_name;
        delegates.avcodec_find_encoder = avcodec_find_encoder;
        delegates.avcodec_find_encoder_by_name = avcodec_find_encoder_by_name;
        delegates.avcodec_flush_buffers = avcodec_flush_buffers;
        delegates.avcodec_free_context = avcodec_free_context;
        delegates.avcodec_get_class = avcodec_get_class;
        delegates.avcodec_get_frame_class = avcodec_get_frame_class;
        delegates.avcodec_get_hw_config = avcodec_get_hw_config;
        delegates.avcodec_get_hw_frames_parameters = avcodec_get_hw_frames_parameters;
        delegates.avcodec_get_name = avcodec_get_name;
        delegates.avcodec_get_subtitle_rect_class = avcodec_get_subtitle_rect_class;
        delegates.avcodec_get_type = avcodec_get_type;
        delegates.avcodec_is_open = avcodec_is_open;
        delegates.avcodec_license = avcodec_license;
        delegates.avcodec_open2 = avcodec_open2;
        delegates.avcodec_parameters_alloc = avcodec_parameters_alloc;
        delegates.avcodec_parameters_copy = avcodec_parameters_copy;
        delegates.avcodec_parameters_free = avcodec_parameters_free;
        delegates.avcodec_parameters_from_context = avcodec_parameters_from_context;
        delegates.avcodec_parameters_to_context = avcodec_parameters_to_context;
        delegates.avcodec_pix_fmt_to_codec_tag = avcodec_pix_fmt_to_codec_tag;
        delegates.avcodec_profile_name = avcodec_profile_name;
        delegates.avcodec_receive_frame = avcodec_receive_frame;
        delegates.avcodec_receive_packet = avcodec_receive_packet;
        delegates.avcodec_send_frame = avcodec_send_frame;
        delegates.avcodec_send_packet = avcodec_send_packet;
        delegates.avcodec_string = avcodec_string;
        delegates.avcodec_version = avcodec_version;
        delegates.avsubtitle_free = avsubtitle_free;
        delegates.av_input_audio_device_next = av_input_audio_device_next;
        delegates.av_input_video_device_next = av_input_video_device_next;
        delegates.av_output_audio_device_next = av_output_audio_device_next;
        delegates.av_output_video_device_next = av_output_video_device_next;
        delegates.avdevice_app_to_dev_control_message = avdevice_app_to_dev_control_message;
        delegates.avdevice_capabilities_create = avdevice_capabilities_create;
        delegates.avdevice_capabilities_free = avdevice_capabilities_free;
        delegates.avdevice_configuration = avdevice_configuration;
        delegates.avdevice_dev_to_app_control_message = avdevice_dev_to_app_control_message;
        delegates.avdevice_free_list_devices = avdevice_free_list_devices;
        delegates.avdevice_license = avdevice_license;
        delegates.avdevice_list_devices = avdevice_list_devices;
        delegates.avdevice_list_input_sources = avdevice_list_input_sources;
        delegates.avdevice_list_output_sinks = avdevice_list_output_sinks;
        delegates.avdevice_register_all = avdevice_register_all;
        delegates.avdevice_version = avdevice_version;
        delegates.av_abuffersink_params_alloc = av_abuffersink_params_alloc;
        delegates.av_buffersink_get_ch_layout = av_buffersink_get_ch_layout;
        delegates.av_buffersink_get_channel_layout = av_buffersink_get_channel_layout;
        delegates.av_buffersink_get_channels = av_buffersink_get_channels;
        delegates.av_buffersink_get_format = av_buffersink_get_format;
        delegates.av_buffersink_get_frame = av_buffersink_get_frame;
        delegates.av_buffersink_get_frame_flags = av_buffersink_get_frame_flags;
        delegates.av_buffersink_get_frame_rate = av_buffersink_get_frame_rate;
        delegates.av_buffersink_get_h = av_buffersink_get_h;
        delegates.av_buffersink_get_hw_frames_ctx = av_buffersink_get_hw_frames_ctx;
        delegates.av_buffersink_get_sample_aspect_ratio = av_buffersink_get_sample_aspect_ratio;
        delegates.av_buffersink_get_sample_rate = av_buffersink_get_sample_rate;
        delegates.av_buffersink_get_samples = av_buffersink_get_samples;
        delegates.av_buffersink_get_time_base = av_buffersink_get_time_base;
        delegates.av_buffersink_get_type = av_buffersink_get_type;
        delegates.av_buffersink_get_w = av_buffersink_get_w;
        delegates.av_buffersink_params_alloc = av_buffersink_params_alloc;
        delegates.av_buffersink_set_frame_size = av_buffersink_set_frame_size;
        delegates.av_buffersrc_add_frame = av_buffersrc_add_frame;
        delegates.av_buffersrc_add_frame_flags = av_buffersrc_add_frame_flags;
        delegates.av_buffersrc_close = av_buffersrc_close;
        delegates.av_buffersrc_get_nb_failed_requests = av_buffersrc_get_nb_failed_requests;
        delegates.av_buffersrc_parameters_alloc = av_buffersrc_parameters_alloc;
        delegates.av_buffersrc_parameters_set = av_buffersrc_parameters_set;
        delegates.av_buffersrc_write_frame = av_buffersrc_write_frame;
        delegates.av_filter_iterate = av_filter_iterate;
        delegates.avfilter_config_links = avfilter_config_links;
        delegates.avfilter_configuration = avfilter_configuration;
        delegates.avfilter_filter_pad_count = avfilter_filter_pad_count;
        delegates.avfilter_free = avfilter_free;
        delegates.avfilter_get_by_name = avfilter_get_by_name;
        delegates.avfilter_get_class = avfilter_get_class;
        delegates.avfilter_graph_alloc = avfilter_graph_alloc;
        delegates.avfilter_graph_alloc_filter = avfilter_graph_alloc_filter;
        delegates.avfilter_graph_config = avfilter_graph_config;
        delegates.avfilter_graph_create_filter = avfilter_graph_create_filter;
        delegates.avfilter_graph_dump = avfilter_graph_dump;
        delegates.avfilter_graph_free = avfilter_graph_free;
        delegates.avfilter_graph_get_filter = avfilter_graph_get_filter;
        delegates.avfilter_graph_parse = avfilter_graph_parse;
        delegates.avfilter_graph_parse_ptr = avfilter_graph_parse_ptr;
        delegates.avfilter_graph_parse2 = avfilter_graph_parse2;
        delegates.avfilter_graph_queue_command = avfilter_graph_queue_command;
        delegates.avfilter_graph_request_oldest = avfilter_graph_request_oldest;
        delegates.avfilter_graph_send_command = avfilter_graph_send_command;
        delegates.avfilter_graph_set_auto_convert = avfilter_graph_set_auto_convert;
        delegates.avfilter_init_dict = avfilter_init_dict;
        delegates.avfilter_init_str = avfilter_init_str;
        delegates.avfilter_inout_alloc = avfilter_inout_alloc;
        delegates.avfilter_inout_free = avfilter_inout_free;
        delegates.avfilter_insert_filter = avfilter_insert_filter;
        delegates.avfilter_license = avfilter_license;
        delegates.avfilter_link = avfilter_link;
        delegates.avfilter_link_free = avfilter_link_free;
        delegates.avfilter_pad_count = avfilter_pad_count;
        delegates.avfilter_pad_get_name = avfilter_pad_get_name;
        delegates.avfilter_pad_get_type = avfilter_pad_get_type;
        delegates.avfilter_process_command = avfilter_process_command;
        delegates.avfilter_version = avfilter_version;
        delegates.av_add_index_entry = av_add_index_entry;
        delegates.av_append_packet = av_append_packet;
        delegates.av_codec_get_id = av_codec_get_id;
        delegates.av_codec_get_tag = av_codec_get_tag;
        delegates.av_codec_get_tag2 = av_codec_get_tag2;
        delegates.av_demuxer_iterate = av_demuxer_iterate;
        delegates.av_disposition_from_string = av_disposition_from_string;
        delegates.av_disposition_to_string = av_disposition_to_string;
        delegates.av_dump_format = av_dump_format;
        delegates.av_filename_number_test = av_filename_number_test;
        delegates.av_find_best_stream = av_find_best_stream;
        delegates.av_find_default_stream_index = av_find_default_stream_index;
        delegates.av_find_input_format = av_find_input_format;
        delegates.av_find_program_from_stream = av_find_program_from_stream;
        delegates.av_fmt_ctx_get_duration_estimation_method = av_fmt_ctx_get_duration_estimation_method;
        delegates.av_format_inject_global_side_data = av_format_inject_global_side_data;
        delegates.av_get_frame_filename = av_get_frame_filename;
        delegates.av_get_frame_filename2 = av_get_frame_filename2;
        delegates.av_get_output_timestamp = av_get_output_timestamp;
        delegates.av_get_packet = av_get_packet;
        delegates.av_guess_codec = av_guess_codec;
        delegates.av_guess_format = av_guess_format;
        delegates.av_guess_frame_rate = av_guess_frame_rate;
        delegates.av_guess_sample_aspect_ratio = av_guess_sample_aspect_ratio;
        delegates.av_hex_dump = av_hex_dump;
        delegates.av_hex_dump_log = av_hex_dump_log;
        delegates.av_index_search_timestamp = av_index_search_timestamp;
        delegates.av_interleaved_write_frame = av_interleaved_write_frame;
        delegates.av_interleaved_write_uncoded_frame = av_interleaved_write_uncoded_frame;
        delegates.av_match_ext = av_match_ext;
        delegates.av_muxer_iterate = av_muxer_iterate;
        delegates.av_new_program = av_new_program;
        delegates.av_pkt_dump_log2 = av_pkt_dump_log2;
        delegates.av_pkt_dump2 = av_pkt_dump2;
        delegates.av_probe_input_buffer = av_probe_input_buffer;
        delegates.av_probe_input_buffer2 = av_probe_input_buffer2;
        delegates.av_probe_input_format = av_probe_input_format;
        delegates.av_probe_input_format2 = av_probe_input_format2;
        delegates.av_probe_input_format3 = av_probe_input_format3;
        delegates.av_program_add_stream_index = av_program_add_stream_index;
        delegates.av_read_frame = av_read_frame;
        delegates.av_read_pause = av_read_pause;
        delegates.av_read_play = av_read_play;
        delegates.av_sdp_create = av_sdp_create;
        delegates.av_seek_frame = av_seek_frame;
        delegates.av_stream_add_side_data = av_stream_add_side_data;
        delegates.av_stream_get_class = av_stream_get_class;
        delegates.av_stream_get_codec_timebase = av_stream_get_codec_timebase;
        delegates.av_stream_get_end_pts = av_stream_get_end_pts;
        delegates.av_stream_get_parser = av_stream_get_parser;
        delegates.av_stream_get_side_data = av_stream_get_side_data;
        delegates.av_stream_new_side_data = av_stream_new_side_data;
        delegates.av_url_split = av_url_split;
        delegates.av_write_frame = av_write_frame;
        delegates.av_write_trailer = av_write_trailer;
        delegates.av_write_uncoded_frame = av_write_uncoded_frame;
        delegates.av_write_uncoded_frame_query = av_write_uncoded_frame_query;
        delegates.avformat_alloc_context = avformat_alloc_context;
        delegates.avformat_alloc_output_context2 = avformat_alloc_output_context2;
        delegates.avformat_close_input = avformat_close_input;
        delegates.avformat_configuration = avformat_configuration;
        delegates.avformat_find_stream_info = avformat_find_stream_info;
        delegates.avformat_flush = avformat_flush;
        delegates.avformat_free_context = avformat_free_context;
        delegates.avformat_get_class = avformat_get_class;
        delegates.avformat_get_mov_audio_tags = avformat_get_mov_audio_tags;
        delegates.avformat_get_mov_video_tags = avformat_get_mov_video_tags;
        delegates.avformat_get_riff_audio_tags = avformat_get_riff_audio_tags;
        delegates.avformat_get_riff_video_tags = avformat_get_riff_video_tags;
        delegates.avformat_index_get_entries_count = avformat_index_get_entries_count;
        delegates.avformat_index_get_entry = avformat_index_get_entry;
        delegates.avformat_index_get_entry_from_timestamp = avformat_index_get_entry_from_timestamp;
        delegates.avformat_init_output = avformat_init_output;
        delegates.avformat_license = avformat_license;
        delegates.avformat_match_stream_specifier = avformat_match_stream_specifier;
        delegates.avformat_network_deinit = avformat_network_deinit;
        delegates.avformat_network_init = avformat_network_init;
        delegates.avformat_new_stream = avformat_new_stream;
        delegates.avformat_open_input = avformat_open_input;
        delegates.avformat_query_codec = avformat_query_codec;
        delegates.avformat_queue_attached_pictures = avformat_queue_attached_pictures;
        delegates.avformat_seek_file = avformat_seek_file;
        delegates.avformat_transfer_internal_stream_timing_info = avformat_transfer_internal_stream_timing_info;
        delegates.avformat_version = avformat_version;
        delegates.avformat_write_header = avformat_write_header;
        delegates.avio_accept = avio_accept;
        delegates.avio_alloc_context = avio_alloc_context;
        delegates.avio_check = avio_check;
        delegates.avio_close = avio_close;
        delegates.avio_close_dir = avio_close_dir;
        delegates.avio_close_dyn_buf = avio_close_dyn_buf;
        delegates.avio_closep = avio_closep;
        delegates.avio_context_free = avio_context_free;
        delegates.avio_enum_protocols = avio_enum_protocols;
        delegates.avio_feof = avio_feof;
        delegates.avio_find_protocol_name = avio_find_protocol_name;
        delegates.avio_flush = avio_flush;
        delegates.avio_free_directory_entry = avio_free_directory_entry;
        delegates.avio_get_dyn_buf = avio_get_dyn_buf;
        delegates.avio_get_str = avio_get_str;
        delegates.avio_get_str16be = avio_get_str16be;
        delegates.avio_get_str16le = avio_get_str16le;
        delegates.avio_handshake = avio_handshake;
        delegates.avio_open = avio_open;
        delegates.avio_open_dir = avio_open_dir;
        delegates.avio_open_dyn_buf = avio_open_dyn_buf;
        delegates.avio_open2 = avio_open2;
        delegates.avio_pause = avio_pause;
        delegates.avio_print_string_array = avio_print_string_array;
        delegates.avio_printf = avio_printf;
        delegates.avio_protocol_get_class = avio_protocol_get_class;
        delegates.avio_put_str = avio_put_str;
        delegates.avio_put_str16be = avio_put_str16be;
        delegates.avio_put_str16le = avio_put_str16le;
        delegates.avio_r8 = avio_r8;
        delegates.avio_rb16 = avio_rb16;
        delegates.avio_rb24 = avio_rb24;
        delegates.avio_rb32 = avio_rb32;
        delegates.avio_rb64 = avio_rb64;
        delegates.avio_read = avio_read;
        delegates.avio_read_dir = avio_read_dir;
        delegates.avio_read_partial = avio_read_partial;
        delegates.avio_read_to_bprint = avio_read_to_bprint;
        delegates.avio_rl16 = avio_rl16;
        delegates.avio_rl24 = avio_rl24;
        delegates.avio_rl32 = avio_rl32;
        delegates.avio_rl64 = avio_rl64;
        delegates.avio_seek = avio_seek;
        delegates.avio_seek_time = avio_seek_time;
        delegates.avio_size = avio_size;
        delegates.avio_skip = avio_skip;
        delegates.avio_vprintf = avio_vprintf;
        delegates.avio_w8 = avio_w8;
        delegates.avio_wb16 = avio_wb16;
        delegates.avio_wb24 = avio_wb24;
        delegates.avio_wb32 = avio_wb32;
        delegates.avio_wb64 = avio_wb64;
        delegates.avio_wl16 = avio_wl16;
        delegates.avio_wl24 = avio_wl24;
        delegates.avio_wl32 = avio_wl32;
        delegates.avio_wl64 = avio_wl64;
        delegates.avio_write = avio_write;
        delegates.avio_write_marker = avio_write_marker;
        delegates.av_add_q = av_add_q;
        delegates.av_add_stable = av_add_stable;
        delegates.av_audio_fifo_alloc = av_audio_fifo_alloc;
        delegates.av_audio_fifo_drain = av_audio_fifo_drain;
        delegates.av_audio_fifo_free = av_audio_fifo_free;
        delegates.av_audio_fifo_peek = av_audio_fifo_peek;
        delegates.av_audio_fifo_peek_at = av_audio_fifo_peek_at;
        delegates.av_audio_fifo_read = av_audio_fifo_read;
        delegates.av_audio_fifo_realloc = av_audio_fifo_realloc;
        delegates.av_audio_fifo_reset = av_audio_fifo_reset;
        delegates.av_audio_fifo_size = av_audio_fifo_size;
        delegates.av_audio_fifo_space = av_audio_fifo_space;
        delegates.av_audio_fifo_write = av_audio_fifo_write;
        delegates.av_bprint_channel_layout = av_bprint_channel_layout;
        delegates.av_buffer_alloc = av_buffer_alloc;
        delegates.av_buffer_allocz = av_buffer_allocz;
        delegates.av_buffer_create = av_buffer_create;
        delegates.av_buffer_default_free = av_buffer_default_free;
        delegates.av_buffer_get_opaque = av_buffer_get_opaque;
        delegates.av_buffer_get_ref_count = av_buffer_get_ref_count;
        delegates.av_buffer_is_writable = av_buffer_is_writable;
        delegates.av_buffer_make_writable = av_buffer_make_writable;
        delegates.av_buffer_pool_buffer_get_opaque = av_buffer_pool_buffer_get_opaque;
        delegates.av_buffer_pool_get = av_buffer_pool_get;
        delegates.av_buffer_pool_init = av_buffer_pool_init;
        delegates.av_buffer_pool_init2 = av_buffer_pool_init2;
        delegates.av_buffer_pool_uninit = av_buffer_pool_uninit;
        delegates.av_buffer_realloc = av_buffer_realloc;
        delegates.av_buffer_ref = av_buffer_ref;
        delegates.av_buffer_replace = av_buffer_replace;
        delegates.av_buffer_unref = av_buffer_unref;
        delegates.av_calloc = av_calloc;
        delegates.av_channel_description = av_channel_description;
        delegates.av_channel_description_bprint = av_channel_description_bprint;
        delegates.av_channel_from_string = av_channel_from_string;
        delegates.av_channel_layout_channel_from_index = av_channel_layout_channel_from_index;
        delegates.av_channel_layout_channel_from_string = av_channel_layout_channel_from_string;
        delegates.av_channel_layout_check = av_channel_layout_check;
        delegates.av_channel_layout_compare = av_channel_layout_compare;
        delegates.av_channel_layout_copy = av_channel_layout_copy;
        delegates.av_channel_layout_default = av_channel_layout_default;
        delegates.av_channel_layout_describe = av_channel_layout_describe;
        delegates.av_channel_layout_describe_bprint = av_channel_layout_describe_bprint;
        delegates.av_channel_layout_extract_channel = av_channel_layout_extract_channel;
        delegates.av_channel_layout_from_mask = av_channel_layout_from_mask;
        delegates.av_channel_layout_from_string = av_channel_layout_from_string;
        delegates.av_channel_layout_index_from_channel = av_channel_layout_index_from_channel;
        delegates.av_channel_layout_index_from_string = av_channel_layout_index_from_string;
        delegates.av_channel_layout_standard = av_channel_layout_standard;
        delegates.av_channel_layout_subset = av_channel_layout_subset;
        delegates.av_channel_layout_uninit = av_channel_layout_uninit;
        delegates.av_channel_name = av_channel_name;
        delegates.av_channel_name_bprint = av_channel_name_bprint;
        delegates.av_chroma_location_from_name = av_chroma_location_from_name;
        delegates.av_chroma_location_name = av_chroma_location_name;
        delegates.av_color_primaries_from_name = av_color_primaries_from_name;
        delegates.av_color_primaries_name = av_color_primaries_name;
        delegates.av_color_range_from_name = av_color_range_from_name;
        delegates.av_color_range_name = av_color_range_name;
        delegates.av_color_space_from_name = av_color_space_from_name;
        delegates.av_color_space_name = av_color_space_name;
        delegates.av_color_transfer_from_name = av_color_transfer_from_name;
        delegates.av_color_transfer_name = av_color_transfer_name;
        delegates.av_compare_mod = av_compare_mod;
        delegates.av_compare_ts = av_compare_ts;
        delegates.av_content_light_metadata_alloc = av_content_light_metadata_alloc;
        delegates.av_content_light_metadata_create_side_data = av_content_light_metadata_create_side_data;
        delegates.av_cpu_count = av_cpu_count;
        delegates.av_cpu_force_count = av_cpu_force_count;
        delegates.av_cpu_max_align = av_cpu_max_align;
        delegates.av_d2q = av_d2q;
        delegates.av_default_get_category = av_default_get_category;
        delegates.av_default_item_name = av_default_item_name;
        delegates.av_dict_copy = av_dict_copy;
        delegates.av_dict_count = av_dict_count;
        delegates.av_dict_free = av_dict_free;
        delegates.av_dict_get = av_dict_get;
        delegates.av_dict_get_string = av_dict_get_string;
        delegates.av_dict_parse_string = av_dict_parse_string;
        delegates.av_dict_set = av_dict_set;
        delegates.av_dict_set_int = av_dict_set_int;
        delegates.av_div_q = av_div_q;
        delegates.av_dynamic_hdr_plus_alloc = av_dynamic_hdr_plus_alloc;
        delegates.av_dynamic_hdr_plus_create_side_data = av_dynamic_hdr_plus_create_side_data;
        delegates.av_dynarray_add = av_dynarray_add;
        delegates.av_dynarray_add_nofree = av_dynarray_add_nofree;
        delegates.av_dynarray2_add = av_dynarray2_add;
        delegates.av_fast_malloc = av_fast_malloc;
        delegates.av_fast_mallocz = av_fast_mallocz;
        delegates.av_fast_realloc = av_fast_realloc;
        delegates.av_file_map = av_file_map;
        delegates.av_file_unmap = av_file_unmap;
        delegates.av_find_best_pix_fmt_of_2 = av_find_best_pix_fmt_of_2;
        delegates.av_find_nearest_q_idx = av_find_nearest_q_idx;
        delegates.av_fopen_utf8 = av_fopen_utf8;
        delegates.av_force_cpu_flags = av_force_cpu_flags;
        delegates.av_fourcc_make_string = av_fourcc_make_string;
        delegates.av_frame_alloc = av_frame_alloc;
        delegates.av_frame_apply_cropping = av_frame_apply_cropping;
        delegates.av_frame_clone = av_frame_clone;
        delegates.av_frame_copy = av_frame_copy;
        delegates.av_frame_copy_props = av_frame_copy_props;
        delegates.av_frame_free = av_frame_free;
        delegates.av_frame_get_buffer = av_frame_get_buffer;
        delegates.av_frame_get_plane_buffer = av_frame_get_plane_buffer;
        delegates.av_frame_get_side_data = av_frame_get_side_data;
        delegates.av_frame_is_writable = av_frame_is_writable;
        delegates.av_frame_make_writable = av_frame_make_writable;
        delegates.av_frame_move_ref = av_frame_move_ref;
        delegates.av_frame_new_side_data = av_frame_new_side_data;
        delegates.av_frame_new_side_data_from_buf = av_frame_new_side_data_from_buf;
        delegates.av_frame_ref = av_frame_ref;
        delegates.av_frame_remove_side_data = av_frame_remove_side_data;
        delegates.av_frame_side_data_name = av_frame_side_data_name;
        delegates.av_frame_unref = av_frame_unref;
        delegates.av_free = av_free;
        delegates.av_freep = av_freep;
        delegates.av_gcd = av_gcd;
        delegates.av_gcd_q = av_gcd_q;
        delegates.av_get_alt_sample_fmt = av_get_alt_sample_fmt;
        delegates.av_get_bits_per_pixel = av_get_bits_per_pixel;
        delegates.av_get_bytes_per_sample = av_get_bytes_per_sample;
        delegates.av_get_channel_description = av_get_channel_description;
        delegates.av_get_channel_layout = av_get_channel_layout;
        delegates.av_get_channel_layout_channel_index = av_get_channel_layout_channel_index;
        delegates.av_get_channel_layout_nb_channels = av_get_channel_layout_nb_channels;
        delegates.av_get_channel_layout_string = av_get_channel_layout_string;
        delegates.av_get_channel_name = av_get_channel_name;
        delegates.av_get_colorspace_name = av_get_colorspace_name;
        delegates.av_get_cpu_flags = av_get_cpu_flags;
        delegates.av_get_default_channel_layout = av_get_default_channel_layout;
        delegates.av_get_extended_channel_layout = av_get_extended_channel_layout;
        delegates.av_get_media_type_string = av_get_media_type_string;
        delegates.av_get_packed_sample_fmt = av_get_packed_sample_fmt;
        delegates.av_get_padded_bits_per_pixel = av_get_padded_bits_per_pixel;
        delegates.av_get_picture_type_char = av_get_picture_type_char;
        delegates.av_get_pix_fmt = av_get_pix_fmt;
        delegates.av_get_pix_fmt_loss = av_get_pix_fmt_loss;
        delegates.av_get_pix_fmt_name = av_get_pix_fmt_name;
        delegates.av_get_pix_fmt_string = av_get_pix_fmt_string;
        delegates.av_get_planar_sample_fmt = av_get_planar_sample_fmt;
        delegates.av_get_sample_fmt = av_get_sample_fmt;
        delegates.av_get_sample_fmt_name = av_get_sample_fmt_name;
        delegates.av_get_sample_fmt_string = av_get_sample_fmt_string;
        delegates.av_get_standard_channel_layout = av_get_standard_channel_layout;
        delegates.av_get_time_base_q = av_get_time_base_q;
        delegates.av_gettime = av_gettime;
        delegates.av_gettime_relative = av_gettime_relative;
        delegates.av_gettime_relative_is_monotonic = av_gettime_relative_is_monotonic;
        delegates.av_hwdevice_ctx_alloc = av_hwdevice_ctx_alloc;
        delegates.av_hwdevice_ctx_create = av_hwdevice_ctx_create;
        delegates.av_hwdevice_ctx_create_derived = av_hwdevice_ctx_create_derived;
        delegates.av_hwdevice_ctx_create_derived_opts = av_hwdevice_ctx_create_derived_opts;
        delegates.av_hwdevice_ctx_init = av_hwdevice_ctx_init;
        delegates.av_hwdevice_find_type_by_name = av_hwdevice_find_type_by_name;
        delegates.av_hwdevice_get_hwframe_constraints = av_hwdevice_get_hwframe_constraints;
        delegates.av_hwdevice_get_type_name = av_hwdevice_get_type_name;
        delegates.av_hwdevice_hwconfig_alloc = av_hwdevice_hwconfig_alloc;
        delegates.av_hwdevice_iterate_types = av_hwdevice_iterate_types;
        delegates.av_hwframe_constraints_free = av_hwframe_constraints_free;
        delegates.av_hwframe_ctx_alloc = av_hwframe_ctx_alloc;
        delegates.av_hwframe_ctx_create_derived = av_hwframe_ctx_create_derived;
        delegates.av_hwframe_ctx_init = av_hwframe_ctx_init;
        delegates.av_hwframe_get_buffer = av_hwframe_get_buffer;
        delegates.av_hwframe_map = av_hwframe_map;
        delegates.av_hwframe_transfer_data = av_hwframe_transfer_data;
        delegates.av_hwframe_transfer_get_formats = av_hwframe_transfer_get_formats;
        delegates.av_image_alloc = av_image_alloc;
        delegates.av_image_check_sar = av_image_check_sar;
        delegates.av_image_check_size = av_image_check_size;
        delegates.av_image_check_size2 = av_image_check_size2;
        delegates.av_image_copy = av_image_copy;
        delegates.av_image_copy_plane = av_image_copy_plane;
        delegates.av_image_copy_plane_uc_from = av_image_copy_plane_uc_from;
        delegates.av_image_copy_to_buffer = av_image_copy_to_buffer;
        delegates.av_image_copy_uc_from = av_image_copy_uc_from;
        delegates.av_image_fill_arrays = av_image_fill_arrays;
        delegates.av_image_fill_black = av_image_fill_black;
        delegates.av_image_fill_linesizes = av_image_fill_linesizes;
        delegates.av_image_fill_max_pixsteps = av_image_fill_max_pixsteps;
        delegates.av_image_fill_plane_sizes = av_image_fill_plane_sizes;
        delegates.av_image_fill_pointers = av_image_fill_pointers;
        delegates.av_image_get_buffer_size = av_image_get_buffer_size;
        delegates.av_image_get_linesize = av_image_get_linesize;
        delegates.av_int_list_length_for_size = av_int_list_length_for_size;
        delegates.av_log = av_log;
        delegates.av_log_default_callback = av_log_default_callback;
        delegates.av_log_format_line = av_log_format_line;
        delegates.av_log_format_line2 = av_log_format_line2;
        delegates.av_log_get_flags = av_log_get_flags;
        delegates.av_log_get_level = av_log_get_level;
        delegates.av_log_once = av_log_once;
        delegates.av_log_set_callback = av_log_set_callback;
        delegates.av_log_set_flags = av_log_set_flags;
        delegates.av_log_set_level = av_log_set_level;
        delegates.av_log2 = av_log2;
        delegates.av_log2_16bit = av_log2_16bit;
        delegates.av_malloc = av_malloc;
        delegates.av_malloc_array = av_malloc_array;
        delegates.av_mallocz = av_mallocz;
        delegates.av_mallocz_array = av_mallocz_array;
        delegates.av_mastering_display_metadata_alloc = av_mastering_display_metadata_alloc;
        delegates.av_mastering_display_metadata_create_side_data = av_mastering_display_metadata_create_side_data;
        delegates.av_max_alloc = av_max_alloc;
        delegates.av_memcpy_backptr = av_memcpy_backptr;
        delegates.av_memdup = av_memdup;
        delegates.av_mul_q = av_mul_q;
        delegates.av_nearer_q = av_nearer_q;
        delegates.av_opt_child_class_iterate = av_opt_child_class_iterate;
        delegates.av_opt_child_next = av_opt_child_next;
        delegates.av_opt_copy = av_opt_copy;
        delegates.av_opt_eval_double = av_opt_eval_double;
        delegates.av_opt_eval_flags = av_opt_eval_flags;
        delegates.av_opt_eval_float = av_opt_eval_float;
        delegates.av_opt_eval_int = av_opt_eval_int;
        delegates.av_opt_eval_int64 = av_opt_eval_int64;
        delegates.av_opt_eval_q = av_opt_eval_q;
        delegates.av_opt_find = av_opt_find;
        delegates.av_opt_find2 = av_opt_find2;
        delegates.av_opt_flag_is_set = av_opt_flag_is_set;
        delegates.av_opt_free = av_opt_free;
        delegates.av_opt_freep_ranges = av_opt_freep_ranges;
        delegates.av_opt_get = av_opt_get;
        delegates.av_opt_get_channel_layout = av_opt_get_channel_layout;
        delegates.av_opt_get_chlayout = av_opt_get_chlayout;
        delegates.av_opt_get_dict_val = av_opt_get_dict_val;
        delegates.av_opt_get_double = av_opt_get_double;
        delegates.av_opt_get_image_size = av_opt_get_image_size;
        delegates.av_opt_get_int = av_opt_get_int;
        delegates.av_opt_get_key_value = av_opt_get_key_value;
        delegates.av_opt_get_pixel_fmt = av_opt_get_pixel_fmt;
        delegates.av_opt_get_q = av_opt_get_q;
        delegates.av_opt_get_sample_fmt = av_opt_get_sample_fmt;
        delegates.av_opt_get_video_rate = av_opt_get_video_rate;
        delegates.av_opt_is_set_to_default = av_opt_is_set_to_default;
        delegates.av_opt_is_set_to_default_by_name = av_opt_is_set_to_default_by_name;
        delegates.av_opt_next = av_opt_next;
        delegates.av_opt_ptr = av_opt_ptr;
        delegates.av_opt_query_ranges = av_opt_query_ranges;
        delegates.av_opt_query_ranges_default = av_opt_query_ranges_default;
        delegates.av_opt_serialize = av_opt_serialize;
        delegates.av_opt_set = av_opt_set;
        delegates.av_opt_set_bin = av_opt_set_bin;
        delegates.av_opt_set_channel_layout = av_opt_set_channel_layout;
        delegates.av_opt_set_chlayout = av_opt_set_chlayout;
        delegates.av_opt_set_defaults = av_opt_set_defaults;
        delegates.av_opt_set_defaults2 = av_opt_set_defaults2;
        delegates.av_opt_set_dict = av_opt_set_dict;
        delegates.av_opt_set_dict_val = av_opt_set_dict_val;
        delegates.av_opt_set_dict2 = av_opt_set_dict2;
        delegates.av_opt_set_double = av_opt_set_double;
        delegates.av_opt_set_from_string = av_opt_set_from_string;
        delegates.av_opt_set_image_size = av_opt_set_image_size;
        delegates.av_opt_set_int = av_opt_set_int;
        delegates.av_opt_set_pixel_fmt = av_opt_set_pixel_fmt;
        delegates.av_opt_set_q = av_opt_set_q;
        delegates.av_opt_set_sample_fmt = av_opt_set_sample_fmt;
        delegates.av_opt_set_video_rate = av_opt_set_video_rate;
        delegates.av_opt_show2 = av_opt_show2;
        delegates.av_parse_cpu_caps = av_parse_cpu_caps;
        delegates.av_pix_fmt_count_planes = av_pix_fmt_count_planes;
        delegates.av_pix_fmt_desc_get = av_pix_fmt_desc_get;
        delegates.av_pix_fmt_desc_get_id = av_pix_fmt_desc_get_id;
        delegates.av_pix_fmt_desc_next = av_pix_fmt_desc_next;
        delegates.av_pix_fmt_get_chroma_sub_sample = av_pix_fmt_get_chroma_sub_sample;
        delegates.av_pix_fmt_swap_endianness = av_pix_fmt_swap_endianness;
        delegates.av_q2intfloat = av_q2intfloat;
        delegates.av_read_image_line = av_read_image_line;
        delegates.av_read_image_line2 = av_read_image_line2;
        delegates.av_realloc = av_realloc;
        delegates.av_realloc_array = av_realloc_array;
        delegates.av_realloc_f = av_realloc_f;
        delegates.av_reallocp = av_reallocp;
        delegates.av_reallocp_array = av_reallocp_array;
        delegates.av_reduce = av_reduce;
        delegates.av_rescale = av_rescale;
        delegates.av_rescale_delta = av_rescale_delta;
        delegates.av_rescale_q = av_rescale_q;
        delegates.av_rescale_q_rnd = av_rescale_q_rnd;
        delegates.av_rescale_rnd = av_rescale_rnd;
        delegates.av_sample_fmt_is_planar = av_sample_fmt_is_planar;
        delegates.av_samples_alloc = av_samples_alloc;
        delegates.av_samples_alloc_array_and_samples = av_samples_alloc_array_and_samples;
        delegates.av_samples_copy = av_samples_copy;
        delegates.av_samples_fill_arrays = av_samples_fill_arrays;
        delegates.av_samples_get_buffer_size = av_samples_get_buffer_size;
        delegates.av_samples_set_silence = av_samples_set_silence;
        delegates.av_set_options_string = av_set_options_string;
        delegates.av_size_mult = av_size_mult;
        delegates.av_strdup = av_strdup;
        delegates.av_strerror = av_strerror;
        delegates.av_strndup = av_strndup;
        delegates.av_sub_q = av_sub_q;
        delegates.av_tempfile = av_tempfile;
        delegates.av_timecode_adjust_ntsc_framenum2 = av_timecode_adjust_ntsc_framenum2;
        delegates.av_timecode_check_frame_rate = av_timecode_check_frame_rate;
        delegates.av_timecode_get_smpte = av_timecode_get_smpte;
        delegates.av_timecode_get_smpte_from_framenum = av_timecode_get_smpte_from_framenum;
        delegates.av_timecode_init = av_timecode_init;
        delegates.av_timecode_init_from_components = av_timecode_init_from_components;
        delegates.av_timecode_init_from_string = av_timecode_init_from_string;
        delegates.av_timecode_make_mpeg_tc_string = av_timecode_make_mpeg_tc_string;
        delegates.av_timecode_make_smpte_tc_string = av_timecode_make_smpte_tc_string;
        delegates.av_timecode_make_smpte_tc_string2 = av_timecode_make_smpte_tc_string2;
        delegates.av_timecode_make_string = av_timecode_make_string;
        delegates.av_tree_destroy = av_tree_destroy;
        delegates.av_tree_enumerate = av_tree_enumerate;
        delegates.av_tree_find = av_tree_find;
        delegates.av_tree_insert = av_tree_insert;
        delegates.av_tree_node_alloc = av_tree_node_alloc;
        delegates.av_usleep = av_usleep;
        delegates.av_version_info = av_version_info;
        delegates.av_vlog = av_vlog;
        delegates.av_write_image_line = av_write_image_line;
        delegates.av_write_image_line2 = av_write_image_line2;
        delegates.avutil_configuration = avutil_configuration;
        delegates.avutil_license = avutil_license;
        delegates.avutil_version = avutil_version;
        delegates.postproc_configuration = postproc_configuration;
        delegates.postproc_license = postproc_license;
        delegates.postproc_version = postproc_version;
        delegates.pp_free_context = pp_free_context;
        delegates.pp_free_mode = pp_free_mode;
        delegates.pp_get_context = pp_get_context;
        delegates.pp_get_mode_by_name_and_quality = pp_get_mode_by_name_and_quality;
        delegates.pp_postprocess = pp_postprocess;
        delegates.swr_alloc = swr_alloc;
        delegates.swr_alloc_set_opts = swr_alloc_set_opts;
        delegates.swr_alloc_set_opts2 = swr_alloc_set_opts2;
        delegates.swr_build_matrix = swr_build_matrix;
        delegates.swr_build_matrix2 = swr_build_matrix2;
        delegates.swr_close = swr_close;
        delegates.swr_config_frame = swr_config_frame;
        delegates.swr_convert = swr_convert;
        delegates.swr_convert_frame = swr_convert_frame;
        delegates.swr_drop_output = swr_drop_output;
        delegates.swr_free = swr_free;
        delegates.swr_get_class = swr_get_class;
        delegates.swr_get_delay = swr_get_delay;
        delegates.swr_get_out_samples = swr_get_out_samples;
        delegates.swr_init = swr_init;
        delegates.swr_inject_silence = swr_inject_silence;
        delegates.swr_is_initialized = swr_is_initialized;
        delegates.swr_next_pts = swr_next_pts;
        delegates.swr_set_channel_mapping = swr_set_channel_mapping;
        delegates.swr_set_compensation = swr_set_compensation;
        delegates.swr_set_matrix = swr_set_matrix;
        delegates.swresample_configuration = swresample_configuration;
        delegates.swresample_license = swresample_license;
        delegates.swresample_version = swresample_version;
        delegates.sws_alloc_context = sws_alloc_context;
        delegates.sws_allocVec = sws_allocVec;
        delegates.sws_convertPalette8ToPacked24 = sws_convertPalette8ToPacked24;
        delegates.sws_convertPalette8ToPacked32 = sws_convertPalette8ToPacked32;
        delegates.sws_frame_end = sws_frame_end;
        delegates.sws_frame_start = sws_frame_start;
        delegates.sws_freeContext = sws_freeContext;
        delegates.sws_freeFilter = sws_freeFilter;
        delegates.sws_freeVec = sws_freeVec;
        delegates.sws_get_class = sws_get_class;
        delegates.sws_getCachedContext = sws_getCachedContext;
        delegates.sws_getCoefficients = sws_getCoefficients;
        delegates.sws_getColorspaceDetails = sws_getColorspaceDetails;
        delegates.sws_getContext = sws_getContext;
        delegates.sws_getDefaultFilter = sws_getDefaultFilter;
        delegates.sws_getGaussianVec = sws_getGaussianVec;
        delegates.sws_init_context = sws_init_context;
        delegates.sws_isSupportedEndiannessConversion = sws_isSupportedEndiannessConversion;
        delegates.sws_isSupportedInput = sws_isSupportedInput;
        delegates.sws_isSupportedOutput = sws_isSupportedOutput;
        delegates.sws_normalizeVec = sws_normalizeVec;
        delegates.sws_receive_slice = sws_receive_slice;
        delegates.sws_receive_slice_alignment = sws_receive_slice_alignment;
        delegates.sws_scale = sws_scale;
        delegates.sws_scale_frame = sws_scale_frame;
        delegates.sws_scaleVec = sws_scaleVec;
        delegates.sws_send_slice = sws_send_slice;
        delegates.sws_setColorspaceDetails = sws_setColorspaceDetails;
        delegates.swscale_configuration = swscale_configuration;
        delegates.swscale_license = swscale_license;
        delegates.swscale_version = swscale_version;
    }
}
