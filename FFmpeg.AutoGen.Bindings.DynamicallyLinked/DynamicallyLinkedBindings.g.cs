...
public static unsafe partial class DynamicallyLinkedBindings
{
    ...
    [Obsolete()]
    [DllImport("avfilter-8", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    ...
    [DllImport("avformat-59", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    ...
    /// <returns>b+c</returns>
    [DllImport("avutil-57", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    ...
    [DllImport("avcodec-59", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    ...
    [DllImport("avdevice-59", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    ...
    [DllImport("postproc-56", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("swresample-4", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    ...
    [DllImport("swscale-6", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
