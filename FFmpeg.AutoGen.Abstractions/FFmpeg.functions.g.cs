...
public unsafe static partial class ffmpeg
{
    ...
    public static int av_codec_is_decoder(AVCodec* @codec) => delegates.av_codec_is_decoder(@codec);
    ...
    public static int av_codec_is_encoder(AVCodec* @codec) => delegates.av_codec_is_encoder(@codec);
    ...
    public static AVCodec* av_codec_iterate(void** @opaque) => delegates.av_codec_iterate(@opaque);
    ...
    public static AVCPBProperties* av_cpb_properties_alloc(ulong* @size) => delegates.av_cpb_properties_alloc(@size);
    
    
    /// <summary>Allocate an AVD3D11VAContext.</summary>
    /// <returns>Newly-allocated AVD3D11VAContext or NULL on failure.</returns>
    public static AVD3D11VAContext* av_d3d11va_alloc_context() => delegates.av_d3d11va_alloc_context();
    ...
    public static void av_fast_padded_malloc(void* @ptr, uint* @size, ulong @min_size) => delegates.av_fast_padded_malloc(@ptr, @size, @min_size);
    
    
    /// <summary>Same behaviour av_fast_padded_malloc except that buffer will always be 0-initialized after call.</summary>
    public static void av_fast_padded_mallocz(void* @ptr, uint* @size, ulong @min_size) => delegates.av_fast_padded_mallocz(@ptr, @size, @min_size);
    ...
    public static int av_get_audio_frame_duration(AVCodecContext* @avctx, int @frame_bytes) => delegates.av_get_audio_frame_duration(@avctx, @frame_bytes);
    ...
    public static int av_get_audio_frame_duration2(AVCodecParameters* @par, int @frame_bytes) => delegates.av_get_audio_frame_duration2(@par, @frame_bytes);
    ...
    public static int av_get_bits_per_sample(AVCodecID @codec_id) => delegates.av_get_bits_per_sample(@codec_id);
    ...
    /// <param name="codec_id">the codec</param>
    /// <returns>Number of bits per sample or zero if unknown for the given codec.</returns>
    public static int av_get_exact_bits_per_sample(AVCodecID @codec_id) => delegates.av_get_exact_bits_per_sample(@codec_id);
    ...
    public static AVCodecID av_get_pcm_codec(AVSampleFormat @fmt, int @be) => delegates.av_get_pcm_codec(@fmt, @be);
    ...
    public static string av_get_profile_name(AVCodec* @codec, int @profile) => delegates.av_get_profile_name(@codec, @profile);
    ...
    public static int av_grow_packet(AVPacket* @pkt, int @grow_by) => delegates.av_grow_packet(@pkt, @grow_by);
    ...
    public static void av_init_packet(AVPacket* @pkt) => delegates.av_init_packet(@pkt);
    ...
    public static int av_new_packet(AVPacket* @pkt, int @size) => delegates.av_new_packet(@pkt, @size);
    ...
    public static int av_packet_add_side_data(AVPacket* @pkt, AVPacketSideDataType @type, byte* @data, ulong @size) => delegates.av_packet_add_side_data(@pkt, @type, @data, @size);
    ...
    public static AVPacket* av_packet_alloc() => delegates.av_packet_alloc();
    ...
    public static AVPacket* av_packet_clone(AVPacket* @src) => delegates.av_packet_clone(@src);
    ...
    public static int av_packet_copy_props(AVPacket* @dst, AVPacket* @src) => delegates.av_packet_copy_props(@dst, @src);
    ...
    public static void av_packet_free(AVPacket** @pkt) => delegates.av_packet_free(@pkt);
    
    
    /// <summary>Convenience function to free all the side data stored. All the other fields stay untouched.</summary>
    /// <param name="pkt">packet</param>
    public static void av_packet_free_side_data(AVPacket* @pkt) => delegates.av_packet_free_side_data(@pkt);
    ...
    public static int av_packet_from_data(AVPacket* @pkt, byte* @data, int @size) => delegates.av_packet_from_data(@pkt, @data, @size);
    ...
    public static byte* av_packet_get_side_data(AVPacket* @pkt, AVPacketSideDataType @type, ulong* @size) => delegates.av_packet_get_side_data(@pkt, @type, @size);
    ...
    public static int av_packet_make_refcounted(AVPacket* @pkt) => delegates.av_packet_make_refcounted(@pkt);
    ...
    public static int av_packet_make_writable(AVPacket* @pkt) => delegates.av_packet_make_writable(@pkt);
    
    
    /// <summary>Move every field in src to dst and reset src.</summary>
    /// <param name="dst">Destination packet</param>
    /// <param name="src">Source packet, will be reset</param>
    public static void av_packet_move_ref(AVPacket* @dst, AVPacket* @src) => delegates.av_packet_move_ref(@dst, @src);
    ...
    public static byte* av_packet_new_side_data(AVPacket* @pkt, AVPacketSideDataType @type, ulong @size) => delegates.av_packet_new_side_data(@pkt, @type, @size);
    ...
    public static byte* av_packet_pack_dictionary(AVDictionary* @dict, ulong* @size) => delegates.av_packet_pack_dictionary(@dict, @size);
    ...
    public static int av_packet_ref(AVPacket* @dst, AVPacket* @src) => delegates.av_packet_ref(@dst, @src);
    ...
    public static void av_packet_rescale_ts(AVPacket* @pkt, AVRational @tb_src, AVRational @tb_dst) => delegates.av_packet_rescale_ts(@pkt, @tb_src, @tb_dst);
    ...
    public static int av_packet_shrink_side_data(AVPacket* @pkt, AVPacketSideDataType @type, ulong @size) => delegates.av_packet_shrink_side_data(@pkt, @type, @size);
    
    
    public static string av_packet_side_data_name(AVPacketSideDataType @type) => delegates.av_packet_side_data_name(@type);
    ...
    /// <returns>0 on success, &lt; 0 on failure</returns>
    public static int av_packet_unpack_dictionary(byte* @data, ulong @size, AVDictionary** @dict) => delegates.av_packet_unpack_dictionary(@data, @size, @dict);
    
    
    /// <summary>Wipe the packet.</summary>
    /// <param name="pkt">The packet to be unreferenced.</param>
    public static void av_packet_unref(AVPacket* @pkt) => delegates.av_packet_unref(@pkt);
    
    
    public static void av_parser_close(AVCodecParserContext* @s) => delegates.av_parser_close(@s);
    
    
    public static AVCodecParserContext* av_parser_init(int @codec_id) => delegates.av_parser_init(@codec_id);
    ...
    public static AVCodecParser* av_parser_iterate(void** @opaque) => delegates.av_parser_iterate(@opaque);
    ...
    public static int av_parser_parse2(AVCodecParserContext* @s, AVCodecContext* @avctx, byte** @poutbuf, int* @poutbuf_size, byte* @buf, int @buf_size, long @pts, long @dts, long @pos) => delegates.av_parser_parse2(@s, @avctx, @poutbuf, @poutbuf_size, @buf, @buf_size, @pts, @dts, @pos);
    
    
    /// <summary>Reduce packet size, correctly zeroing padding</summary>
    /// <param name="pkt">packet</param>
    /// <param name="size">new size</param>
    public static void av_shrink_packet(AVPacket* @pkt, int @size) => delegates.av_shrink_packet(@pkt, @size);
    ...
    public static uint av_xiphlacing(byte* @s, uint @v) => delegates.av_xiphlacing(@s, @v);
    ...
    public static void avcodec_align_dimensions(AVCodecContext* @s, int* @width, int* @height) => delegates.avcodec_align_dimensions(@s, @width, @height);
    ...
    public static void avcodec_align_dimensions2(AVCodecContext* @s, int* @width, int* @height, ref int_array8 @linesize_align) => delegates.avcodec_align_dimensions2(@s, @width, @height, ref @linesize_align);
    ...
    public static AVCodecContext* avcodec_alloc_context3(AVCodec* @codec) => delegates.avcodec_alloc_context3(@codec);
    ...
    public static AVChromaLocation avcodec_chroma_pos_to_enum(int @xpos, int @ypos) => delegates.avcodec_chroma_pos_to_enum(@xpos, @ypos);
    
    
    /// <summary>Close a given AVCodecContext and free all the data associated with it (but not the AVCodecContext itself).</summary>
    public static int avcodec_close(AVCodecContext* @avctx) => delegates.avcodec_close(@avctx);
    
    
    /// <summary>Return the libavcodec build-time configuration.</summary>
    public static string avcodec_configuration() => delegates.avcodec_configuration();
    ...
    public static int avcodec_decode_subtitle2(AVCodecContext* @avctx, AVSubtitle* @sub, int* @got_sub_ptr, AVPacket* @avpkt) => delegates.avcodec_decode_subtitle2(@avctx, @sub, @got_sub_ptr, @avpkt);
    
    
    public static int avcodec_default_execute(AVCodecContext* @c, avcodec_default_execute_func_func @func, void* @arg, int* @ret, int @count, int @size) => delegates.avcodec_default_execute(@c, @func, @arg, @ret, @count, @size);
    
    
    public static int avcodec_default_execute2(AVCodecContext* @c, avcodec_default_execute2_func_func @func, void* @arg, int* @ret, int @count) => delegates.avcodec_default_execute2(@c, @func, @arg, @ret, @count);
    ...
    public static int avcodec_default_get_buffer2(AVCodecContext* @s, AVFrame* @frame, int @flags) => delegates.avcodec_default_get_buffer2(@s, @frame, @flags);
    ...
    public static int avcodec_default_get_encode_buffer(AVCodecContext* @s, AVPacket* @pkt, int @flags) => delegates.avcodec_default_get_encode_buffer(@s, @pkt, @flags);
    
    
    public static AVPixelFormat avcodec_default_get_format(AVCodecContext* @s, AVPixelFormat* @fmt) => delegates.avcodec_default_get_format(@s, @fmt);
    ...
    public static AVCodecDescriptor* avcodec_descriptor_get(AVCodecID @id) => delegates.avcodec_descriptor_get(@id);
    ...
    public static AVCodecDescriptor* avcodec_descriptor_get_by_name(string @name) => delegates.avcodec_descriptor_get_by_name(@name);
    ...
    public static AVCodecDescriptor* avcodec_descriptor_next(AVCodecDescriptor* @prev) => delegates.avcodec_descriptor_next(@prev);
    
    
    /// <summary>@{</summary>
    public static int avcodec_encode_subtitle(AVCodecContext* @avctx, byte* @buf, int @buf_size, AVSubtitle* @sub) => delegates.avcodec_encode_subtitle(@avctx, @buf, @buf_size, @sub);
    
    
    /// <summary>Converts AVChromaLocation to swscale x/y chroma position.</summary>
    /// <param name="xpos">horizontal chroma sample position</param>
    /// <param name="ypos">vertical   chroma sample position</param>
    public static int avcodec_enum_to_chroma_pos(int* @xpos, int* @ypos, AVChromaLocation @pos) => delegates.avcodec_enum_to_chroma_pos(@xpos, @ypos, @pos);
    ...
    public static int avcodec_fill_audio_frame(AVFrame* @frame, int @nb_channels, AVSampleFormat @sample_fmt, byte* @buf, int @buf_size, int @align) => delegates.avcodec_fill_audio_frame(@frame, @nb_channels, @sample_fmt, @buf, @buf_size, @align);
    ...
    public static AVPixelFormat avcodec_find_best_pix_fmt_of_list(AVPixelFormat* @pix_fmt_list, AVPixelFormat @src_pix_fmt, int @has_alpha, int* @loss_ptr) => delegates.avcodec_find_best_pix_fmt_of_list(@pix_fmt_list, @src_pix_fmt, @has_alpha, @loss_ptr);
    ...
    public static AVCodec* avcodec_find_decoder(AVCodecID @id) => delegates.avcodec_find_decoder(@id);
    
    
    /// <summary>Find a registered decoder with the specified name.</summary>
    /// <param name="name">name of the requested decoder</param>
    /// <returns>A decoder if one was found, NULL otherwise.</returns>
    public static AVCodec* avcodec_find_decoder_by_name(string @name) => delegates.avcodec_find_decoder_by_name(@name);
    ...
    public static AVCodec* avcodec_find_encoder(AVCodecID @id) => delegates.avcodec_find_encoder(@id);
    
    
    /// <summary>Find a registered encoder with the specified name.</summary>
    /// <param name="name">name of the requested encoder</param>
    /// <returns>An encoder if one was found, NULL otherwise.</returns>
    public static AVCodec* avcodec_find_encoder_by_name(string @name) => delegates.avcodec_find_encoder_by_name(@name);
    ...
    public static void avcodec_flush_buffers(AVCodecContext* @avctx) => delegates.avcodec_flush_buffers(@avctx);
    
    
    /// <summary>Free the codec context and everything associated with it and write NULL to the provided pointer.</summary>
    public static void avcodec_free_context(AVCodecContext** @avctx) => delegates.avcodec_free_context(@avctx);
    ...
    public static AVClass* avcodec_get_class() => delegates.avcodec_get_class();
    
    
    [Obsolete("This function should not be used.")]
    public static AVClass* avcodec_get_frame_class() => delegates.avcodec_get_frame_class();
    
    
    /// <summary>Retrieve supported hardware configurations for a codec.</summary>
    public static AVCodecHWConfig* avcodec_get_hw_config(AVCodec* @codec, int @index) => delegates.avcodec_get_hw_config(@codec, @index);
    ...
    public static int avcodec_get_hw_frames_parameters(AVCodecContext* @avctx, AVBufferRef* @device_ref, AVPixelFormat @hw_pix_fmt, AVBufferRef** @out_frames_ref) => delegates.avcodec_get_hw_frames_parameters(@avctx, @device_ref, @hw_pix_fmt, @out_frames_ref);
    
    
    /// <summary>Get the name of a codec.</summary>
    /// <returns>a static string identifying the codec; never NULL</returns>
    public static string avcodec_get_name(AVCodecID @id) => delegates.avcodec_get_name(@id);
    ...
    public static AVClass* avcodec_get_subtitle_rect_class() => delegates.avcodec_get_subtitle_rect_class();
    
    
    /// <summary>Get the type of the given codec.</summary>
    public static AVMediaType avcodec_get_type(AVCodecID @codec_id) => delegates.avcodec_get_type(@codec_id);
    ...
    public static int avcodec_is_open(AVCodecContext* @s) => delegates.avcodec_is_open(@s);
    
    
    /// <summary>Return the libavcodec license.</summary>
    public static string avcodec_license() => delegates.avcodec_license();
    ...
    public static int avcodec_open2(AVCodecContext* @avctx, AVCodec* @codec, AVDictionary** @options) => delegates.avcodec_open2(@avctx, @codec, @options);
    ...
    public static AVCodecParameters* avcodec_parameters_alloc() => delegates.avcodec_parameters_alloc();
    ...
    public static int avcodec_parameters_copy(AVCodecParameters* @dst, AVCodecParameters* @src) => delegates.avcodec_parameters_copy(@dst, @src);
    ...
    public static void avcodec_parameters_free(AVCodecParameters** @par) => delegates.avcodec_parameters_free(@par);
    ...
    /// <returns>&gt;= 0 on success, a negative AVERROR code on failure</returns>
    public static int avcodec_parameters_from_context(AVCodecParameters* @par, AVCodecContext* @codec) => delegates.avcodec_parameters_from_context(@par, @codec);
    ...
    /// <returns>&gt;= 0 on success, a negative AVERROR code on failure.</returns>
    public static int avcodec_parameters_to_context(AVCodecContext* @codec, AVCodecParameters* @par) => delegates.avcodec_parameters_to_context(@codec, @par);
    ...
    public static uint avcodec_pix_fmt_to_codec_tag(AVPixelFormat @pix_fmt) => delegates.avcodec_pix_fmt_to_codec_tag(@pix_fmt);
    ...
    /// <param name="profile">the profile value for which a name is requested</param>
    /// <returns>A name for the profile if found, NULL otherwise.</returns>
    public static string avcodec_profile_name(AVCodecID @codec_id, int @profile) => delegates.avcodec_profile_name(@codec_id, @profile);
    ...
    public static int avcodec_receive_frame(AVCodecContext* @avctx, AVFrame* @frame) => delegates.avcodec_receive_frame(@avctx, @frame);
    ...
    public static int avcodec_receive_packet(AVCodecContext* @avctx, AVPacket* @avpkt) => delegates.avcodec_receive_packet(@avctx, @avpkt);
    ...
    public static int avcodec_send_frame(AVCodecContext* @avctx, AVFrame* @frame) => delegates.avcodec_send_frame(@avctx, @frame);
    ...
    public static int avcodec_send_packet(AVCodecContext* @avctx, AVPacket* @avpkt) => delegates.avcodec_send_packet(@avctx, @avpkt);
    
    
    /// <summary>@}</summary>
    public static void avcodec_string(byte* @buf, int @buf_size, AVCodecContext* @enc, int @encode) => delegates.avcodec_string(@buf, @buf_size, @enc, @encode);
    
    
    /// <summary>Return the LIBAVCODEC_VERSION_INT constant.</summary>
    public static uint avcodec_version() => delegates.avcodec_version();
    
    
    /// <summary>Free all allocated data in the given subtitle struct.</summary>
    /// <param name="sub">AVSubtitle to free.</param>
    public static void avsubtitle_free(AVSubtitle* @sub) => delegates.avsubtitle_free(@sub);
    
    
    /// <summary>Audio input devices iterator.</summary>
    public static AVInputFormat* av_input_audio_device_next(AVInputFormat* @d) => delegates.av_input_audio_device_next(@d);
    
    
    /// <summary>Video input devices iterator.</summary>
    public static AVInputFormat* av_input_video_device_next(AVInputFormat* @d) => delegates.av_input_video_device_next(@d);
    
    
    /// <summary>Audio output devices iterator.</summary>
    public static AVOutputFormat* av_output_audio_device_next(AVOutputFormat* @d) => delegates.av_output_audio_device_next(@d);
    
    
    /// <summary>Video output devices iterator.</summary>
    public static AVOutputFormat* av_output_video_device_next(AVOutputFormat* @d) => delegates.av_output_video_device_next(@d);
    ...
    public static int avdevice_app_to_dev_control_message(AVFormatContext* @s, AVAppToDevMessageType @type, void* @data, ulong @data_size) => delegates.avdevice_app_to_dev_control_message(@s, @type, @data, @data_size);
    ...
    [Obsolete("")]
    public static int avdevice_capabilities_create(AVDeviceCapabilitiesQuery** @caps, AVFormatContext* @s, AVDictionary** @device_options) => delegates.avdevice_capabilities_create(@caps, @s, @device_options);
    ...
    /// <param name="s">Context of the device.</param>
    [Obsolete("")]
    public static void avdevice_capabilities_free(AVDeviceCapabilitiesQuery** @caps, AVFormatContext* @s) => delegates.avdevice_capabilities_free(@caps, @s);
    
    
    /// <summary>Return the libavdevice build-time configuration.</summary>
    public static string avdevice_configuration() => delegates.avdevice_configuration();
    ...
    public static int avdevice_dev_to_app_control_message(AVFormatContext* @s, AVDevToAppMessageType @type, void* @data, ulong @data_size) => delegates.avdevice_dev_to_app_control_message(@s, @type, @data, @data_size);
    
    
    /// <summary>Convenient function to free result of avdevice_list_devices().</summary>
    public static void avdevice_free_list_devices(AVDeviceInfoList** @device_list) => delegates.avdevice_free_list_devices(@device_list);
    
    
    /// <summary>Return the libavdevice license.</summary>
    public static string avdevice_license() => delegates.avdevice_license();
    ...
    public static int avdevice_list_devices(AVFormatContext* @s, AVDeviceInfoList** @device_list) => delegates.avdevice_list_devices(@s, @device_list);
    ...
    /// <param name="device_list">list of autodetected devices</param>
    /// <returns>count of autodetected devices, negative on error.</returns>
    public static int avdevice_list_input_sources(AVInputFormat* @device, string @device_name, AVDictionary* @device_options, AVDeviceInfoList** @device_list) => delegates.avdevice_list_input_sources(@device, @device_name, @device_options, @device_list);
    
    
    public static int avdevice_list_output_sinks(AVOutputFormat* @device, string @device_name, AVDictionary* @device_options, AVDeviceInfoList** @device_list) => delegates.avdevice_list_output_sinks(@device, @device_name, @device_options, @device_list);
    
    
    /// <summary>Initialize libavdevice and register all the input and output devices.</summary>
    public static void avdevice_register_all() => delegates.avdevice_register_all();
    
    
    /// <summary>Return the LIBAVDEVICE_VERSION_INT constant.</summary>
    public static uint avdevice_version() => delegates.avdevice_version();
    
    
    /// <summary>Create an AVABufferSinkParams structure.</summary>
    [Obsolete("")]
    public static AVABufferSinkParams* av_abuffersink_params_alloc() => delegates.av_abuffersink_params_alloc();
    
    
    public static int av_buffersink_get_ch_layout(AVFilterContext* @ctx, AVChannelLayout* @ch_layout) => delegates.av_buffersink_get_ch_layout(@ctx, @ch_layout);
    
    
    [Obsolete("")]
    public static ulong av_buffersink_get_channel_layout(AVFilterContext* @ctx) => delegates.av_buffersink_get_channel_layout(@ctx);
    
    
    public static int av_buffersink_get_channels(AVFilterContext* @ctx) => delegates.av_buffersink_get_channels(@ctx);
    
    
    public static int av_buffersink_get_format(AVFilterContext* @ctx) => delegates.av_buffersink_get_format(@ctx);
    ...
    public static int av_buffersink_get_frame(AVFilterContext* @ctx, AVFrame* @frame) => delegates.av_buffersink_get_frame(@ctx, @frame);
    ...
    public static int av_buffersink_get_frame_flags(AVFilterContext* @ctx, AVFrame* @frame, int @flags) => delegates.av_buffersink_get_frame_flags(@ctx, @frame, @flags);
    
    
    public static AVRational av_buffersink_get_frame_rate(AVFilterContext* @ctx) => delegates.av_buffersink_get_frame_rate(@ctx);
    
    
    public static int av_buffersink_get_h(AVFilterContext* @ctx) => delegates.av_buffersink_get_h(@ctx);
    
    
    public static AVBufferRef* av_buffersink_get_hw_frames_ctx(AVFilterContext* @ctx) => delegates.av_buffersink_get_hw_frames_ctx(@ctx);
    
    
    public static AVRational av_buffersink_get_sample_aspect_ratio(AVFilterContext* @ctx) => delegates.av_buffersink_get_sample_aspect_ratio(@ctx);
    
    
    public static int av_buffersink_get_sample_rate(AVFilterContext* @ctx) => delegates.av_buffersink_get_sample_rate(@ctx);
    ...
    public static int av_buffersink_get_samples(AVFilterContext* @ctx, AVFrame* @frame, int @nb_samples) => delegates.av_buffersink_get_samples(@ctx, @frame, @nb_samples);
    
    
    public static AVRational av_buffersink_get_time_base(AVFilterContext* @ctx) => delegates.av_buffersink_get_time_base(@ctx);
    
    
    /// <summary>Get the properties of the stream @{</summary>
    public static AVMediaType av_buffersink_get_type(AVFilterContext* @ctx) => delegates.av_buffersink_get_type(@ctx);
    
    
    public static int av_buffersink_get_w(AVFilterContext* @ctx) => delegates.av_buffersink_get_w(@ctx);
    
    
    /// <summary>Create an AVBufferSinkParams structure.</summary>
    [Obsolete("")]
    public static AVBufferSinkParams* av_buffersink_params_alloc() => delegates.av_buffersink_params_alloc();
    
    
    /// <summary>Set the frame size for an audio buffer sink.</summary>
    public static void av_buffersink_set_frame_size(AVFilterContext* @ctx, uint @frame_size) => delegates.av_buffersink_set_frame_size(@ctx, @frame_size);
    ...
    /// <returns>0 on success, a negative AVERROR on error.</returns>
    public static int av_buffersrc_add_frame(AVFilterContext* @ctx, AVFrame* @frame) => delegates.av_buffersrc_add_frame(@ctx, @frame);
    ...
    public static int av_buffersrc_add_frame_flags(AVFilterContext* @buffer_src, AVFrame* @frame, int @flags) => delegates.av_buffersrc_add_frame_flags(@buffer_src, @frame, @flags);
    
    
    /// <summary>Close the buffer source after EOF.</summary>
    public static int av_buffersrc_close(AVFilterContext* @ctx, long @pts, uint @flags) => delegates.av_buffersrc_close(@ctx, @pts, @flags);
    
    
    /// <summary>Get the number of failed requests.</summary>
    public static uint av_buffersrc_get_nb_failed_requests(AVFilterContext* @buffer_src) => delegates.av_buffersrc_get_nb_failed_requests(@buffer_src);
    
    
    /// <summary>Allocate a new AVBufferSrcParameters instance. It should be freed by the caller with av_free().</summary>
    public static AVBufferSrcParameters* av_buffersrc_parameters_alloc() => delegates.av_buffersrc_parameters_alloc();
    ...
    /// <returns>0 on success, a negative AVERROR code on failure.</returns>
    public static int av_buffersrc_parameters_set(AVFilterContext* @ctx, AVBufferSrcParameters* @param) => delegates.av_buffersrc_parameters_set(@ctx, @param);
    ...
    /// <returns>0 on success, a negative AVERROR on error</returns>
    public static int av_buffersrc_write_frame(AVFilterContext* @ctx, AVFrame* @frame) => delegates.av_buffersrc_write_frame(@ctx, @frame);
    ...
    public static AVFilter* av_filter_iterate(void** @opaque) => delegates.av_filter_iterate(@opaque);
    ...
    public static int avfilter_config_links(AVFilterContext* @filter) => delegates.avfilter_config_links(@filter);
    
    
    /// <summary>Return the libavfilter build-time configuration.</summary>
    public static string avfilter_configuration() => delegates.avfilter_configuration();
    
    
    /// <summary>Get the number of elements in an AVFilter&apos;s inputs or outputs array.</summary>
    public static uint avfilter_filter_pad_count(AVFilter* @filter, int @is_output) => delegates.avfilter_filter_pad_count(@filter, @is_output);
    ...
    public static void avfilter_free(AVFilterContext* @filter) => delegates.avfilter_free(@filter);
    ...
    public static AVFilter* avfilter_get_by_name(string @name) => delegates.avfilter_get_by_name(@name);
    
    
    /// <summary>Returns AVClass for AVFilterContext.</summary>
    /// <returns>AVClass for AVFilterContext.</returns>
    public static AVClass* avfilter_get_class() => delegates.avfilter_get_class();
    
    
    /// <summary>Allocate a filter graph.</summary>
    /// <returns>the allocated filter graph on success or NULL.</returns>
    public static AVFilterGraph* avfilter_graph_alloc() => delegates.avfilter_graph_alloc();
    ...
    public static AVFilterContext* avfilter_graph_alloc_filter(AVFilterGraph* @graph, AVFilter* @filter, string @name) => delegates.avfilter_graph_alloc_filter(@graph, @filter, @name);
    ...
    public static int avfilter_graph_config(AVFilterGraph* @graphctx, void* @log_ctx) => delegates.avfilter_graph_config(@graphctx, @log_ctx);
    ...
    public static int avfilter_graph_create_filter(AVFilterContext** @filt_ctx, AVFilter* @filt, string @name, string @args, void* @opaque, AVFilterGraph* @graph_ctx) => delegates.avfilter_graph_create_filter(@filt_ctx, @filt, @name, @args, @opaque, @graph_ctx);
    ...
    public static byte* avfilter_graph_dump(AVFilterGraph* @graph, string @options) => delegates.avfilter_graph_dump(@graph, @options);
    
    
    /// <summary>Free a graph, destroy its links, and set *graph to NULL. If *graph is NULL, do nothing.</summary>
    public static void avfilter_graph_free(AVFilterGraph** @graph) => delegates.avfilter_graph_free(@graph);
    ...
    public static AVFilterContext* avfilter_graph_get_filter(AVFilterGraph* @graph, string @name) => delegates.avfilter_graph_get_filter(@graph, @name);
    ...
    public static int avfilter_graph_parse(AVFilterGraph* @graph, string @filters, AVFilterInOut* @inputs, AVFilterInOut* @outputs, void* @log_ctx) => delegates.avfilter_graph_parse(@graph, @filters, @inputs, @outputs, @log_ctx);
    ...
    public static int avfilter_graph_parse_ptr(AVFilterGraph* @graph, string @filters, AVFilterInOut** @inputs, AVFilterInOut** @outputs, void* @log_ctx) => delegates.avfilter_graph_parse_ptr(@graph, @filters, @inputs, @outputs, @log_ctx);
    ...
    /// <returns>zero on success, a negative AVERROR code on error</returns>
    public static int avfilter_graph_parse2(AVFilterGraph* @graph, string @filters, AVFilterInOut** @inputs, AVFilterInOut** @outputs) => delegates.avfilter_graph_parse2(@graph, @filters, @inputs, @outputs);
    ...
    public static int avfilter_graph_queue_command(AVFilterGraph* @graph, string @target, string @cmd, string @arg, int @flags, double @ts) => delegates.avfilter_graph_queue_command(@graph, @target, @cmd, @arg, @flags, @ts);
    ...
    public static int avfilter_graph_request_oldest(AVFilterGraph* @graph) => delegates.avfilter_graph_request_oldest(@graph);
    ...
    public static int avfilter_graph_send_command(AVFilterGraph* @graph, string @target, string @cmd, string @arg, byte* @res, int @res_len, int @flags) => delegates.avfilter_graph_send_command(@graph, @target, @cmd, @arg, @res, @res_len, @flags);
    ...
    public static void avfilter_graph_set_auto_convert(AVFilterGraph* @graph, uint @flags) => delegates.avfilter_graph_set_auto_convert(@graph, @flags);
    ...
    public static int avfilter_init_dict(AVFilterContext* @ctx, AVDictionary** @options) => delegates.avfilter_init_dict(@ctx, @options);
    ...
    /// <returns>0 on success, a negative AVERROR on failure</returns>
    public static int avfilter_init_str(AVFilterContext* @ctx, string @args) => delegates.avfilter_init_str(@ctx, @args);
    ...
    public static AVFilterInOut* avfilter_inout_alloc() => delegates.avfilter_inout_alloc();
    
    
    /// <summary>Free the supplied list of AVFilterInOut and set *inout to NULL. If *inout is NULL, do nothing.</summary>
    public static void avfilter_inout_free(AVFilterInOut** @inout) => delegates.avfilter_inout_free(@inout);
    ...
    public static int avfilter_insert_filter(AVFilterLink* @link, AVFilterContext* @filt, uint @filt_srcpad_idx, uint @filt_dstpad_idx) => delegates.avfilter_insert_filter(@link, @filt, @filt_srcpad_idx, @filt_dstpad_idx);
    
    
    /// <summary>Return the libavfilter license.</summary>
    public static string avfilter_license() => delegates.avfilter_license();
    ...
    /// <returns>zero on success</returns>
    public static int avfilter_link(AVFilterContext* @src, uint @srcpad, AVFilterContext* @dst, uint @dstpad) => delegates.avfilter_link(@src, @srcpad, @dst, @dstpad);
    
    
    /// <summary>Free the link in *link, and set its pointer to NULL.</summary>
    public static void avfilter_link_free(AVFilterLink** @link) => delegates.avfilter_link_free(@link);
    
    
    /// <summary>Get the number of elements in an AVFilter&apos;s inputs or outputs array.</summary>
    [Obsolete("Use avfilter_filter_pad_count() instead.")]
    public static int avfilter_pad_count(AVFilterPad* @pads) => delegates.avfilter_pad_count(@pads);
    ...
    public static string avfilter_pad_get_name(AVFilterPad* @pads, int @pad_idx) => delegates.avfilter_pad_get_name(@pads, @pad_idx);
    ...
    public static AVMediaType avfilter_pad_get_type(AVFilterPad* @pads, int @pad_idx) => delegates.avfilter_pad_get_type(@pads, @pad_idx);
    
    
    /// <summary>Make the filter instance process a command. It is recommended to use avfilter_graph_send_command().</summary>
    public static int avfilter_process_command(AVFilterContext* @filter, string @cmd, string @arg, byte* @res, int @res_len, int @flags) => delegates.avfilter_process_command(@filter, @cmd, @arg, @res, @res_len, @flags);
    
    
    /// <summary>Return the LIBAVFILTER_VERSION_INT constant.</summary>
    public static uint avfilter_version() => delegates.avfilter_version();
    ...
    public static int av_add_index_entry(AVStream* @st, long @pos, long @timestamp, int @size, int @distance, int @flags) => delegates.av_add_index_entry(@st, @pos, @timestamp, @size, @distance, @flags);
    ...
    public static int av_append_packet(AVIOContext* @s, AVPacket* @pkt, int @size) => delegates.av_append_packet(@s, @pkt, @size);
    ...
    public static AVCodecID av_codec_get_id(AVCodecTag** @tags, uint @tag) => delegates.av_codec_get_id(@tags, @tag);
    ...
    public static uint av_codec_get_tag(AVCodecTag** @tags, AVCodecID @id) => delegates.av_codec_get_tag(@tags, @id);
    ...
    public static int av_codec_get_tag2(AVCodecTag** @tags, AVCodecID @id, uint* @tag) => delegates.av_codec_get_tag2(@tags, @id, @tag);
    ...
    public static AVInputFormat* av_demuxer_iterate(void** @opaque) => delegates.av_demuxer_iterate(@opaque);
    ...
    public static int av_disposition_from_string(string @disp) => delegates.av_disposition_from_string(@disp);
    ...
    public static string av_disposition_to_string(int @disposition) => delegates.av_disposition_to_string(@disposition);
    ...
    public static void av_dump_format(AVFormatContext* @ic, int @index, string @url, int @is_output) => delegates.av_dump_format(@ic, @index, @url, @is_output);
    ...
    public static int av_filename_number_test(string @filename) => delegates.av_filename_number_test(@filename);
    ...
    public static int av_find_best_stream(AVFormatContext* @ic, AVMediaType @type, int @wanted_stream_nb, int @related_stream, AVCodec** @decoder_ret, int @flags) => delegates.av_find_best_stream(@ic, @type, @wanted_stream_nb, @related_stream, @decoder_ret, @flags);
    
    
    public static int av_find_default_stream_index(AVFormatContext* @s) => delegates.av_find_default_stream_index(@s);
    
    
    /// <summary>Find AVInputFormat based on the short name of the input format.</summary>
    public static AVInputFormat* av_find_input_format(string @short_name) => delegates.av_find_input_format(@short_name);
    ...
    public static AVProgram* av_find_program_from_stream(AVFormatContext* @ic, AVProgram* @last, int @s) => delegates.av_find_program_from_stream(@ic, @last, @s);
    ...
    public static AVDurationEstimationMethod av_fmt_ctx_get_duration_estimation_method(AVFormatContext* @ctx) => delegates.av_fmt_ctx_get_duration_estimation_method(@ctx);
    ...
    public static void av_format_inject_global_side_data(AVFormatContext* @s) => delegates.av_format_inject_global_side_data(@s);
    
    
    public static int av_get_frame_filename(byte* @buf, int @buf_size, string @path, int @number) => delegates.av_get_frame_filename(@buf, @buf_size, @path, @number);
    ...
    public static int av_get_frame_filename2(byte* @buf, int @buf_size, string @path, int @number, int @flags) => delegates.av_get_frame_filename2(@buf, @buf_size, @path, @number, @flags);
    ...
    public static int av_get_output_timestamp(AVFormatContext* @s, int @stream, long* @dts, long* @wall) => delegates.av_get_output_timestamp(@s, @stream, @dts, @wall);
    ...
    public static int av_get_packet(AVIOContext* @s, AVPacket* @pkt, int @size) => delegates.av_get_packet(@s, @pkt, @size);
    
    
    /// <summary>Guess the codec ID based upon muxer and filename.</summary>
    public static AVCodecID av_guess_codec(AVOutputFormat* @fmt, string @short_name, string @filename, string @mime_type, AVMediaType @type) => delegates.av_guess_codec(@fmt, @short_name, @filename, @mime_type, @type);
    ...
    public static AVOutputFormat* av_guess_format(string @short_name, string @filename, string @mime_type) => delegates.av_guess_format(@short_name, @filename, @mime_type);
    ...
    public static AVRational av_guess_frame_rate(AVFormatContext* @ctx, AVStream* @stream, AVFrame* @frame) => delegates.av_guess_frame_rate(@ctx, @stream, @frame);
    ...
    public static AVRational av_guess_sample_aspect_ratio(AVFormatContext* @format, AVStream* @stream, AVFrame* @frame) => delegates.av_guess_sample_aspect_ratio(@format, @stream, @frame);
    ...
    public static void av_hex_dump(_iobuf* @f, byte* @buf, int @size) => delegates.av_hex_dump(@f, @buf, @size);
    ...
    /// <param name="buf">buffer</param>
    /// <param name="size">buffer size</param>
    public static void av_hex_dump_log(void* @avcl, int @level, byte* @buf, int @size) => delegates.av_hex_dump_log(@avcl, @level, @buf, @size);
    ...
    public static int av_index_search_timestamp(AVStream* @st, long @timestamp, int @flags) => delegates.av_index_search_timestamp(@st, @timestamp, @flags);
    ...
    /// <returns>0 on success, a negative AVERROR on error.</returns>
    public static int av_interleaved_write_frame(AVFormatContext* @s, AVPacket* @pkt) => delegates.av_interleaved_write_frame(@s, @pkt);
    
    
    /// <summary>Write an uncoded frame to an output media file.</summary>
    /// <returns>&gt;=0 for success, a negative code on error</returns>
    public static int av_interleaved_write_uncoded_frame(AVFormatContext* @s, int @stream_index, AVFrame* @frame) => delegates.av_interleaved_write_uncoded_frame(@s, @stream_index, @frame);
    ...
    public static int av_match_ext(string @filename, string @extensions) => delegates.av_match_ext(@filename, @extensions);
    ...
    public static AVOutputFormat* av_muxer_iterate(void** @opaque) => delegates.av_muxer_iterate(@opaque);
    
    
    public static AVProgram* av_new_program(AVFormatContext* @s, int @id) => delegates.av_new_program(@s, @id);
    ...
    public static void av_pkt_dump_log2(void* @avcl, int @level, AVPacket* @pkt, int @dump_payload, AVStream* @st) => delegates.av_pkt_dump_log2(@avcl, @level, @pkt, @dump_payload, @st);
    ...
    /// <param name="dump_payload">True if the payload must be displayed, too.</param>
    /// <param name="st">AVStream that the packet belongs to</param>
    public static void av_pkt_dump2(_iobuf* @f, AVPacket* @pkt, int @dump_payload, AVStream* @st) => delegates.av_pkt_dump2(@f, @pkt, @dump_payload, @st);
    
    
    /// <summary>Like av_probe_input_buffer2() but returns 0 on success</summary>
    public static int av_probe_input_buffer(AVIOContext* @pb, AVInputFormat** @fmt, string @url, void* @logctx, uint @offset, uint @max_probe_size) => delegates.av_probe_input_buffer(@pb, @fmt, @url, @logctx, @offset, @max_probe_size);
    ...
    public static int av_probe_input_buffer2(AVIOContext* @pb, AVInputFormat** @fmt, string @url, void* @logctx, uint @offset, uint @max_probe_size) => delegates.av_probe_input_buffer2(@pb, @fmt, @url, @logctx, @offset, @max_probe_size);
    ...
    public static AVInputFormat* av_probe_input_format(AVProbeData* @pd, int @is_opened) => delegates.av_probe_input_format(@pd, @is_opened);
    ...
    public static AVInputFormat* av_probe_input_format2(AVProbeData* @pd, int @is_opened, int* @score_max) => delegates.av_probe_input_format2(@pd, @is_opened, @score_max);
    
    
    /// <summary>Guess the file format.</summary>
    /// <param name="is_opened">Whether the file is already opened; determines whether demuxers with or without AVFMT_NOFILE are probed.</param>
    /// <param name="score_ret">The score of the best detection.</param>
    public static AVInputFormat* av_probe_input_format3(AVProbeData* @pd, int @is_opened, int* @score_ret) => delegates.av_probe_input_format3(@pd, @is_opened, @score_ret);
    
    
    public static void av_program_add_stream_index(AVFormatContext* @ac, int @progid, uint @idx) => delegates.av_program_add_stream_index(@ac, @progid, @idx);
    ...
    public static int av_read_frame(AVFormatContext* @s, AVPacket* @pkt) => delegates.av_read_frame(@s, @pkt);
    
    
    /// <summary>Pause a network-based stream (e.g. RTSP stream).</summary>
    public static int av_read_pause(AVFormatContext* @s) => delegates.av_read_pause(@s);
    
    
    /// <summary>Start playing a network-based stream (e.g. RTSP stream) at the current position.</summary>
    public static int av_read_play(AVFormatContext* @s) => delegates.av_read_play(@s);
    ...
    public static int av_sdp_create(AVFormatContext** @ac, int @n_files, byte* @buf, int @size) => delegates.av_sdp_create(@ac, @n_files, @buf, @size);
    ...
    public static int av_seek_frame(AVFormatContext* @s, int @stream_index, long @timestamp, int @flags) => delegates.av_seek_frame(@s, @stream_index, @timestamp, @flags);
    ...
    public static int av_stream_add_side_data(AVStream* @st, AVPacketSideDataType @type, byte* @data, ulong @size) => delegates.av_stream_add_side_data(@st, @type, @data, @size);
    ...
    public static AVClass* av_stream_get_class() => delegates.av_stream_get_class();
    ...
    public static AVRational av_stream_get_codec_timebase(AVStream* @st) => delegates.av_stream_get_codec_timebase(@st);
    
    
    /// <summary>Returns the pts of the last muxed packet + its duration</summary>
    public static long av_stream_get_end_pts(AVStream* @st) => delegates.av_stream_get_end_pts(@st);
    
    
    public static AVCodecParserContext* av_stream_get_parser(AVStream* @s) => delegates.av_stream_get_parser(@s);
    ...
    /// <param name="size">If supplied, *size will be set to the size of the side data or to zero if the desired side data is not present.</param>
    /// <returns>pointer to data if present or NULL otherwise</returns>
    public static byte* av_stream_get_side_data(AVStream* @stream, AVPacketSideDataType @type, ulong* @size) => delegates.av_stream_get_side_data(@stream, @type, @size);
    ...
    /// <param name="size">side information size</param>
    /// <returns>pointer to fresh allocated data or NULL otherwise</returns>
    public static byte* av_stream_new_side_data(AVStream* @stream, AVPacketSideDataType @type, ulong @size) => delegates.av_stream_new_side_data(@stream, @type, @size);
    ...
    public static void av_url_split(byte* @proto, int @proto_size, byte* @authorization, int @authorization_size, byte* @hostname, int @hostname_size, int* @port_ptr, byte* @path, int @path_size, string @url) => delegates.av_url_split(@proto, @proto_size, @authorization, @authorization_size, @hostname, @hostname_size, @port_ptr, @path, @path_size, @url);
    ...
    public static int av_write_frame(AVFormatContext* @s, AVPacket* @pkt) => delegates.av_write_frame(@s, @pkt);
    
    
    /// <summary>Write the stream trailer to an output media file and free the file private data.</summary>
    /// <param name="s">media file handle</param>
    /// <returns>0 if OK, AVERROR_xxx on error</returns>
    public static int av_write_trailer(AVFormatContext* @s) => delegates.av_write_trailer(@s);
    
    
    /// <summary>Write an uncoded frame to an output media file.</summary>
    public static int av_write_uncoded_frame(AVFormatContext* @s, int @stream_index, AVFrame* @frame) => delegates.av_write_uncoded_frame(@s, @stream_index, @frame);
    ...
    public static int av_write_uncoded_frame_query(AVFormatContext* @s, int @stream_index) => delegates.av_write_uncoded_frame_query(@s, @stream_index);
    ...
    public static AVFormatContext* avformat_alloc_context() => delegates.avformat_alloc_context();
    ...
    /// <returns>&gt;= 0 in case of success, a negative AVERROR code in case of failure</returns>
    public static int avformat_alloc_output_context2(AVFormatContext** @ctx, AVOutputFormat* @oformat, string @format_name, string @filename) => delegates.avformat_alloc_output_context2(@ctx, @oformat, @format_name, @filename);
    
    
    /// <summary>Close an opened input AVFormatContext. Free it and all its contents and set *s to NULL.</summary>
    public static void avformat_close_input(AVFormatContext** @s) => delegates.avformat_close_input(@s);
    
    
    /// <summary>Return the libavformat build-time configuration.</summary>
    public static string avformat_configuration() => delegates.avformat_configuration();
    ...
    /// <returns>&gt;=0 if OK, AVERROR_xxx on error</returns>
    public static int avformat_find_stream_info(AVFormatContext* @ic, AVDictionary** @options) => delegates.avformat_find_stream_info(@ic, @options);
    ...
    public static int avformat_flush(AVFormatContext* @s) => delegates.avformat_flush(@s);
    
    
    /// <summary>Free an AVFormatContext and all its streams.</summary>
    /// <param name="s">context to free</param>
    public static void avformat_free_context(AVFormatContext* @s) => delegates.avformat_free_context(@s);
    ...
    public static AVClass* avformat_get_class() => delegates.avformat_get_class();
    ...
    public static AVCodecTag* avformat_get_mov_audio_tags() => delegates.avformat_get_mov_audio_tags();
    ...
    public static AVCodecTag* avformat_get_mov_video_tags() => delegates.avformat_get_mov_video_tags();
    ...
    public static AVCodecTag* avformat_get_riff_audio_tags() => delegates.avformat_get_riff_audio_tags();
    ...
    public static AVCodecTag* avformat_get_riff_video_tags() => delegates.avformat_get_riff_video_tags();
    ...
    public static int avformat_index_get_entries_count(AVStream* @st) => delegates.avformat_index_get_entries_count(@st);
    ...
    public static AVIndexEntry* avformat_index_get_entry(AVStream* @st, int @idx) => delegates.avformat_index_get_entry(@st, @idx);
    ...
    /// <returns>A pointer to the requested AVIndexEntry if it exists, NULL otherwise.</returns>
    public static AVIndexEntry* avformat_index_get_entry_from_timestamp(AVStream* @st, long @wanted_timestamp, int @flags) => delegates.avformat_index_get_entry_from_timestamp(@st, @wanted_timestamp, @flags);
    ...
    public static int avformat_init_output(AVFormatContext* @s, AVDictionary** @options) => delegates.avformat_init_output(@s, @options);
    
    
    /// <summary>Return the libavformat license.</summary>
    public static string avformat_license() => delegates.avformat_license();
    ...
    public static int avformat_match_stream_specifier(AVFormatContext* @s, AVStream* @st, string @spec) => delegates.avformat_match_stream_specifier(@s, @st, @spec);
    ...
    public static int avformat_network_deinit() => delegates.avformat_network_deinit();
    
    
    /// <summary>Do global initialization of network libraries. This is optional, and not recommended anymore.</summary>
    public static int avformat_network_init() => delegates.avformat_network_init();
    ...
    public static AVStream* avformat_new_stream(AVFormatContext* @s, AVCodec* @c) => delegates.avformat_new_stream(@s, @c);
    ...
    /// <returns>0 on success, a negative AVERROR on failure.</returns>
    public static int avformat_open_input(AVFormatContext** @ps, string @url, AVInputFormat* @fmt, AVDictionary** @options) => delegates.avformat_open_input(@ps, @url, @fmt, @options);
    ...
    public static int avformat_query_codec(AVOutputFormat* @ofmt, AVCodecID @codec_id, int @std_compliance) => delegates.avformat_query_codec(@ofmt, @codec_id, @std_compliance);
    
    
    public static int avformat_queue_attached_pictures(AVFormatContext* @s) => delegates.avformat_queue_attached_pictures(@s);
    ...
    /// <returns>&gt;=0 on success, error code otherwise</returns>
    public static int avformat_seek_file(AVFormatContext* @s, int @stream_index, long @min_ts, long @ts, long @max_ts, int @flags) => delegates.avformat_seek_file(@s, @stream_index, @min_ts, @ts, @max_ts, @flags);
    ...
    public static int avformat_transfer_internal_stream_timing_info(AVOutputFormat* @ofmt, AVStream* @ost, AVStream* @ist, AVTimebaseSource @copy_tb) => delegates.avformat_transfer_internal_stream_timing_info(@ofmt, @ost, @ist, @copy_tb);
    
    
    /// <summary>Return the LIBAVFORMAT_VERSION_INT constant.</summary>
    public static uint avformat_version() => delegates.avformat_version();
    ...
    public static int avformat_write_header(AVFormatContext* @s, AVDictionary** @options) => delegates.avformat_write_header(@s, @options);
    ...
    public static int avio_accept(AVIOContext* @s, AVIOContext** @c) => delegates.avio_accept(@s, @c);
    ...
    public static int avio_check(string @url, int @flags) => delegates.avio_check(@url, @flags);
    ...
    public static int avio_close(AVIOContext* @s) => delegates.avio_close(@s);
    ...
    public static int avio_close_dir(AVIODirContext** @s) => delegates.avio_close_dir(@s);
    ...
    public static int avio_close_dyn_buf(AVIOContext* @s, byte** @pbuffer) => delegates.avio_close_dyn_buf(@s, @pbuffer);
    ...
    /// <returns>0 on success, an AVERROR &lt; 0 on error.</returns>
    public static int avio_closep(AVIOContext** @s) => delegates.avio_closep(@s);
    ...
    public static void avio_context_free(AVIOContext** @s) => delegates.avio_context_free(@s);
    ...
    public static string avio_enum_protocols(void** @opaque, int @output) => delegates.avio_enum_protocols(@opaque, @output);
    ...
    public static int avio_feof(AVIOContext* @s) => delegates.avio_feof(@s);
    ...
    public static string avio_find_protocol_name(string @url) => delegates.avio_find_protocol_name(@url);
    
    
    /// <summary>Force flushing of buffered data.</summary>
    public static void avio_flush(AVIOContext* @s) => delegates.avio_flush(@s);
    
    
    /// <summary>Free entry allocated by avio_read_dir().</summary>
    /// <param name="entry">entry to be freed.</param>
    public static void avio_free_directory_entry(AVIODirEntry** @entry) => delegates.avio_free_directory_entry(@entry);
    ...
    /// <param name="pbuffer">pointer to a byte buffer</param>
    /// <returns>the length of the byte buffer</returns>
    public static int avio_get_dyn_buf(AVIOContext* @s, byte** @pbuffer) => delegates.avio_get_dyn_buf(@s, @pbuffer);
    ...
    public static int avio_get_str(AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) => delegates.avio_get_str(@pb, @maxlen, @buf, @buflen);
    
    
    public static int avio_get_str16be(AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) => delegates.avio_get_str16be(@pb, @maxlen, @buf, @buflen);
    ...
    public static int avio_get_str16le(AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) => delegates.avio_get_str16le(@pb, @maxlen, @buf, @buflen);
    ...
    public static int avio_handshake(AVIOContext* @c) => delegates.avio_handshake(@c);
    ...
    public static int avio_open(AVIOContext** @s, string @url, int @flags) => delegates.avio_open(@s, @url, @flags);
    ...
    /// <returns>&gt;=0 on success or negative on error.</returns>
    public static int avio_open_dir(AVIODirContext** @s, string @url, AVDictionary** @options) => delegates.avio_open_dir(@s, @url, @options);
    
    
    /// <summary>Open a write only memory stream.</summary>
    /// <param name="s">new IO context</param>
    /// <returns>zero if no error.</returns>
    public static int avio_open_dyn_buf(AVIOContext** @s) => delegates.avio_open_dyn_buf(@s);
    ...
    /// <returns>&gt;= 0 in case of success, a negative value corresponding to an AVERROR code in case of failure</returns>
    public static int avio_open2(AVIOContext** @s, string @url, int @flags, AVIOInterruptCB* @int_cb, AVDictionary** @options) => delegates.avio_open2(@s, @url, @flags, @int_cb, @options);
    ...
    public static int avio_pause(AVIOContext* @h, int @pause) => delegates.avio_pause(@h, @pause);
    ...
    public static void avio_print_string_array(AVIOContext* @s, byte*[] @strings) => delegates.avio_print_string_array(@s, @strings);
    
    
    /// <summary>Writes a formatted string to the context.</summary>
    /// <returns>number of bytes written, &lt; 0 on error.</returns>
    public static int avio_printf(AVIOContext* @s, string @fmt) => delegates.avio_printf(@s, @fmt);
    
    
    /// <summary>Get AVClass by names of available protocols.</summary>
    /// <returns>A AVClass of input protocol name or NULL</returns>
    public static AVClass* avio_protocol_get_class(string @name) => delegates.avio_protocol_get_class(@name);
    
    
    /// <summary>Write a NULL-terminated string.</summary>
    /// <returns>number of bytes written.</returns>
    public static int avio_put_str(AVIOContext* @s, string @str) => delegates.avio_put_str(@s, @str);
    ...
    /// <returns>number of bytes written.</returns>
    public static int avio_put_str16be(AVIOContext* @s, string @str) => delegates.avio_put_str16be(@s, @str);
    ...
    /// <param name="str">NULL-terminated UTF-8 string</param>
    /// <returns>number of bytes written.</returns>
    public static int avio_put_str16le(AVIOContext* @s, string @str) => delegates.avio_put_str16le(@s, @str);
    
    
    /// <summary>@{</summary>
    public static int avio_r8(AVIOContext* @s) => delegates.avio_r8(@s);
    
    
    public static uint avio_rb16(AVIOContext* @s) => delegates.avio_rb16(@s);
    
    
    public static uint avio_rb24(AVIOContext* @s) => delegates.avio_rb24(@s);
    
    
    public static uint avio_rb32(AVIOContext* @s) => delegates.avio_rb32(@s);
    
    
    public static ulong avio_rb64(AVIOContext* @s) => delegates.avio_rb64(@s);
    
    
    /// <summary>Read size bytes from AVIOContext into buf.</summary>
    /// <returns>number of bytes read or AVERROR</returns>
    public static int avio_read(AVIOContext* @s, byte* @buf, int @size) => delegates.avio_read(@s, @buf, @size);
    ...
    public static int avio_read_dir(AVIODirContext* @s, AVIODirEntry** @next) => delegates.avio_read_dir(@s, @next);
    ...
    /// <returns>number of bytes read or AVERROR</returns>
    public static int avio_read_partial(AVIOContext* @s, byte* @buf, int @size) => delegates.avio_read_partial(@s, @buf, @size);
    ...
    public static int avio_read_to_bprint(AVIOContext* @h, AVBPrint* @pb, ulong @max_size) => delegates.avio_read_to_bprint(@h, @pb, @max_size);
    
    
    public static uint avio_rl16(AVIOContext* @s) => delegates.avio_rl16(@s);
    
    
    public static uint avio_rl24(AVIOContext* @s) => delegates.avio_rl24(@s);
    
    
    public static uint avio_rl32(AVIOContext* @s) => delegates.avio_rl32(@s);
    
    
    public static ulong avio_rl64(AVIOContext* @s) => delegates.avio_rl64(@s);
    
    
    /// <summary>fseek() equivalent for AVIOContext.</summary>
    /// <returns>new position or AVERROR.</returns>
    public static long avio_seek(AVIOContext* @s, long @offset, int @whence) => delegates.avio_seek(@s, @offset, @whence);
    ...
    /// <returns>&gt;= 0 on success</returns>
    public static long avio_seek_time(AVIOContext* @h, int @stream_index, long @timestamp, int @flags) => delegates.avio_seek_time(@h, @stream_index, @timestamp, @flags);
    
    
    /// <summary>Get the filesize.</summary>
    /// <returns>filesize or AVERROR</returns>
    public static long avio_size(AVIOContext* @s) => delegates.avio_size(@s);
    
    
    /// <summary>Skip given number of bytes forward</summary>
    /// <returns>new position or AVERROR.</returns>
    public static long avio_skip(AVIOContext* @s, long @offset) => delegates.avio_skip(@s, @offset);
    
    
    /// <summary>Writes a formatted string to the context taking a va_list.</summary>
    /// <returns>number of bytes written, &lt; 0 on error.</returns>
    public static int avio_vprintf(AVIOContext* @s, string @fmt, byte* @ap) => delegates.avio_vprintf(@s, @fmt, @ap);
    
    
    public static void avio_w8(AVIOContext* @s, int @b) => delegates.avio_w8(@s, @b);
    
    
    public static void avio_wb16(AVIOContext* @s, uint @val) => delegates.avio_wb16(@s, @val);
    
    
    public static void avio_wb24(AVIOContext* @s, uint @val) => delegates.avio_wb24(@s, @val);
    
    
    public static void avio_wb32(AVIOContext* @s, uint @val) => delegates.avio_wb32(@s, @val);
    
    
    public static void avio_wb64(AVIOContext* @s, ulong @val) => delegates.avio_wb64(@s, @val);
    
    
    public static void avio_wl16(AVIOContext* @s, uint @val) => delegates.avio_wl16(@s, @val);
    
    
    public static void avio_wl24(AVIOContext* @s, uint @val) => delegates.avio_wl24(@s, @val);
    
    
    public static void avio_wl32(AVIOContext* @s, uint @val) => delegates.avio_wl32(@s, @val);
    
    
    public static void avio_wl64(AVIOContext* @s, ulong @val) => delegates.avio_wl64(@s, @val);
    
    
    public static void avio_write(AVIOContext* @s, byte* @buf, int @size) => delegates.avio_write(@s, @buf, @size);
    ...
    public static void avio_write_marker(AVIOContext* @s, long @time, AVIODataMarkerType @type) => delegates.avio_write_marker(@s, @time, @type);
    ...
    /// <returns>b+c</returns>
    public static AVRational av_add_q(AVRational @b, AVRational @c) => delegates.av_add_q(@b, @c);
    ...
    public static long av_add_stable(AVRational @ts_tb, long @ts, AVRational @inc_tb, long @inc) => delegates.av_add_stable(@ts_tb, @ts, @inc_tb, @inc);
    ...
    public static AVAudioFifo* av_audio_fifo_alloc(AVSampleFormat @sample_fmt, int @channels, int @nb_samples) => delegates.av_audio_fifo_alloc(@sample_fmt, @channels, @nb_samples);
    ...
    public static int av_audio_fifo_drain(AVAudioFifo* @af, int @nb_samples) => delegates.av_audio_fifo_drain(@af, @nb_samples);
    
    
    /// <summary>Free an AVAudioFifo.</summary>
    /// <param name="af">AVAudioFifo to free</param>
    public static void av_audio_fifo_free(AVAudioFifo* @af) => delegates.av_audio_fifo_free(@af);
    ...
    public static int av_audio_fifo_peek(AVAudioFifo* @af, void** @data, int @nb_samples) => delegates.av_audio_fifo_peek(@af, @data, @nb_samples);
    ...
    /// <returns>number of samples actually peek, or negative AVERROR code on failure. The number of samples actually peek will not be greater than nb_samples, and will only be less than nb_samples if av_audio_fifo_size is less than nb_samples.</returns>
    public static int av_audio_fifo_peek_at(AVAudioFifo* @af, void** @data, int @nb_samples, int @offset) => delegates.av_audio_fifo_peek_at(@af, @data, @nb_samples, @offset);
    ...
    public static int av_audio_fifo_read(AVAudioFifo* @af, void** @data, int @nb_samples) => delegates.av_audio_fifo_read(@af, @data, @nb_samples);
    ...
    /// <returns>0 if OK, or negative AVERROR code on failure</returns>
    public static int av_audio_fifo_realloc(AVAudioFifo* @af, int @nb_samples) => delegates.av_audio_fifo_realloc(@af, @nb_samples);
    
    
    /// <summary>Reset the AVAudioFifo buffer.</summary>
    /// <param name="af">AVAudioFifo to reset</param>
    public static void av_audio_fifo_reset(AVAudioFifo* @af) => delegates.av_audio_fifo_reset(@af);
    ...
    public static int av_audio_fifo_size(AVAudioFifo* @af) => delegates.av_audio_fifo_size(@af);
    ...
    public static int av_audio_fifo_space(AVAudioFifo* @af) => delegates.av_audio_fifo_space(@af);
    ...
    public static int av_audio_fifo_write(AVAudioFifo* @af, void** @data, int @nb_samples) => delegates.av_audio_fifo_write(@af, @data, @nb_samples);
    
    
    /// <summary>Append a description of a channel layout to a bprint buffer.</summary>
    [Obsolete("use av_channel_layout_describe()")]
    public static void av_bprint_channel_layout(AVBPrint* @bp, int @nb_channels, ulong @channel_layout) => delegates.av_bprint_channel_layout(@bp, @nb_channels, @channel_layout);
    ...
    public static AVBufferRef* av_buffer_alloc(ulong @size) => delegates.av_buffer_alloc(@size);
    
    
    /// <summary>Same as av_buffer_alloc(), except the returned buffer will be initialized to zero.</summary>
    public static AVBufferRef* av_buffer_allocz(ulong @size) => delegates.av_buffer_allocz(@size);
    ...
    public static AVBufferRef* av_buffer_create(byte* @data, ulong @size, av_buffer_create_free_func @free, void* @opaque, int @flags) => delegates.av_buffer_create(@data, @size, @free, @opaque, @flags);
    ...
    public static void av_buffer_default_free(void* @opaque, byte* @data) => delegates.av_buffer_default_free(@opaque, @data);
    ...
    public static void* av_buffer_get_opaque(AVBufferRef* @buf) => delegates.av_buffer_get_opaque(@buf);
    
    
    public static int av_buffer_get_ref_count(AVBufferRef* @buf) => delegates.av_buffer_get_ref_count(@buf);
    ...
    public static int av_buffer_is_writable(AVBufferRef* @buf) => delegates.av_buffer_is_writable(@buf);
    ...
    /// <returns>0 on success, a negative AVERROR on failure.</returns>
    public static int av_buffer_make_writable(AVBufferRef** @buf) => delegates.av_buffer_make_writable(@buf);
    ...
    public static void* av_buffer_pool_buffer_get_opaque(AVBufferRef* @ref) => delegates.av_buffer_pool_buffer_get_opaque(@ref);
    ...
    public static AVBufferRef* av_buffer_pool_get(AVBufferPool* @pool) => delegates.av_buffer_pool_get(@pool);
    ...
    public static AVBufferPool* av_buffer_pool_init(ulong @size, av_buffer_pool_init_alloc_func @alloc) => delegates.av_buffer_pool_init(@size, @alloc);
    ...
    /// <returns>newly created buffer pool on success, NULL on error.</returns>
    public static AVBufferPool* av_buffer_pool_init2(ulong @size, void* @opaque, av_buffer_pool_init2_alloc_func @alloc, av_buffer_pool_init2_pool_free_func @pool_free) => delegates.av_buffer_pool_init2(@size, @opaque, @alloc, @pool_free);
    ...
    public static void av_buffer_pool_uninit(AVBufferPool** @pool) => delegates.av_buffer_pool_uninit(@pool);
    ...
    /// <returns>0 on success, a negative AVERROR on failure.</returns>
    public static int av_buffer_realloc(AVBufferRef** @buf, ulong @size) => delegates.av_buffer_realloc(@buf, @size);
    ...
    public static AVBufferRef* av_buffer_ref(AVBufferRef* @buf) => delegates.av_buffer_ref(@buf);
    ...
    public static int av_buffer_replace(AVBufferRef** @dst, AVBufferRef* @src) => delegates.av_buffer_replace(@dst, @src);
    ...
    public static void av_buffer_unref(AVBufferRef** @buf) => delegates.av_buffer_unref(@buf);
    ...
    public static void* av_calloc(ulong @nmemb, ulong @size) => delegates.av_calloc(@nmemb, @size);
    ...
    public static int av_channel_description(byte* @buf, ulong @buf_size, AVChannel @channel) => delegates.av_channel_description(@buf, @buf_size, @channel);
    
    
    /// <summary>bprint variant of av_channel_description().</summary>
    public static void av_channel_description_bprint(AVBPrint* @bp, AVChannel @channel_id) => delegates.av_channel_description_bprint(@bp, @channel_id);
    ...
    public static AVChannel av_channel_from_string(string @name) => delegates.av_channel_from_string(@name);
    ...
    public static AVChannel av_channel_layout_channel_from_index(AVChannelLayout* @channel_layout, uint @idx) => delegates.av_channel_layout_channel_from_index(@channel_layout, @idx);
    ...
    public static AVChannel av_channel_layout_channel_from_string(AVChannelLayout* @channel_layout, string @name) => delegates.av_channel_layout_channel_from_string(@channel_layout, @name);
    ...
    public static int av_channel_layout_check(AVChannelLayout* @channel_layout) => delegates.av_channel_layout_check(@channel_layout);
    ...
    public static int av_channel_layout_compare(AVChannelLayout* @chl, AVChannelLayout* @chl1) => delegates.av_channel_layout_compare(@chl, @chl1);
    ...
    /// <returns>0 on success, a negative AVERROR on error.</returns>
    public static int av_channel_layout_copy(AVChannelLayout* @dst, AVChannelLayout* @src) => delegates.av_channel_layout_copy(@dst, @src);
    ...
    public static void av_channel_layout_default(AVChannelLayout* @ch_layout, int @nb_channels) => delegates.av_channel_layout_default(@ch_layout, @nb_channels);
    ...
    /// <param name="buf_size">size in bytes of the buffer.</param>
    /// <returns>amount of bytes needed to hold the output string, or a negative AVERROR on failure. If the returned value is bigger than buf_size, then the string was truncated.</returns>
    public static int av_channel_layout_describe(AVChannelLayout* @channel_layout, byte* @buf, ulong @buf_size) => delegates.av_channel_layout_describe(@channel_layout, @buf, @buf_size);
    ...
    public static int av_channel_layout_describe_bprint(AVChannelLayout* @channel_layout, AVBPrint* @bp) => delegates.av_channel_layout_describe_bprint(@channel_layout, @bp);
    
    
    /// <summary>Get the channel with the given index in channel_layout.</summary>
    [Obsolete("use av_channel_layout_channel_from_index()")]
    public static ulong av_channel_layout_extract_channel(ulong @channel_layout, int @index) => delegates.av_channel_layout_extract_channel(@channel_layout, @index);
    ...
    public static int av_channel_layout_from_mask(AVChannelLayout* @channel_layout, ulong @mask) => delegates.av_channel_layout_from_mask(@channel_layout, @mask);
    ...
    public static int av_channel_layout_from_string(AVChannelLayout* @channel_layout, string @str) => delegates.av_channel_layout_from_string(@channel_layout, @str);
    ...
    public static int av_channel_layout_index_from_channel(AVChannelLayout* @channel_layout, AVChannel @channel) => delegates.av_channel_layout_index_from_channel(@channel_layout, @channel);
    ...
    public static int av_channel_layout_index_from_string(AVChannelLayout* @channel_layout, string @name) => delegates.av_channel_layout_index_from_string(@channel_layout, @name);
    ...
    public static AVChannelLayout* av_channel_layout_standard(void** @opaque) => delegates.av_channel_layout_standard(@opaque);
    ...
    public static ulong av_channel_layout_subset(AVChannelLayout* @channel_layout, ulong @mask) => delegates.av_channel_layout_subset(@channel_layout, @mask);
    ...
    public static void av_channel_layout_uninit(AVChannelLayout* @channel_layout) => delegates.av_channel_layout_uninit(@channel_layout);
    ...
    /// <param name="buf_size">size in bytes of the buffer.</param>
    /// <returns>amount of bytes needed to hold the output string, or a negative AVERROR on failure. If the returned value is bigger than buf_size, then the string was truncated.</returns>
    public static int av_channel_name(byte* @buf, ulong @buf_size, AVChannel @channel) => delegates.av_channel_name(@buf, @buf_size, @channel);
    
    
    /// <summary>bprint variant of av_channel_name().</summary>
    public static void av_channel_name_bprint(AVBPrint* @bp, AVChannel @channel_id) => delegates.av_channel_name_bprint(@bp, @channel_id);
    ...
    public static int av_chroma_location_from_name(string @name) => delegates.av_chroma_location_from_name(@name);
    ...
    public static string av_chroma_location_name(AVChromaLocation @location) => delegates.av_chroma_location_name(@location);
    ...
    public static int av_color_primaries_from_name(string @name) => delegates.av_color_primaries_from_name(@name);
    ...
    public static string av_color_primaries_name(AVColorPrimaries @primaries) => delegates.av_color_primaries_name(@primaries);
    ...
    public static int av_color_range_from_name(string @name) => delegates.av_color_range_from_name(@name);
    ...
    public static string av_color_range_name(AVColorRange @range) => delegates.av_color_range_name(@range);
    ...
    public static int av_color_space_from_name(string @name) => delegates.av_color_space_from_name(@name);
    ...
    public static string av_color_space_name(AVColorSpace @space) => delegates.av_color_space_name(@space);
    ...
    public static int av_color_transfer_from_name(string @name) => delegates.av_color_transfer_from_name(@name);
    ...
    public static string av_color_transfer_name(AVColorTransferCharacteristic @transfer) => delegates.av_color_transfer_name(@transfer);
    ...
    public static long av_compare_mod(ulong @a, ulong @b, ulong @mod) => delegates.av_compare_mod(@a, @b, @mod);
    ...
    public static int av_compare_ts(long @ts_a, AVRational @tb_a, long @ts_b, AVRational @tb_b) => delegates.av_compare_ts(@ts_a, @tb_a, @ts_b, @tb_b);
    ...
    public static AVContentLightMetadata* av_content_light_metadata_alloc(ulong* @size) => delegates.av_content_light_metadata_alloc(@size);
    ...
    public static AVContentLightMetadata* av_content_light_metadata_create_side_data(AVFrame* @frame) => delegates.av_content_light_metadata_create_side_data(@frame);
    
    
    /// <summary>Returns the number of logical CPU cores present.</summary>
    /// <returns>the number of logical CPU cores present.</returns>
    public static int av_cpu_count() => delegates.av_cpu_count();
    
    
    /// <summary>Overrides cpu count detection and forces the specified count. Count &lt; 1 disables forcing of specific count.</summary>
    public static void av_cpu_force_count(int @count) => delegates.av_cpu_force_count(@count);
    
    
    /// <summary>Get the maximum data alignment that may be required by FFmpeg.</summary>
    public static ulong av_cpu_max_align() => delegates.av_cpu_max_align();
    ...
    public static AVRational av_d2q(double @d, int @max) => delegates.av_d2q(@d, @max);
    
    
    public static AVClassCategory av_default_get_category(void* @ptr) => delegates.av_default_get_category(@ptr);
    
    
    /// <summary>Return the context name</summary>
    /// <param name="ctx">The AVClass context</param>
    /// <returns>The AVClass class_name</returns>
    public static string av_default_item_name(void* @ctx) => delegates.av_default_item_name(@ctx);
    ...
    public static int av_dict_copy(AVDictionary** @dst, AVDictionary* @src, int @flags) => delegates.av_dict_copy(@dst, @src, @flags);
    ...
    public static int av_dict_count(AVDictionary* @m) => delegates.av_dict_count(@m);
    
    
    /// <summary>Free all the memory allocated for an AVDictionary struct and all keys and values.</summary>
    public static void av_dict_free(AVDictionary** @m) => delegates.av_dict_free(@m);
    ...
    public static AVDictionaryEntry* av_dict_get(AVDictionary* @m, string @key, AVDictionaryEntry* @prev, int @flags) => delegates.av_dict_get(@m, @key, @prev, @flags);
    ...
    public static int av_dict_get_string(AVDictionary* @m, byte** @buffer, byte @key_val_sep, byte @pairs_sep) => delegates.av_dict_get_string(@m, @buffer, @key_val_sep, @pairs_sep);
    ...
    public static int av_dict_parse_string(AVDictionary** @pm, string @str, string @key_val_sep, string @pairs_sep, int @flags) => delegates.av_dict_parse_string(@pm, @str, @key_val_sep, @pairs_sep, @flags);
    ...
    public static int av_dict_set(AVDictionary** @pm, string @key, string @value, int @flags) => delegates.av_dict_set(@pm, @key, @value, @flags);
    
    
    /// <summary>Convenience wrapper for av_dict_set that converts the value to a string and stores it.</summary>
    public static int av_dict_set_int(AVDictionary** @pm, string @key, long @value, int @flags) => delegates.av_dict_set_int(@pm, @key, @value, @flags);
    ...
    /// <param name="c">Second rational</param>
    /// <returns>b/c</returns>
    public static AVRational av_div_q(AVRational @b, AVRational @c) => delegates.av_div_q(@b, @c);
    ...
    public static AVDynamicHDRPlus* av_dynamic_hdr_plus_alloc(ulong* @size) => delegates.av_dynamic_hdr_plus_alloc(@size);
    ...
    public static AVDynamicHDRPlus* av_dynamic_hdr_plus_create_side_data(AVFrame* @frame) => delegates.av_dynamic_hdr_plus_create_side_data(@frame);
    ...
    public static void av_dynarray_add(void* @tab_ptr, int* @nb_ptr, void* @elem) => delegates.av_dynarray_add(@tab_ptr, @nb_ptr, @elem);
    
    
    /// <summary>Add an element to a dynamic array.</summary>
    /// <returns>&gt;=0 on success, negative otherwise</returns>
    public static int av_dynarray_add_nofree(void* @tab_ptr, int* @nb_ptr, void* @elem) => delegates.av_dynarray_add_nofree(@tab_ptr, @nb_ptr, @elem);
    ...
    public static void* av_dynarray2_add(void** @tab_ptr, int* @nb_ptr, ulong @elem_size, byte* @elem_data) => delegates.av_dynarray2_add(@tab_ptr, @nb_ptr, @elem_size, @elem_data);
    ...
    public static void av_fast_malloc(void* @ptr, uint* @size, ulong @min_size) => delegates.av_fast_malloc(@ptr, @size, @min_size);
    ...
    /// <param name="size">Pointer to the size of buffer `*ptr`. `*size` is updated to the new allocated size, in particular 0 in case of failure.</param>
    /// <param name="min_size">Desired minimal size of buffer `*ptr`</param>
    public static void av_fast_mallocz(void* @ptr, uint* @size, ulong @min_size) => delegates.av_fast_mallocz(@ptr, @size, @min_size);
    ...
    public static void* av_fast_realloc(void* @ptr, uint* @size, ulong @min_size) => delegates.av_fast_realloc(@ptr, @size, @min_size);
    ...
    public static int av_file_map(string @filename, byte** @bufptr, ulong* @size, int @log_offset, void* @log_ctx) => delegates.av_file_map(@filename, @bufptr, @size, @log_offset, @log_ctx);
    ...
    public static void av_file_unmap(byte* @bufptr, ulong @size) => delegates.av_file_unmap(@bufptr, @size);
    ...
    public static AVPixelFormat av_find_best_pix_fmt_of_2(AVPixelFormat @dst_pix_fmt1, AVPixelFormat @dst_pix_fmt2, AVPixelFormat @src_pix_fmt, int @has_alpha, int* @loss_ptr) => delegates.av_find_best_pix_fmt_of_2(@dst_pix_fmt1, @dst_pix_fmt2, @src_pix_fmt, @has_alpha, @loss_ptr);
    ...
    public static int av_find_nearest_q_idx(AVRational @q, AVRational* @q_list) => delegates.av_find_nearest_q_idx(@q, @q_list);
    ...
    public static _iobuf* av_fopen_utf8(string @path, string @mode) => delegates.av_fopen_utf8(@path, @mode);
    ...
    public static void av_force_cpu_flags(int @flags) => delegates.av_force_cpu_flags(@flags);
    ...
    public static byte* av_fourcc_make_string(byte* @buf, uint @fourcc) => delegates.av_fourcc_make_string(@buf, @fourcc);
    ...
    public static AVFrame* av_frame_alloc() => delegates.av_frame_alloc();
    ...
    public static int av_frame_apply_cropping(AVFrame* @frame, int @flags) => delegates.av_frame_apply_cropping(@frame, @flags);
    ...
    public static AVFrame* av_frame_clone(AVFrame* @src) => delegates.av_frame_clone(@src);
    
    
    /// <summary>Copy the frame data from src to dst.</summary>
    /// <returns>&gt;= 0 on success, a negative AVERROR on error.</returns>
    public static int av_frame_copy(AVFrame* @dst, AVFrame* @src) => delegates.av_frame_copy(@dst, @src);
    
    
    /// <summary>Copy only &quot;metadata&quot; fields from src to dst.</summary>
    public static int av_frame_copy_props(AVFrame* @dst, AVFrame* @src) => delegates.av_frame_copy_props(@dst, @src);
    ...
    public static void av_frame_free(AVFrame** @frame) => delegates.av_frame_free(@frame);
    ...
    /// <returns>0 on success, a negative AVERROR on error.</returns>
    public static int av_frame_get_buffer(AVFrame* @frame, int @align) => delegates.av_frame_get_buffer(@frame, @align);
    ...
    public static AVBufferRef* av_frame_get_plane_buffer(AVFrame* @frame, int @plane) => delegates.av_frame_get_plane_buffer(@frame, @plane);
    ...
    public static AVFrameSideData* av_frame_get_side_data(AVFrame* @frame, AVFrameSideDataType @type) => delegates.av_frame_get_side_data(@frame, @type);
    ...
    public static int av_frame_is_writable(AVFrame* @frame) => delegates.av_frame_is_writable(@frame);
    
    
    /// <summary>Ensure that the frame data is writable, avoiding data copy if possible.</summary>
    /// <returns>0 on success, a negative AVERROR on error.</returns>
    public static int av_frame_make_writable(AVFrame* @frame) => delegates.av_frame_make_writable(@frame);
    
    
    /// <summary>Move everything contained in src to dst and reset src.</summary>
    public static void av_frame_move_ref(AVFrame* @dst, AVFrame* @src) => delegates.av_frame_move_ref(@dst, @src);
    ...
    public static AVFrameSideData* av_frame_new_side_data(AVFrame* @frame, AVFrameSideDataType @type, ulong @size) => delegates.av_frame_new_side_data(@frame, @type, @size);
    ...
    public static AVFrameSideData* av_frame_new_side_data_from_buf(AVFrame* @frame, AVFrameSideDataType @type, AVBufferRef* @buf) => delegates.av_frame_new_side_data_from_buf(@frame, @type, @buf);
    
    
    /// <summary>Set up a new reference to the data described by the source frame.</summary>
    /// <returns>0 on success, a negative AVERROR on error</returns>
    public static int av_frame_ref(AVFrame* @dst, AVFrame* @src) => delegates.av_frame_ref(@dst, @src);
    
    
    /// <summary>Remove and free all side data instances of the given type.</summary>
    public static void av_frame_remove_side_data(AVFrame* @frame, AVFrameSideDataType @type) => delegates.av_frame_remove_side_data(@frame, @type);
    
    
    /// <summary>Returns a string identifying the side data type</summary>
    /// <returns>a string identifying the side data type</returns>
    public static string av_frame_side_data_name(AVFrameSideDataType @type) => delegates.av_frame_side_data_name(@type);
    
    
    /// <summary>Unreference all the buffers referenced by frame and reset the frame fields.</summary>
    public static void av_frame_unref(AVFrame* @frame) => delegates.av_frame_unref(@frame);
    ...
    public static void av_free(void* @ptr) => delegates.av_free(@ptr);
    ...
    public static void av_freep(void* @ptr) => delegates.av_freep(@ptr);
    ...
    public static long av_gcd(long @a, long @b) => delegates.av_gcd(@a, @b);
    ...
    public static AVRational av_gcd_q(AVRational @a, AVRational @b, int @max_den, AVRational @def) => delegates.av_gcd_q(@a, @b, @max_den, @def);
    ...
    public static AVSampleFormat av_get_alt_sample_fmt(AVSampleFormat @sample_fmt, int @planar) => delegates.av_get_alt_sample_fmt(@sample_fmt, @planar);
    ...
    public static int av_get_bits_per_pixel(AVPixFmtDescriptor* @pixdesc) => delegates.av_get_bits_per_pixel(@pixdesc);
    ...
    public static int av_get_bytes_per_sample(AVSampleFormat @sample_fmt) => delegates.av_get_bytes_per_sample(@sample_fmt);
    ...
    public static string av_get_channel_description(ulong @channel) => delegates.av_get_channel_description(@channel);
    ...
    public static ulong av_get_channel_layout(string @name) => delegates.av_get_channel_layout(@name);
    ...
    public static int av_get_channel_layout_channel_index(ulong @channel_layout, ulong @channel) => delegates.av_get_channel_layout_channel_index(@channel_layout, @channel);
    
    
    /// <summary>Return the number of channels in the channel layout.</summary>
    [Obsolete("use AVChannelLayout.nb_channels")]
    public static int av_get_channel_layout_nb_channels(ulong @channel_layout) => delegates.av_get_channel_layout_nb_channels(@channel_layout);
    ...
    /// <param name="buf_size">size in bytes of the buffer</param>
    [Obsolete("use av_channel_layout_describe()")]
    public static void av_get_channel_layout_string(byte* @buf, int @buf_size, int @nb_channels, ulong @channel_layout) => delegates.av_get_channel_layout_string(@buf, @buf_size, @nb_channels, @channel_layout);
    ...
    public static string av_get_channel_name(ulong @channel) => delegates.av_get_channel_name(@channel);
    ...
    public static string av_get_colorspace_name(AVColorSpace @val) => delegates.av_get_colorspace_name(@val);
    ...
    public static int av_get_cpu_flags() => delegates.av_get_cpu_flags();
    
    
    /// <summary>Return default channel layout for a given number of channels.</summary>
    [Obsolete("use av_channel_layout_default()")]
    public static long av_get_default_channel_layout(int @nb_channels) => delegates.av_get_default_channel_layout(@nb_channels);
    ...
    [Obsolete("use av_channel_layout_from_string()")]
    public static int av_get_extended_channel_layout(string @name, ulong* @channel_layout, int* @nb_channels) => delegates.av_get_extended_channel_layout(@name, @channel_layout, @nb_channels);
    
    
    /// <summary>Return a string describing the media_type enum, NULL if media_type is unknown.</summary>
    public static string av_get_media_type_string(AVMediaType @media_type) => delegates.av_get_media_type_string(@media_type);
    ...
    public static AVSampleFormat av_get_packed_sample_fmt(AVSampleFormat @sample_fmt) => delegates.av_get_packed_sample_fmt(@sample_fmt);
    ...
    public static int av_get_padded_bits_per_pixel(AVPixFmtDescriptor* @pixdesc) => delegates.av_get_padded_bits_per_pixel(@pixdesc);
    ...
    public static byte av_get_picture_type_char(AVPictureType @pict_type) => delegates.av_get_picture_type_char(@pict_type);
    
    
    /// <summary>Return the pixel format corresponding to name.</summary>
    public static AVPixelFormat av_get_pix_fmt(string @name) => delegates.av_get_pix_fmt(@name);
    ...
    /// <param name="has_alpha">Whether the source pixel format alpha channel is used.</param>
    /// <returns>Combination of flags informing you what kind of losses will occur (maximum loss for an invalid dst_pix_fmt).</returns>
    public static int av_get_pix_fmt_loss(AVPixelFormat @dst_pix_fmt, AVPixelFormat @src_pix_fmt, int @has_alpha) => delegates.av_get_pix_fmt_loss(@dst_pix_fmt, @src_pix_fmt, @has_alpha);
    
    
    /// <summary>Return the short name for a pixel format, NULL in case pix_fmt is unknown.</summary>
    public static string av_get_pix_fmt_name(AVPixelFormat @pix_fmt) => delegates.av_get_pix_fmt_name(@pix_fmt);
    ...
    public static byte* av_get_pix_fmt_string(byte* @buf, int @buf_size, AVPixelFormat @pix_fmt) => delegates.av_get_pix_fmt_string(@buf, @buf_size, @pix_fmt);
    ...
    public static AVSampleFormat av_get_planar_sample_fmt(AVSampleFormat @sample_fmt) => delegates.av_get_planar_sample_fmt(@sample_fmt);
    
    
    /// <summary>Return a sample format corresponding to name, or AV_SAMPLE_FMT_NONE on error.</summary>
    public static AVSampleFormat av_get_sample_fmt(string @name) => delegates.av_get_sample_fmt(@name);
    
    
    /// <summary>Return the name of sample_fmt, or NULL if sample_fmt is not recognized.</summary>
    public static string av_get_sample_fmt_name(AVSampleFormat @sample_fmt) => delegates.av_get_sample_fmt_name(@sample_fmt);
    ...
    public static byte* av_get_sample_fmt_string(byte* @buf, int @buf_size, AVSampleFormat @sample_fmt) => delegates.av_get_sample_fmt_string(@buf, @buf_size, @sample_fmt);
    ...
    public static int av_get_standard_channel_layout(uint @index, ulong* @layout, byte** @name) => delegates.av_get_standard_channel_layout(@index, @layout, @name);
    
    
    /// <summary>Return the fractional representation of the internal time base.</summary>
    public static AVRational av_get_time_base_q() => delegates.av_get_time_base_q();
    
    
    /// <summary>Get the current time in microseconds.</summary>
    public static long av_gettime() => delegates.av_gettime();
    ...
    public static long av_gettime_relative() => delegates.av_gettime_relative();
    
    
    /// <summary>Indicates with a boolean result if the av_gettime_relative() time source is monotonic.</summary>
    public static int av_gettime_relative_is_monotonic() => delegates.av_gettime_relative_is_monotonic();
    ...
    public static AVBufferRef* av_hwdevice_ctx_alloc(AVHWDeviceType @type) => delegates.av_hwdevice_ctx_alloc(@type);
    ...
    /// <returns>0 on success, a negative AVERROR code on failure.</returns>
    public static int av_hwdevice_ctx_create(AVBufferRef** @device_ctx, AVHWDeviceType @type, string @device, AVDictionary* @opts, int @flags) => delegates.av_hwdevice_ctx_create(@device_ctx, @type, @device, @opts, @flags);
    ...
    public static int av_hwdevice_ctx_create_derived(AVBufferRef** @dst_ctx, AVHWDeviceType @type, AVBufferRef* @src_ctx, int @flags) => delegates.av_hwdevice_ctx_create_derived(@dst_ctx, @type, @src_ctx, @flags);
    ...
    /// <param name="flags">Currently unused; should be set to zero.</param>
    /// <returns>Zero on success, a negative AVERROR code on failure.</returns>
    public static int av_hwdevice_ctx_create_derived_opts(AVBufferRef** @dst_ctx, AVHWDeviceType @type, AVBufferRef* @src_ctx, AVDictionary* @options, int @flags) => delegates.av_hwdevice_ctx_create_derived_opts(@dst_ctx, @type, @src_ctx, @options, @flags);
    ...
    /// <returns>0 on success, a negative AVERROR code on failure</returns>
    public static int av_hwdevice_ctx_init(AVBufferRef* @ref) => delegates.av_hwdevice_ctx_init(@ref);
    ...
    public static AVHWDeviceType av_hwdevice_find_type_by_name(string @name) => delegates.av_hwdevice_find_type_by_name(@name);
    ...
    public static AVHWFramesConstraints* av_hwdevice_get_hwframe_constraints(AVBufferRef* @ref, void* @hwconfig) => delegates.av_hwdevice_get_hwframe_constraints(@ref, @hwconfig);
    ...
    public static string av_hwdevice_get_type_name(AVHWDeviceType @type) => delegates.av_hwdevice_get_type_name(@type);
    ...
    public static void* av_hwdevice_hwconfig_alloc(AVBufferRef* @device_ctx) => delegates.av_hwdevice_hwconfig_alloc(@device_ctx);
    ...
    public static AVHWDeviceType av_hwdevice_iterate_types(AVHWDeviceType @prev) => delegates.av_hwdevice_iterate_types(@prev);
    ...
    public static void av_hwframe_constraints_free(AVHWFramesConstraints** @constraints) => delegates.av_hwframe_constraints_free(@constraints);
    ...
    public static AVBufferRef* av_hwframe_ctx_alloc(AVBufferRef* @device_ctx) => delegates.av_hwframe_ctx_alloc(@device_ctx);
    ...
    public static int av_hwframe_ctx_create_derived(AVBufferRef** @derived_frame_ctx, AVPixelFormat @format, AVBufferRef* @derived_device_ctx, AVBufferRef* @source_frame_ctx, int @flags) => delegates.av_hwframe_ctx_create_derived(@derived_frame_ctx, @format, @derived_device_ctx, @source_frame_ctx, @flags);
    ...
    /// <returns>0 on success, a negative AVERROR code on failure</returns>
    public static int av_hwframe_ctx_init(AVBufferRef* @ref) => delegates.av_hwframe_ctx_init(@ref);
    ...
    /// <param name="flags">currently unused, should be set to zero</param>
    /// <returns>0 on success, a negative AVERROR code on failure</returns>
    public static int av_hwframe_get_buffer(AVBufferRef* @hwframe_ctx, AVFrame* @frame, int @flags) => delegates.av_hwframe_get_buffer(@hwframe_ctx, @frame, @flags);
    ...
    /// <returns>Zero on success, negative AVERROR code on failure.</returns>
    public static int av_hwframe_map(AVFrame* @dst, AVFrame* @src, int @flags) => delegates.av_hwframe_map(@dst, @src, @flags);
    ...
    public static int av_hwframe_transfer_data(AVFrame* @dst, AVFrame* @src, int @flags) => delegates.av_hwframe_transfer_data(@dst, @src, @flags);
    ...
    /// <param name="flags">currently unused, should be set to zero</param>
    /// <returns>0 on success, a negative AVERROR code on failure.</returns>
    public static int av_hwframe_transfer_get_formats(AVBufferRef* @hwframe_ctx, AVHWFrameTransferDirection @dir, AVPixelFormat** @formats, int @flags) => delegates.av_hwframe_transfer_get_formats(@hwframe_ctx, @dir, @formats, @flags);
    ...
    public static int av_image_alloc(ref byte_ptrArray4 @pointers, ref int_array4 @linesizes, int @w, int @h, AVPixelFormat @pix_fmt, int @align) => delegates.av_image_alloc(ref @pointers, ref @linesizes, @w, @h, @pix_fmt, @align);
    ...
    public static int av_image_check_sar(uint @w, uint @h, AVRational @sar) => delegates.av_image_check_sar(@w, @h, @sar);
    ...
    public static int av_image_check_size(uint @w, uint @h, int @log_offset, void* @log_ctx) => delegates.av_image_check_size(@w, @h, @log_offset, @log_ctx);
    ...
    /// <param name="log_ctx">the parent logging context, it may be NULL</param>
    /// <returns>&gt;= 0 if valid, a negative error code otherwise</returns>
    public static int av_image_check_size2(uint @w, uint @h, long @max_pixels, AVPixelFormat @pix_fmt, int @log_offset, void* @log_ctx) => delegates.av_image_check_size2(@w, @h, @max_pixels, @pix_fmt, @log_offset, @log_ctx);
    ...
    public static void av_image_copy(ref byte_ptrArray4 @dst_data, ref int_array4 @dst_linesizes, ref byte_ptrArray4 @src_data, int_array4 @src_linesizes, AVPixelFormat @pix_fmt, int @width, int @height) => delegates.av_image_copy(ref @dst_data, ref @dst_linesizes, ref @src_data, @src_linesizes, @pix_fmt, @width, @height);
    ...
    public static void av_image_copy_plane(byte* @dst, int @dst_linesize, byte* @src, int @src_linesize, int @bytewidth, int @height) => delegates.av_image_copy_plane(@dst, @dst_linesize, @src, @src_linesize, @bytewidth, @height);
    ...
    public static void av_image_copy_plane_uc_from(byte* @dst, long @dst_linesize, byte* @src, long @src_linesize, long @bytewidth, int @height) => delegates.av_image_copy_plane_uc_from(@dst, @dst_linesize, @src, @src_linesize, @bytewidth, @height);
    ...
    public static int av_image_copy_to_buffer(byte* @dst, int @dst_size, byte_ptrArray4 @src_data, int_array4 @src_linesize, AVPixelFormat @pix_fmt, int @width, int @height, int @align) => delegates.av_image_copy_to_buffer(@dst, @dst_size, @src_data, @src_linesize, @pix_fmt, @width, @height, @align);
    ...
    public static void av_image_copy_uc_from(ref byte_ptrArray4 @dst_data, long_array4 @dst_linesizes, ref byte_ptrArray4 @src_data, long_array4 @src_linesizes, AVPixelFormat @pix_fmt, int @width, int @height) => delegates.av_image_copy_uc_from(ref @dst_data, @dst_linesizes, ref @src_data, @src_linesizes, @pix_fmt, @width, @height);
    ...
    public static int av_image_fill_arrays(ref byte_ptrArray4 @dst_data, ref int_array4 @dst_linesize, byte* @src, AVPixelFormat @pix_fmt, int @width, int @height, int @align) => delegates.av_image_fill_arrays(ref @dst_data, ref @dst_linesize, @src, @pix_fmt, @width, @height, @align);
    ...
    public static int av_image_fill_black(ref byte_ptrArray4 @dst_data, long_array4 @dst_linesize, AVPixelFormat @pix_fmt, AVColorRange @range, int @width, int @height) => delegates.av_image_fill_black(ref @dst_data, @dst_linesize, @pix_fmt, @range, @width, @height);
    ...
    public static int av_image_fill_linesizes(ref int_array4 @linesizes, AVPixelFormat @pix_fmt, int @width) => delegates.av_image_fill_linesizes(ref @linesizes, @pix_fmt, @width);
    ...
    public static void av_image_fill_max_pixsteps(int_array4 @max_pixsteps, ref int_array4 @max_pixstep_comps, AVPixFmtDescriptor* @pixdesc) => delegates.av_image_fill_max_pixsteps(@max_pixsteps, ref @max_pixstep_comps, @pixdesc);
    ...
    /// <returns>&gt;= 0 in case of success, a negative error code otherwise</returns>
    public static int av_image_fill_plane_sizes(ulong_array4 @size, AVPixelFormat @pix_fmt, int @height, long_array4 @linesizes) => delegates.av_image_fill_plane_sizes(@size, @pix_fmt, @height, @linesizes);
    ...
    /// <param name="linesizes">the array containing the linesize for each plane, should be filled by av_image_fill_linesizes()</param>
    /// <returns>the size in bytes required for the image buffer, a negative error code in case of failure</returns>
    public static int av_image_fill_pointers(byte_ptrArray4 @data, AVPixelFormat @pix_fmt, int @height, byte* @ptr, int_array4 @linesizes) => delegates.av_image_fill_pointers(@data, @pix_fmt, @height, @ptr, @linesizes);
    ...
    public static int av_image_get_buffer_size(AVPixelFormat @pix_fmt, int @width, int @height, int @align) => delegates.av_image_get_buffer_size(@pix_fmt, @width, @height, @align);
    ...
    public static int av_image_get_linesize(AVPixelFormat @pix_fmt, int @width, int @plane) => delegates.av_image_get_linesize(@pix_fmt, @width, @plane);
    ...
    public static uint av_int_list_length_for_size(uint @elsize, void* @list, ulong @term) => delegates.av_int_list_length_for_size(@elsize, @list, @term);
    ...
    public static void av_log(void* @avcl, int @level, string @fmt) => delegates.av_log(@avcl, @level, @fmt);
    ...
    public static void av_log_default_callback(void* @avcl, int @level, string @fmt, byte* @vl) => delegates.av_log_default_callback(@avcl, @level, @fmt, @vl);
    ...
    public static void av_log_format_line(void* @ptr, int @level, string @fmt, byte* @vl, byte* @line, int @line_size, int* @print_prefix) => delegates.av_log_format_line(@ptr, @level, @fmt, @vl, @line, @line_size, @print_prefix);
    ...
    public static int av_log_format_line2(void* @ptr, int @level, string @fmt, byte* @vl, byte* @line, int @line_size, int* @print_prefix) => delegates.av_log_format_line2(@ptr, @level, @fmt, @vl, @line, @line_size, @print_prefix);
    
    
    public static int av_log_get_flags() => delegates.av_log_get_flags();
    
    
    /// <summary>Get the current log level</summary>
    /// <returns>Current log level</returns>
    public static int av_log_get_level() => delegates.av_log_get_level();
    ...
    /// <param name="fmt">The format string (printf-compatible) that specifies how subsequent arguments are converted to output.</param>
    public static void av_log_once(void* @avcl, int @initial_level, int @subsequent_level, int* @state, string @fmt) => delegates.av_log_once(@avcl, @initial_level, @subsequent_level, @state, @fmt);
    
    
    /// <summary>Set the logging callback</summary>
    /// <param name="callback">A logging function with a compatible signature.</param>
    public static void av_log_set_callback(av_log_set_callback_callback_func @callback) => delegates.av_log_set_callback(@callback);
    
    
    public static void av_log_set_flags(int @arg) => delegates.av_log_set_flags(@arg);
    
    
    /// <summary>Set the log level</summary>
    /// <param name="level">Logging level</param>
    public static void av_log_set_level(int @level) => delegates.av_log_set_level(@level);
    
    
    public static int av_log2(uint @v) => delegates.av_log2(@v);
    
    
    public static int av_log2_16bit(uint @v) => delegates.av_log2_16bit(@v);
    ...
    /// <returns>Pointer to the allocated block, or `NULL` if the block cannot be allocated</returns>
    public static void* av_malloc(ulong @size) => delegates.av_malloc(@size);
    ...
    /// <returns>Pointer to the allocated block, or `NULL` if the block cannot be allocated</returns>
    public static void* av_malloc_array(ulong @nmemb, ulong @size) => delegates.av_malloc_array(@nmemb, @size);
    ...
    public static void* av_mallocz(ulong @size) => delegates.av_mallocz(@size);
    
    
    [Obsolete("use av_calloc()")]
    public static void* av_mallocz_array(ulong @nmemb, ulong @size) => delegates.av_mallocz_array(@nmemb, @size);
    ...
    public static AVMasteringDisplayMetadata* av_mastering_display_metadata_alloc() => delegates.av_mastering_display_metadata_alloc();
    ...
    public static AVMasteringDisplayMetadata* av_mastering_display_metadata_create_side_data(AVFrame* @frame) => delegates.av_mastering_display_metadata_create_side_data(@frame);
    ...
    public static void av_max_alloc(ulong @max) => delegates.av_max_alloc(@max);
    ...
    public static void av_memcpy_backptr(byte* @dst, int @back, int @cnt) => delegates.av_memcpy_backptr(@dst, @back, @cnt);
    ...
    public static void* av_memdup(void* @p, ulong @size) => delegates.av_memdup(@p, @size);
    ...
    /// <param name="c">Second rational</param>
    /// <returns>b*c</returns>
    public static AVRational av_mul_q(AVRational @b, AVRational @c) => delegates.av_mul_q(@b, @c);
    ...
    public static int av_nearer_q(AVRational @q, AVRational @q1, AVRational @q2) => delegates.av_nearer_q(@q, @q1, @q2);
    ...
    public static AVClass* av_opt_child_class_iterate(AVClass* @parent, void** @iter) => delegates.av_opt_child_class_iterate(@parent, @iter);
    ...
    public static void* av_opt_child_next(void* @obj, void* @prev) => delegates.av_opt_child_next(@obj, @prev);
    ...
    /// <returns>0 on success, negative on error</returns>
    public static int av_opt_copy(void* @dest, void* @src) => delegates.av_opt_copy(@dest, @src);
    
    
    public static int av_opt_eval_double(void* @obj, AVOption* @o, string @val, double* @double_out) => delegates.av_opt_eval_double(@obj, @o, @val, @double_out);
    ...
    public static int av_opt_eval_flags(void* @obj, AVOption* @o, string @val, int* @flags_out) => delegates.av_opt_eval_flags(@obj, @o, @val, @flags_out);
    
    
    public static int av_opt_eval_float(void* @obj, AVOption* @o, string @val, float* @float_out) => delegates.av_opt_eval_float(@obj, @o, @val, @float_out);
    
    
    public static int av_opt_eval_int(void* @obj, AVOption* @o, string @val, int* @int_out) => delegates.av_opt_eval_int(@obj, @o, @val, @int_out);
    
    
    public static int av_opt_eval_int64(void* @obj, AVOption* @o, string @val, long* @int64_out) => delegates.av_opt_eval_int64(@obj, @o, @val, @int64_out);
    
    
    public static int av_opt_eval_q(void* @obj, AVOption* @o, string @val, AVRational* @q_out) => delegates.av_opt_eval_q(@obj, @o, @val, @q_out);
    ...
    public static AVOption* av_opt_find(void* @obj, string @name, string @unit, int @opt_flags, int @search_flags) => delegates.av_opt_find(@obj, @name, @unit, @opt_flags, @search_flags);
    ...
    /// <returns>A pointer to the option found, or NULL if no option was found.</returns>
    public static AVOption* av_opt_find2(void* @obj, string @name, string @unit, int @opt_flags, int @search_flags, void** @target_obj) => delegates.av_opt_find2(@obj, @name, @unit, @opt_flags, @search_flags, @target_obj);
    ...
    public static int av_opt_flag_is_set(void* @obj, string @field_name, string @flag_name) => delegates.av_opt_flag_is_set(@obj, @field_name, @flag_name);
    
    
    /// <summary>Free all allocated objects in obj.</summary>
    public static void av_opt_free(void* @obj) => delegates.av_opt_free(@obj);
    
    
    /// <summary>Free an AVOptionRanges struct and set it to NULL.</summary>
    public static void av_opt_freep_ranges(AVOptionRanges** @ranges) => delegates.av_opt_freep_ranges(@ranges);
    ...
    public static int av_opt_get(void* @obj, string @name, int @search_flags, byte** @out_val) => delegates.av_opt_get(@obj, @name, @search_flags, @out_val);
    
    
    [Obsolete("")]
    public static int av_opt_get_channel_layout(void* @obj, string @name, int @search_flags, long* @ch_layout) => delegates.av_opt_get_channel_layout(@obj, @name, @search_flags, @ch_layout);
    
    
    public static int av_opt_get_chlayout(void* @obj, string @name, int @search_flags, AVChannelLayout* @layout) => delegates.av_opt_get_chlayout(@obj, @name, @search_flags, @layout);
    ...
    public static int av_opt_get_dict_val(void* @obj, string @name, int @search_flags, AVDictionary** @out_val) => delegates.av_opt_get_dict_val(@obj, @name, @search_flags, @out_val);
    
    
    public static int av_opt_get_double(void* @obj, string @name, int @search_flags, double* @out_val) => delegates.av_opt_get_double(@obj, @name, @search_flags, @out_val);
    
    
    public static int av_opt_get_image_size(void* @obj, string @name, int @search_flags, int* @w_out, int* @h_out) => delegates.av_opt_get_image_size(@obj, @name, @search_flags, @w_out, @h_out);
    
    
    public static int av_opt_get_int(void* @obj, string @name, int @search_flags, long* @out_val) => delegates.av_opt_get_int(@obj, @name, @search_flags, @out_val);
    ...
    public static int av_opt_get_key_value(byte** @ropts, string @key_val_sep, string @pairs_sep, uint @flags, byte** @rkey, byte** @rval) => delegates.av_opt_get_key_value(@ropts, @key_val_sep, @pairs_sep, @flags, @rkey, @rval);
    
    
    public static int av_opt_get_pixel_fmt(void* @obj, string @name, int @search_flags, AVPixelFormat* @out_fmt) => delegates.av_opt_get_pixel_fmt(@obj, @name, @search_flags, @out_fmt);
    
    
    public static int av_opt_get_q(void* @obj, string @name, int @search_flags, AVRational* @out_val) => delegates.av_opt_get_q(@obj, @name, @search_flags, @out_val);
    
    
    public static int av_opt_get_sample_fmt(void* @obj, string @name, int @search_flags, AVSampleFormat* @out_fmt) => delegates.av_opt_get_sample_fmt(@obj, @name, @search_flags, @out_fmt);
    
    
    public static int av_opt_get_video_rate(void* @obj, string @name, int @search_flags, AVRational* @out_val) => delegates.av_opt_get_video_rate(@obj, @name, @search_flags, @out_val);
    ...
    public static int av_opt_is_set_to_default(void* @obj, AVOption* @o) => delegates.av_opt_is_set_to_default(@obj, @o);
    ...
    /// <returns>&gt;0 when option is set to its default, 0 when option is not set its default,  &lt; 0 on error</returns>
    public static int av_opt_is_set_to_default_by_name(void* @obj, string @name, int @search_flags) => delegates.av_opt_is_set_to_default_by_name(@obj, @name, @search_flags);
    ...
    public static AVOption* av_opt_next(void* @obj, AVOption* @prev) => delegates.av_opt_next(@obj, @prev);
    
    
    /// <summary>@}</summary>
    public static void* av_opt_ptr(AVClass* @avclass, void* @obj, string @name) => delegates.av_opt_ptr(@avclass, @obj, @name);
    ...
    public static int av_opt_query_ranges(AVOptionRanges** @p0, void* @obj, string @key, int @flags) => delegates.av_opt_query_ranges(@p0, @obj, @key, @flags);
    
    
    /// <summary>Get a default list of allowed ranges for the given option.</summary>
    /// <param name="flags">is a bitmask of flags, undefined flags should not be set and should be ignored AV_OPT_SEARCH_FAKE_OBJ indicates that the obj is a double pointer to a AVClass instead of a full instance AV_OPT_MULTI_COMPONENT_RANGE indicates that function may return more than one component,</param>
    /// <returns>number of compontents returned on success, a negative errro code otherwise</returns>
    public static int av_opt_query_ranges_default(AVOptionRanges** @p0, void* @obj, string @key, int @flags) => delegates.av_opt_query_ranges_default(@p0, @obj, @key, @flags);
    ...
    /// <param name="pairs_sep">character used to separate two pairs from each other</param>
    /// <returns>&gt;= 0 on success, negative on error</returns>
    public static int av_opt_serialize(void* @obj, int @opt_flags, int @flags, byte** @buffer, byte @key_val_sep, byte @pairs_sep) => delegates.av_opt_serialize(@obj, @opt_flags, @flags, @buffer, @key_val_sep, @pairs_sep);
    ...
    public static int av_opt_set(void* @obj, string @name, string @val, int @search_flags) => delegates.av_opt_set(@obj, @name, @val, @search_flags);
    
    
    public static int av_opt_set_bin(void* @obj, string @name, byte* @val, int @size, int @search_flags) => delegates.av_opt_set_bin(@obj, @name, @val, @size, @search_flags);
    
    
    [Obsolete("")]
    public static int av_opt_set_channel_layout(void* @obj, string @name, long @ch_layout, int @search_flags) => delegates.av_opt_set_channel_layout(@obj, @name, @ch_layout, @search_flags);
    
    
    public static int av_opt_set_chlayout(void* @obj, string @name, AVChannelLayout* @layout, int @search_flags) => delegates.av_opt_set_chlayout(@obj, @name, @layout, @search_flags);
    ...
    public static void av_opt_set_defaults(void* @s) => delegates.av_opt_set_defaults(@s);
    ...
    public static void av_opt_set_defaults2(void* @s, int @mask, int @flags) => delegates.av_opt_set_defaults2(@s, @mask, @flags);
    ...
    public static int av_opt_set_dict(void* @obj, AVDictionary** @options) => delegates.av_opt_set_dict(@obj, @options);
    
    
    public static int av_opt_set_dict_val(void* @obj, string @name, AVDictionary* @val, int @search_flags) => delegates.av_opt_set_dict_val(@obj, @name, @val, @search_flags);
    ...
    /// <param name="search_flags">A combination of AV_OPT_SEARCH_*.</param>
    /// <returns>0 on success, a negative AVERROR if some option was found in obj, but could not be set.</returns>
    public static int av_opt_set_dict2(void* @obj, AVDictionary** @options, int @search_flags) => delegates.av_opt_set_dict2(@obj, @options, @search_flags);
    
    
    public static int av_opt_set_double(void* @obj, string @name, double @val, int @search_flags) => delegates.av_opt_set_double(@obj, @name, @val, @search_flags);
    ...
    public static int av_opt_set_from_string(void* @ctx, string @opts, byte** @shorthand, string @key_val_sep, string @pairs_sep) => delegates.av_opt_set_from_string(@ctx, @opts, @shorthand, @key_val_sep, @pairs_sep);
    
    
    public static int av_opt_set_image_size(void* @obj, string @name, int @w, int @h, int @search_flags) => delegates.av_opt_set_image_size(@obj, @name, @w, @h, @search_flags);
    
    
    public static int av_opt_set_int(void* @obj, string @name, long @val, int @search_flags) => delegates.av_opt_set_int(@obj, @name, @val, @search_flags);
    
    
    public static int av_opt_set_pixel_fmt(void* @obj, string @name, AVPixelFormat @fmt, int @search_flags) => delegates.av_opt_set_pixel_fmt(@obj, @name, @fmt, @search_flags);
    
    
    public static int av_opt_set_q(void* @obj, string @name, AVRational @val, int @search_flags) => delegates.av_opt_set_q(@obj, @name, @val, @search_flags);
    
    
    public static int av_opt_set_sample_fmt(void* @obj, string @name, AVSampleFormat @fmt, int @search_flags) => delegates.av_opt_set_sample_fmt(@obj, @name, @fmt, @search_flags);
    
    
    public static int av_opt_set_video_rate(void* @obj, string @name, AVRational @val, int @search_flags) => delegates.av_opt_set_video_rate(@obj, @name, @val, @search_flags);
    ...
    public static int av_opt_show2(void* @obj, void* @av_log_obj, int @req_flags, int @rej_flags) => delegates.av_opt_show2(@obj, @av_log_obj, @req_flags, @rej_flags);
    ...
    public static int av_parse_cpu_caps(uint* @flags, string @s) => delegates.av_parse_cpu_caps(@flags, @s);
    ...
    public static int av_pix_fmt_count_planes(AVPixelFormat @pix_fmt) => delegates.av_pix_fmt_count_planes(@pix_fmt);
    ...
    public static AVPixFmtDescriptor* av_pix_fmt_desc_get(AVPixelFormat @pix_fmt) => delegates.av_pix_fmt_desc_get(@pix_fmt);
    ...
    public static AVPixelFormat av_pix_fmt_desc_get_id(AVPixFmtDescriptor* @desc) => delegates.av_pix_fmt_desc_get_id(@desc);
    
    
    /// <summary>Iterate over all pixel format descriptors known to libavutil.</summary>
    /// <param name="prev">previous descriptor. NULL to get the first descriptor.</param>
    /// <returns>next descriptor or NULL after the last descriptor</returns>
    public static AVPixFmtDescriptor* av_pix_fmt_desc_next(AVPixFmtDescriptor* @prev) => delegates.av_pix_fmt_desc_next(@prev);
    ...
    public static int av_pix_fmt_get_chroma_sub_sample(AVPixelFormat @pix_fmt, int* @h_shift, int* @v_shift) => delegates.av_pix_fmt_get_chroma_sub_sample(@pix_fmt, @h_shift, @v_shift);
    ...
    public static AVPixelFormat av_pix_fmt_swap_endianness(AVPixelFormat @pix_fmt) => delegates.av_pix_fmt_swap_endianness(@pix_fmt);
    ...
    public static uint av_q2intfloat(AVRational @q) => delegates.av_q2intfloat(@q);
    
    
    public static void av_read_image_line(ushort* @dst, ref byte_ptrArray4 @data, int_array4 @linesize, AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component) => delegates.av_read_image_line(@dst, ref @data, @linesize, @desc, @x, @y, @c, @w, @read_pal_component);
    ...
    public static void av_read_image_line2(void* @dst, ref byte_ptrArray4 @data, int_array4 @linesize, AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component, int @dst_element_size) => delegates.av_read_image_line2(@dst, ref @data, @linesize, @desc, @x, @y, @c, @w, @read_pal_component, @dst_element_size);
    ...
    public static void* av_realloc(void* @ptr, ulong @size) => delegates.av_realloc(@ptr, @size);
    ...
    /// <returns>Pointer to a newly-reallocated block or NULL if the block cannot be reallocated</returns>
    public static void* av_realloc_array(void* @ptr, ulong @nmemb, ulong @size) => delegates.av_realloc_array(@ptr, @nmemb, @size);
    
    
    /// <summary>Allocate, reallocate, or free a block of memory.</summary>
    public static void* av_realloc_f(void* @ptr, ulong @nelem, ulong @elsize) => delegates.av_realloc_f(@ptr, @nelem, @elsize);
    ...
    public static int av_reallocp(void* @ptr, ulong @size) => delegates.av_reallocp(@ptr, @size);
    ...
    /// <param name="size">Size of the single element</param>
    /// <returns>Zero on success, an AVERROR error code on failure</returns>
    public static int av_reallocp_array(void* @ptr, ulong @nmemb, ulong @size) => delegates.av_reallocp_array(@ptr, @nmemb, @size);
    ...
    public static int av_reduce(int* @dst_num, int* @dst_den, long @num, long @den, long @max) => delegates.av_reduce(@dst_num, @dst_den, @num, @den, @max);
    
    
    /// <summary>Rescale a 64-bit integer with rounding to nearest.</summary>
    public static long av_rescale(long @a, long @b, long @c) => delegates.av_rescale(@a, @b, @c);
    ...
    public static long av_rescale_delta(AVRational @in_tb, long @in_ts, AVRational @fs_tb, int @duration, long* @last, AVRational @out_tb) => delegates.av_rescale_delta(@in_tb, @in_ts, @fs_tb, @duration, @last, @out_tb);
    
    
    /// <summary>Rescale a 64-bit integer by 2 rational numbers.</summary>
    public static long av_rescale_q(long @a, AVRational @bq, AVRational @cq) => delegates.av_rescale_q(@a, @bq, @cq);
    
    
    /// <summary>Rescale a 64-bit integer by 2 rational numbers with specified rounding.</summary>
    public static long av_rescale_q_rnd(long @a, AVRational @bq, AVRational @cq, AVRounding @rnd) => delegates.av_rescale_q_rnd(@a, @bq, @cq, @rnd);
    
    
    /// <summary>Rescale a 64-bit integer with specified rounding.</summary>
    public static long av_rescale_rnd(long @a, long @b, long @c, AVRounding @rnd) => delegates.av_rescale_rnd(@a, @b, @c, @rnd);
    ...
    public static int av_sample_fmt_is_planar(AVSampleFormat @sample_fmt) => delegates.av_sample_fmt_is_planar(@sample_fmt);
    ...
    public static int av_samples_alloc(byte** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align) => delegates.av_samples_alloc(@audio_data, @linesize, @nb_channels, @nb_samples, @sample_fmt, @align);
    ...
    public static int av_samples_alloc_array_and_samples(byte*** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align) => delegates.av_samples_alloc_array_and_samples(@audio_data, @linesize, @nb_channels, @nb_samples, @sample_fmt, @align);
    ...
    public static int av_samples_copy(byte** @dst, byte** @src, int @dst_offset, int @src_offset, int @nb_samples, int @nb_channels, AVSampleFormat @sample_fmt) => delegates.av_samples_copy(@dst, @src, @dst_offset, @src_offset, @nb_samples, @nb_channels, @sample_fmt);
    ...
    public static int av_samples_fill_arrays(byte** @audio_data, int* @linesize, byte* @buf, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align) => delegates.av_samples_fill_arrays(@audio_data, @linesize, @buf, @nb_channels, @nb_samples, @sample_fmt, @align);
    ...
    public static int av_samples_get_buffer_size(int* @linesize, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align) => delegates.av_samples_get_buffer_size(@linesize, @nb_channels, @nb_samples, @sample_fmt, @align);
    ...
    /// <param name="nb_channels">number of audio channels</param>
    /// <param name="sample_fmt">audio sample format</param>
    public static int av_samples_set_silence(byte** @audio_data, int @offset, int @nb_samples, int @nb_channels, AVSampleFormat @sample_fmt) => delegates.av_samples_set_silence(@audio_data, @offset, @nb_samples, @nb_channels, @sample_fmt);
    ...
    public static int av_set_options_string(void* @ctx, string @opts, string @key_val_sep, string @pairs_sep) => delegates.av_set_options_string(@ctx, @opts, @key_val_sep, @pairs_sep);
    ...
    public static int av_size_mult(ulong @a, ulong @b, ulong* @r) => delegates.av_size_mult(@a, @b, @r);
    ...
    public static byte* av_strdup(string @s) => delegates.av_strdup(@s);
    ...
    public static int av_strerror(int @errnum, byte* @errbuf, ulong @errbuf_size) => delegates.av_strerror(@errnum, @errbuf, @errbuf_size);
    ...
    public static byte* av_strndup(string @s, ulong @len) => delegates.av_strndup(@s, @len);
    ...
    /// <param name="c">Second rational</param>
    /// <returns>b-c</returns>
    public static AVRational av_sub_q(AVRational @b, AVRational @c) => delegates.av_sub_q(@b, @c);
    ...
    public static int av_tempfile(string @prefix, byte** @filename, int @log_offset, void* @log_ctx) => delegates.av_tempfile(@prefix, @filename, @log_offset, @log_ctx);
    ...
    public static int av_timecode_adjust_ntsc_framenum2(int @framenum, int @fps) => delegates.av_timecode_adjust_ntsc_framenum2(@framenum, @fps);
    ...
    public static int av_timecode_check_frame_rate(AVRational @rate) => delegates.av_timecode_check_frame_rate(@rate);
    ...
    public static uint av_timecode_get_smpte(AVRational @rate, int @drop, int @hh, int @mm, int @ss, int @ff) => delegates.av_timecode_get_smpte(@rate, @drop, @hh, @mm, @ss, @ff);
    ...
    /// <returns>the SMPTE binary representation</returns>
    public static uint av_timecode_get_smpte_from_framenum(AVTimecode* @tc, int @framenum) => delegates.av_timecode_get_smpte_from_framenum(@tc, @framenum);
    ...
    public static int av_timecode_init(AVTimecode* @tc, AVRational @rate, int @flags, int @frame_start, void* @log_ctx) => delegates.av_timecode_init(@tc, @rate, @flags, @frame_start, @log_ctx);
    ...
    /// <param name="log_ctx">a pointer to an arbitrary struct of which the first field is a pointer to an AVClass struct (used for av_log)</param>
    /// <returns>0 on success, AVERROR otherwise</returns>
    public static int av_timecode_init_from_components(AVTimecode* @tc, AVRational @rate, int @flags, int @hh, int @mm, int @ss, int @ff, void* @log_ctx) => delegates.av_timecode_init_from_components(@tc, @rate, @flags, @hh, @mm, @ss, @ff, @log_ctx);
    ...
    /// <param name="log_ctx">a pointer to an arbitrary struct of which the first field is a pointer to an AVClass struct (used for av_log).</param>
    /// <returns>0 on success, AVERROR otherwise</returns>
    public static int av_timecode_init_from_string(AVTimecode* @tc, AVRational @rate, string @str, void* @log_ctx) => delegates.av_timecode_init_from_string(@tc, @rate, @str, @log_ctx);
    ...
    public static byte* av_timecode_make_mpeg_tc_string(byte* @buf, uint @tc25bit) => delegates.av_timecode_make_mpeg_tc_string(@buf, @tc25bit);
    ...
    /// <returns>the buf parameter</returns>
    public static byte* av_timecode_make_smpte_tc_string(byte* @buf, uint @tcsmpte, int @prevent_df) => delegates.av_timecode_make_smpte_tc_string(@buf, @tcsmpte, @prevent_df);
    ...
    /// <returns>the buf parameter</returns>
    public static byte* av_timecode_make_smpte_tc_string2(byte* @buf, AVRational @rate, uint @tcsmpte, int @prevent_df, int @skip_field) => delegates.av_timecode_make_smpte_tc_string2(@buf, @rate, @tcsmpte, @prevent_df, @skip_field);
    ...
    /// <param name="framenum">frame number</param>
    /// <returns>the buf parameter</returns>
    public static byte* av_timecode_make_string(AVTimecode* @tc, byte* @buf, int @framenum) => delegates.av_timecode_make_string(@tc, @buf, @framenum);
    
    
    public static void av_tree_destroy(AVTreeNode* @t) => delegates.av_tree_destroy(@t);
    ...
    public static void av_tree_enumerate(AVTreeNode* @t, void* @opaque, av_tree_enumerate_cmp_func @cmp, av_tree_enumerate_enu_func @enu) => delegates.av_tree_enumerate(@t, @opaque, @cmp, @enu);
    ...
    public static void* av_tree_find(AVTreeNode* @root, void* @key, av_tree_find_cmp_func @cmp, void_ptrArray2 @next) => delegates.av_tree_find(@root, @key, @cmp, @next);
    ...
    public static void* av_tree_insert(AVTreeNode** @rootp, void* @key, av_tree_insert_cmp_func @cmp, AVTreeNode** @next) => delegates.av_tree_insert(@rootp, @key, @cmp, @next);
    
    
    /// <summary>Allocate an AVTreeNode.</summary>
    public static AVTreeNode* av_tree_node_alloc() => delegates.av_tree_node_alloc();
    ...
    public static int av_usleep(uint @usec) => delegates.av_usleep(@usec);
    ...
    public static string av_version_info() => delegates.av_version_info();
    ...
    /// <param name="fmt">The format string (printf-compatible) that specifies how subsequent arguments are converted to output.</param>
    /// <param name="vl">The arguments referenced by the format string.</param>
    public static void av_vlog(void* @avcl, int @level, string @fmt, byte* @vl) => delegates.av_vlog(@avcl, @level, @fmt, @vl);
    
    
    public static void av_write_image_line(ushort* @src, ref byte_ptrArray4 @data, int_array4 @linesize, AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w) => delegates.av_write_image_line(@src, ref @data, @linesize, @desc, @x, @y, @c, @w);
    ...
    public static void av_write_image_line2(void* @src, ref byte_ptrArray4 @data, int_array4 @linesize, AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @src_element_size) => delegates.av_write_image_line2(@src, ref @data, @linesize, @desc, @x, @y, @c, @w, @src_element_size);
    
    
    /// <summary>Return the libavutil build-time configuration.</summary>
    public static string avutil_configuration() => delegates.avutil_configuration();
    
    
    /// <summary>Return the libavutil license.</summary>
    public static string avutil_license() => delegates.avutil_license();
    
    
    /// <summary>Return the LIBAVUTIL_VERSION_INT constant.</summary>
    public static uint avutil_version() => delegates.avutil_version();
    
    
    /// <summary>Return the libpostproc build-time configuration.</summary>
    public static string postproc_configuration() => delegates.postproc_configuration();
    
    
    /// <summary>Return the libpostproc license.</summary>
    public static string postproc_license() => delegates.postproc_license();
    
    
    /// <summary>Return the LIBPOSTPROC_VERSION_INT constant.</summary>
    public static uint postproc_version() => delegates.postproc_version();
    
    
    public static void pp_free_context(void* @ppContext) => delegates.pp_free_context(@ppContext);
    
    
    public static void pp_free_mode(void* @mode) => delegates.pp_free_mode(@mode);
    
    
    public static void* pp_get_context(int @width, int @height, int @flags) => delegates.pp_get_context(@width, @height, @flags);
    ...
    public static void* pp_get_mode_by_name_and_quality(string @name, int @quality) => delegates.pp_get_mode_by_name_and_quality(@name, @quality);
    
    
    public static void pp_postprocess(byte_ptrArray3 @src, int_array3 @srcStride, ref byte_ptrArray3 @dst, int_array3 @dstStride, int @horizontalSize, int @verticalSize, sbyte* @QP_store, int @QP_stride, void* @mode, void* @ppContext, int @pict_type) => delegates.pp_postprocess(@src, @srcStride, ref @dst, @dstStride, @horizontalSize, @verticalSize, @QP_store, @QP_stride, @mode, @ppContext, @pict_type);
    
    
    /// <summary>Allocate SwrContext.</summary>
    /// <returns>NULL on error, allocated context otherwise</returns>
    public static SwrContext* swr_alloc() => delegates.swr_alloc();
    ...
    /// <returns>0 on success, negative AVERROR code on failure</returns>
    [Obsolete("use ")]
    public static int swr_build_matrix(ulong @in_layout, ulong @out_layout, double @center_mix_level, double @surround_mix_level, double @lfe_mix_level, double @rematrix_maxval, double @rematrix_volume, double* @matrix, int @stride, AVMatrixEncoding @matrix_encoding, void* @log_ctx) => delegates.swr_build_matrix(@in_layout, @out_layout, @center_mix_level, @surround_mix_level, @lfe_mix_level, @rematrix_maxval, @rematrix_volume, @matrix, @stride, @matrix_encoding, @log_ctx);
    ...
    /// <param name="matrix_encoding">matrixed stereo downmix mode (e.g. dplii)</param>
    /// <returns>0 on success, negative AVERROR code on failure</returns>
    public static int swr_build_matrix2(AVChannelLayout* @in_layout, AVChannelLayout* @out_layout, double @center_mix_level, double @surround_mix_level, double @lfe_mix_level, double @maxval, double @rematrix_volume, double* @matrix, long @stride, AVMatrixEncoding @matrix_encoding, void* @log_context) => delegates.swr_build_matrix2(@in_layout, @out_layout, @center_mix_level, @surround_mix_level, @lfe_mix_level, @maxval, @rematrix_volume, @matrix, @stride, @matrix_encoding, @log_context);
    
    
    /// <summary>Closes the context so that swr_is_initialized() returns 0.</summary>
    /// <param name="s">Swr context to be closed</param>
    public static void swr_close(SwrContext* @s) => delegates.swr_close(@s);
    ...
    /// <returns>0 on success, AVERROR on failure.</returns>
    public static int swr_config_frame(SwrContext* @swr, AVFrame* @out, AVFrame* @in) => delegates.swr_config_frame(@swr, @out, @in);
    ...
    public static int swr_convert(SwrContext* @s, byte** @out, int @out_count, byte** @in, int @in_count) => delegates.swr_convert(@s, @out, @out_count, @in, @in_count);
    ...
    public static int swr_convert_frame(SwrContext* @swr, AVFrame* @output, AVFrame* @input) => delegates.swr_convert_frame(@swr, @output, @input);
    ...
    public static int swr_drop_output(SwrContext* @s, int @count) => delegates.swr_drop_output(@s, @count);
    ...
    public static void swr_free(SwrContext** @s) => delegates.swr_free(@s);
    ...
    public static AVClass* swr_get_class() => delegates.swr_get_class();
    ...
    public static long swr_get_delay(SwrContext* @s, long @base) => delegates.swr_get_delay(@s, @base);
    ...
    public static int swr_get_out_samples(SwrContext* @s, int @in_samples) => delegates.swr_get_out_samples(@s, @in_samples);
    ...
    public static int swr_init(SwrContext* @s) => delegates.swr_init(@s);
    ...
    /// <param name="count">number of samples to be dropped</param>
    /// <returns>&gt;= 0 on success, or a negative AVERROR code on failure</returns>
    public static int swr_inject_silence(SwrContext* @s, int @count) => delegates.swr_inject_silence(@s, @count);
    ...
    public static int swr_is_initialized(SwrContext* @s) => delegates.swr_is_initialized(@s);
    ...
    public static long swr_next_pts(SwrContext* @s, long @pts) => delegates.swr_next_pts(@s, @pts);
    ...
    public static int swr_set_channel_mapping(SwrContext* @s, int* @channel_map) => delegates.swr_set_channel_mapping(@s, @channel_map);
    ...
    public static int swr_set_compensation(SwrContext* @s, int @sample_delta, int @compensation_distance) => delegates.swr_set_compensation(@s, @sample_delta, @compensation_distance);
    ...
    /// <returns>&gt;= 0 on success, or AVERROR error code in case of failure.</returns>
    public static int swr_set_matrix(SwrContext* @s, double* @matrix, int @stride) => delegates.swr_set_matrix(@s, @matrix, @stride);
    
    
    /// <summary>Return the swr build-time configuration.</summary>
    public static string swresample_configuration() => delegates.swresample_configuration();
    
    
    /// <summary>Return the swr license.</summary>
    public static string swresample_license() => delegates.swresample_license();
    
    
    /// <summary>Return the LIBSWRESAMPLE_VERSION_INT constant.</summary>
    public static uint swresample_version() => delegates.swresample_version();
    ...
    public static SwsContext* sws_alloc_context() => delegates.sws_alloc_context();
    
    
    /// <summary>Allocate and return an uninitialized vector with length coefficients.</summary>
    public static SwsVector* sws_allocVec(int @length) => delegates.sws_allocVec(@length);
    ...
    public static void sws_convertPalette8ToPacked24(byte* @src, byte* @dst, int @num_pixels, byte* @palette) => delegates.sws_convertPalette8ToPacked24(@src, @dst, @num_pixels, @palette);
    ...
    /// <param name="num_pixels">number of pixels to convert</param>
    /// <param name="palette">array with [256] entries, which must match color arrangement (RGB or BGR) of src</param>
    public static void sws_convertPalette8ToPacked32(byte* @src, byte* @dst, int @num_pixels, byte* @palette) => delegates.sws_convertPalette8ToPacked32(@src, @dst, @num_pixels, @palette);
    ...
    public static void sws_frame_end(SwsContext* @c) => delegates.sws_frame_end(@c);
    ...
    /// <returns>0 on success, a negative AVERROR code on failure</returns>
    public static int sws_frame_start(SwsContext* @c, AVFrame* @dst, AVFrame* @src) => delegates.sws_frame_start(@c, @dst, @src);
    
    
    /// <summary>Free the swscaler context swsContext. If swsContext is NULL, then does nothing.</summary>
    public static void sws_freeContext(SwsContext* @swsContext) => delegates.sws_freeContext(@swsContext);
    
    
    public static void sws_freeFilter(SwsFilter* @filter) => delegates.sws_freeFilter(@filter);
    
    
    public static void sws_freeVec(SwsVector* @a) => delegates.sws_freeVec(@a);
    ...
    public static AVClass* sws_get_class() => delegates.sws_get_class();
    
    
    /// <summary>Check if context can be reused, otherwise reallocate a new one.</summary>
    public static SwsContext* sws_getCachedContext(SwsContext* @context, int @srcW, int @srcH, AVPixelFormat @srcFormat, int @dstW, int @dstH, AVPixelFormat @dstFormat, int @flags, SwsFilter* @srcFilter, SwsFilter* @dstFilter, double* @param) => delegates.sws_getCachedContext(@context, @srcW, @srcH, @srcFormat, @dstW, @dstH, @dstFormat, @flags, @srcFilter, @dstFilter, @param);
    ...
    public static int* sws_getCoefficients(int @colorspace) => delegates.sws_getCoefficients(@colorspace);
    
    
    /// <summary>#if LIBSWSCALE_VERSION_MAJOR &gt; 6</summary>
    /// <returns>negative error code on error, non negative otherwise #else</returns>
    public static int sws_getColorspaceDetails(SwsContext* @c, int** @inv_table, int* @srcRange, int** @table, int* @dstRange, int* @brightness, int* @contrast, int* @saturation) => delegates.sws_getColorspaceDetails(@c, @inv_table, @srcRange, @table, @dstRange, @brightness, @contrast, @saturation);
    ...
    public static SwsContext* sws_getContext(int @srcW, int @srcH, AVPixelFormat @srcFormat, int @dstW, int @dstH, AVPixelFormat @dstFormat, int @flags, SwsFilter* @srcFilter, SwsFilter* @dstFilter, double* @param) => delegates.sws_getContext(@srcW, @srcH, @srcFormat, @dstW, @dstH, @dstFormat, @flags, @srcFilter, @dstFilter, @param);
    
    
    public static SwsFilter* sws_getDefaultFilter(float @lumaGBlur, float @chromaGBlur, float @lumaSharpen, float @chromaSharpen, float @chromaHShift, float @chromaVShift, int @verbose) => delegates.sws_getDefaultFilter(@lumaGBlur, @chromaGBlur, @lumaSharpen, @chromaSharpen, @chromaHShift, @chromaVShift, @verbose);
    
    
    /// <summary>Return a normalized Gaussian curve used to filter stuff quality = 3 is high quality, lower is lower quality.</summary>
    public static SwsVector* sws_getGaussianVec(double @variance, double @quality) => delegates.sws_getGaussianVec(@variance, @quality);
    ...
    public static int sws_init_context(SwsContext* @sws_context, SwsFilter* @srcFilter, SwsFilter* @dstFilter) => delegates.sws_init_context(@sws_context, @srcFilter, @dstFilter);
    ...
    public static int sws_isSupportedEndiannessConversion(AVPixelFormat @pix_fmt) => delegates.sws_isSupportedEndiannessConversion(@pix_fmt);
    
    
    /// <summary>Return a positive value if pix_fmt is a supported input format, 0 otherwise.</summary>
    public static int sws_isSupportedInput(AVPixelFormat @pix_fmt) => delegates.sws_isSupportedInput(@pix_fmt);
    
    
    /// <summary>Return a positive value if pix_fmt is a supported output format, 0 otherwise.</summary>
    public static int sws_isSupportedOutput(AVPixelFormat @pix_fmt) => delegates.sws_isSupportedOutput(@pix_fmt);
    
    
    /// <summary>Scale all the coefficients of a so that their sum equals height.</summary>
    public static void sws_normalizeVec(SwsVector* @a, double @height) => delegates.sws_normalizeVec(@a, @height);
    ...
    public static int sws_receive_slice(SwsContext* @c, uint @slice_start, uint @slice_height) => delegates.sws_receive_slice(@c, @slice_start, @slice_height);
    ...
    public static uint sws_receive_slice_alignment(SwsContext* @c) => delegates.sws_receive_slice_alignment(@c);
    ...
    public static int sws_scale(SwsContext* @c, byte*[] @srcSlice, int[] @srcStride, int @srcSliceY, int @srcSliceH, byte*[] @dst, int[] @dstStride) => delegates.sws_scale(@c, @srcSlice, @srcStride, @srcSliceY, @srcSliceH, @dst, @dstStride);
    ...
    /// <param name="src">The source frame.</param>
    /// <returns>0 on success, a negative AVERROR code on failure</returns>
    public static int sws_scale_frame(SwsContext* @c, AVFrame* @dst, AVFrame* @src) => delegates.sws_scale_frame(@c, @dst, @src);
    
    
    /// <summary>Scale all the coefficients of a by the scalar value.</summary>
    public static void sws_scaleVec(SwsVector* @a, double @scalar) => delegates.sws_scaleVec(@a, @scalar);
    ...
    public static int sws_send_slice(SwsContext* @c, uint @slice_start, uint @slice_height) => delegates.sws_send_slice(@c, @slice_start, @slice_height);
    ...
    /// <returns>negative error code on error, non negative otherwise #else</returns>
    public static int sws_setColorspaceDetails(SwsContext* @c, int_array4 @inv_table, int @srcRange, int_array4 @table, int @dstRange, int @brightness, int @contrast, int @saturation) => delegates.sws_setColorspaceDetails(@c, @inv_table, @srcRange, @table, @dstRange, @brightness, @contrast, @saturation);
    
    
    /// <summary>Return the libswscale build-time configuration.</summary>
    public static string swscale_configuration() => delegates.swscale_configuration();
    
    
    /// <summary>Return the libswscale license.</summary>
    public static string swscale_license() => delegates.swscale_license();
    
    
    /// <summary>Color conversion and scaling library.</summary>
    public static uint swscale_version() => delegates.swscale_version();
