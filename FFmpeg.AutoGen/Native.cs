...
namespace FFmpeg.AutoGen
{
	...
	public static unsafe partial class Native
	{
		...
		public const int FF_QP2LAMBDA = 0x76; // 118
		...
		public const int AV_TIME_BASE = 0xf4240; // 1000000
		
		public const int AV_GCC_VERSION_AT_LEAST = 0x0; // 0
		...
		public const int av_builtin_constant_p = 0x0; // 0
		...
		public const int AV_HAVE_BIGENDIAN = 0x0; // 0
		
		public const int AV_HAVE_FAST_UNALIGNED = 0x1; // 1
		
		public const int AV_HAVE_INCOMPATIBLE_FORK_ABI = 0x0; // 0
		...
		public const int AV_ERROR_MAX_STRING_SIZE = 0x40; // 64
		...
		public const int AV_LOG_PANIC = 0x0; // 0
		
		public const int AV_LOG_FATAL = 0x8; // 8
		
		public const int AV_LOG_ERROR = 0x10; // 16
		
		public const int AV_LOG_WARNING = 0x18; // 24
		
		public const int AV_LOG_INFO = 0x20; // 32
		
		public const int AV_LOG_VERBOSE = 0x28; // 40
		
		public const int AV_LOG_DEBUG = 0x30; // 48
		
		public const int AV_LOG_MAX_OFFSET = 0x0; // (AV_LOG_DEBUG - AV_LOG_QUIET)
		
		public const int AV_LOG_SKIP_REPEATED = 0x1; // 1
		
		public const int AVPALETTE_SIZE = 0x400; // 1024
		
		public const int AVPALETTE_COUNT = 0x100; // 256
		...
		public const int AV_CPU_FLAG_MMX = 0x1; // 1
		
		public const int AV_CPU_FLAG_MMXEXT = 0x2; // 2
		
		public const int AV_CPU_FLAG_MMX2 = 0x2; // 2
		
		public const int AV_CPU_FLAG_3DNOW = 0x4; // 4
		
		public const int AV_CPU_FLAG_SSE = 0x8; // 8
		
		public const int AV_CPU_FLAG_SSE2 = 0x10; // 16
		
		public const int AV_CPU_FLAG_SSE2SLOW = 0x40000000; // 1073741824
		
		public const int AV_CPU_FLAG_3DNOWEXT = 0x20; // 32
		
		public const int AV_CPU_FLAG_SSE3 = 0x40; // 64
		
		public const int AV_CPU_FLAG_SSE3SLOW = 0x20000000; // 536870912
		
		public const int AV_CPU_FLAG_SSSE3 = 0x80; // 128
		
		public const int AV_CPU_FLAG_ATOM = 0x10000000; // 268435456
		
		public const int AV_CPU_FLAG_SSE4 = 0x100; // 256
		
		public const int AV_CPU_FLAG_SSE42 = 0x200; // 512
		
		public const int AV_CPU_FLAG_AVX = 0x4000; // 16384
		
		public const int AV_CPU_FLAG_XOP = 0x400; // 1024
		
		public const int AV_CPU_FLAG_FMA4 = 0x800; // 2048
		
		public const int AV_CPU_FLAG_CMOV = 0x1001000; // 16781312
		
		public const int AV_CPU_FLAG_ALTIVEC = 0x1; // 1
		...
		public const int AV_CH_FRONT_LEFT = 0x1; // 1
		
		public const int AV_CH_FRONT_RIGHT = 0x2; // 2
		
		public const int AV_CH_FRONT_CENTER = 0x4; // 4
		
		public const int AV_CH_LOW_FREQUENCY = 0x8; // 8
		
		public const int AV_CH_BACK_LEFT = 0x10; // 16
		
		public const int AV_CH_BACK_RIGHT = 0x20; // 32
		
		public const int AV_CH_FRONT_LEFT_OF_CENTER = 0x40; // 64
		
		public const int AV_CH_FRONT_RIGHT_OF_CENTER = 0x80; // 128
		
		public const int AV_CH_BACK_CENTER = 0x100; // 256
		
		public const int AV_CH_SIDE_LEFT = 0x200; // 512
		
		public const int AV_CH_SIDE_RIGHT = 0x400; // 1024
		
		public const int AV_CH_TOP_CENTER = 0x800; // 2048
		
		public const int AV_CH_TOP_FRONT_LEFT = 0x1000; // 4096
		
		public const int AV_CH_TOP_FRONT_CENTER = 0x2000; // 8192
		
		public const int AV_CH_TOP_FRONT_RIGHT = 0x4000; // 16384
		
		public const int AV_CH_TOP_BACK_LEFT = 0x8000; // 32768
		
		public const int AV_CH_TOP_BACK_CENTER = 0x10000; // 65536
		
		public const int AV_CH_TOP_BACK_RIGHT = 0x20000; // 131072
		
		public const int AV_CH_STEREO_LEFT = 0x20000000; // 536870912
		
		public const int AV_CH_STEREO_RIGHT = 0x40000000; // 1073741824
		...
		public const int AV_DICT_MATCH_CASE = 0x1; // 1
		
		public const int AV_DICT_IGNORE_SUFFIX = 0x2; // 2
		
		public const int AV_DICT_DONT_STRDUP_KEY = 0x4; // 4
		
		public const int AV_DICT_DONT_STRDUP_VAL = 0x8; // 8
		
		public const int AV_DICT_DONT_OVERWRITE = 0x10; // 16
		
		public const int AV_DICT_APPEND = 0x20; // 32
		...
		public const int AV_NUM_DATA_POINTERS = 0x8; // 8
		
		public const int FF_DECODE_ERROR_INVALID_BITSTREAM = 0x1; // 1
		
		public const int FF_DECODE_ERROR_MISSING_REFERENCE = 0x2; // 2
		...
		public const int CODEC_FLAG_4MV = 0x4; // 4
		
		public const int CODEC_FLAG_QPEL = 0x10; // 16
		
		public const int CODEC_FLAG_GMC = 0x20; // 32
		
		public const int CODEC_FLAG_MV0 = 0x40; // 64
		
		public const int CODEC_FLAG_INPUT_PRESERVED = 0x100; // 256
		
		public const int CODEC_FLAG_PASS1 = 0x200; // 512
		
		public const int CODEC_FLAG_PASS2 = 0x400; // 1024
		
		public const int CODEC_FLAG_GRAY = 0x2000; // 8192
		
		public const int CODEC_FLAG_EMU_EDGE = 0x4000; // 16384
		
		public const int CODEC_FLAG_PSNR = 0x8000; // 32768
		
		public const int CODEC_FLAG_TRUNCATED = 0x10000; // 65536
		
		public const int CODEC_FLAG_NORMALIZE_AQP = 0x20000; // 131072
		
		public const int CODEC_FLAG_INTERLACED_DCT = 0x40000; // 262144
		
		public const int CODEC_FLAG_LOW_DELAY = 0x80000; // 524288
		
		public const int CODEC_FLAG_GLOBAL_HEADER = 0x400000; // 4194304
		
		public const int CODEC_FLAG_BITEXACT = 0x800000; // 8388608
		
		public const int CODEC_FLAG_AC_PRED = 0x1000000; // 16777216
		
		public const int CODEC_FLAG_LOOP_FILTER = 0x800; // 2048
		
		public const int CODEC_FLAG_INTERLACED_ME = 0x20000000; // 536870912
		
		public const long CODEC_FLAG_CLOSED_GOP = 0x80000000L; // 2147483648L
		
		public const int CODEC_FLAG2_FAST = 0x1; // 1
		
		public const int CODEC_FLAG2_NO_OUTPUT = 0x4; // 4
		
		public const int CODEC_FLAG2_LOCAL_HEADER = 0x8; // 8
		
		public const int CODEC_FLAG2_DROP_FRAME_TIMECODE = 0x2000; // 8192
		
		public const int CODEC_FLAG2_IGNORE_CROP = 0x10000; // 65536
		
		public const int CODEC_FLAG2_CHUNKS = 0x8000; // 32768
		
		public const int CODEC_FLAG2_SHOW_ALL = 0x400000; // 4194304
		
		public const int CODEC_CAP_DRAW_HORIZ_BAND = 0x1; // 1
		
		public const int CODEC_CAP_DR1 = 0x2; // 2
		
		public const int CODEC_CAP_TRUNCATED = 0x8; // 8
		
		public const int CODEC_CAP_HWACCEL = 0x10; // 16
		
		public const int CODEC_CAP_DELAY = 0x20; // 32
		
		public const int CODEC_CAP_SMALL_LAST_FRAME = 0x40; // 64
		
		public const int CODEC_CAP_HWACCEL_VDPAU = 0x80; // 128
		
		public const int CODEC_CAP_SUBFRAMES = 0x100; // 256
		
		public const int CODEC_CAP_EXPERIMENTAL = 0x200; // 512
		
		public const int CODEC_CAP_CHANNEL_CONF = 0x400; // 1024
		
		public const int CODEC_CAP_NEG_LINESIZES = 0x800; // 2048
		
		public const int CODEC_CAP_FRAME_THREADS = 0x1000; // 4096
		
		public const int CODEC_CAP_SLICE_THREADS = 0x2000; // 8192
		
		public const int CODEC_CAP_PARAM_CHANGE = 0x4000; // 16384
		
		public const int CODEC_CAP_AUTO_THREADS = 0x8000; // 32768
		
		public const int CODEC_CAP_VARIABLE_FRAME_SIZE = 0x10000; // 65536
		
		public const int CODEC_CAP_INTRA_ONLY = 0x40000000; // 1073741824
		
		public const long CODEC_CAP_LOSSLESS = 0x80000000L; // 2147483648L
		
		public const int MB_TYPE_INTRA4x4 = 0x1; // 1
		
		public const int MB_TYPE_INTRA16x16 = 0x2; // 2
		
		public const int MB_TYPE_INTRA_PCM = 0x4; // 4
		
		public const int MB_TYPE_16x16 = 0x8; // 8
		
		public const int MB_TYPE_16x8 = 0x10; // 16
		
		public const int MB_TYPE_8x16 = 0x20; // 32
		
		public const int MB_TYPE_8x8 = 0x40; // 64
		
		public const int MB_TYPE_INTERLACED = 0x80; // 128
		
		public const int MB_TYPE_DIRECT2 = 0x100; // 256
		
		public const int MB_TYPE_ACPRED = 0x200; // 512
		
		public const int MB_TYPE_GMC = 0x400; // 1024
		
		public const int MB_TYPE_SKIP = 0x800; // 2048
		
		public const int MB_TYPE_P0L0 = 0x1000; // 4096
		
		public const int MB_TYPE_P1L0 = 0x2000; // 8192
		
		public const int MB_TYPE_P0L1 = 0x4000; // 16384
		
		public const int MB_TYPE_P1L1 = 0x8000; // 32768
		...
		public const int MB_TYPE_QUANT = 0x10000; // 65536
		
		public const int MB_TYPE_CBP = 0x20000; // 131072
		
		public const int FF_QSCALE_TYPE_MPEG1 = 0x0; // 0
		
		public const int FF_QSCALE_TYPE_MPEG2 = 0x1; // 1
		
		public const int FF_QSCALE_TYPE_H264 = 0x2; // 2
		
		public const int FF_QSCALE_TYPE_VP56 = 0x3; // 3
		
		public const int FF_BUFFER_TYPE_INTERNAL = 0x1; // 1
		
		public const int FF_BUFFER_TYPE_USER = 0x2; // 2
		
		public const int FF_BUFFER_TYPE_SHARED = 0x4; // 4
		
		public const int FF_BUFFER_TYPE_COPY = 0x8; // 8
		
		public const int FF_BUFFER_HINTS_VALID = 0x1; // 1
		
		public const int FF_BUFFER_HINTS_READABLE = 0x2; // 2
		
		public const int FF_BUFFER_HINTS_PRESERVE = 0x4; // 4
		
		public const int FF_BUFFER_HINTS_REUSABLE = 0x8; // 8
		
		public const int AV_GET_BUFFER_FLAG_REF = 0x1; // (1 << 0)
		
		public const int AV_PKT_FLAG_KEY = 0x1; // 1
		
		public const int AV_PKT_FLAG_CORRUPT = 0x2; // 2
		
		public const int FF_COMPRESSION_DEFAULT = -0x1; // (-1)
		
		public const int FF_ASPECT_EXTENDED = 0xf; // 15
		
		public const int FF_RC_STRATEGY_XVID = 0x1; // 1
		
		public const int FF_PRED_LEFT = 0x0; // 0
		
		public const int FF_PRED_PLANE = 0x1; // 1
		
		public const int FF_PRED_MEDIAN = 0x2; // 2
		
		public const int FF_CMP_SAD = 0x0; // 0
		
		public const int FF_CMP_SSE = 0x1; // 1
		
		public const int FF_CMP_SATD = 0x2; // 2
		
		public const int FF_CMP_DCT = 0x3; // 3
		
		public const int FF_CMP_PSNR = 0x4; // 4
		
		public const int FF_CMP_BIT = 0x5; // 5
		
		public const int FF_CMP_RD = 0x6; // 6
		
		public const int FF_CMP_ZERO = 0x7; // 7
		
		public const int FF_CMP_VSAD = 0x8; // 8
		
		public const int FF_CMP_VSSE = 0x9; // 9
		
		public const int FF_CMP_NSSE = 0xa; // 10
		
		public const int FF_CMP_W53 = 0xb; // 11
		
		public const int FF_CMP_W97 = 0xc; // 12
		
		public const int FF_CMP_DCTMAX = 0xd; // 13
		
		public const int FF_CMP_DCT264 = 0xe; // 14
		
		public const int FF_CMP_CHROMA = 0x100; // 256
		
		public const int FF_DTG_AFD_SAME = 0x8; // 8
		
		public const int FF_DTG_AFD_4_3 = 0x9; // 9
		
		public const int FF_DTG_AFD_16_9 = 0xa; // 10
		
		public const int FF_DTG_AFD_14_9 = 0xb; // 11
		
		public const int FF_DTG_AFD_4_3_SP_14_9 = 0xd; // 13
		
		public const int FF_DTG_AFD_16_9_SP_14_9 = 0xe; // 14
		
		public const int FF_DTG_AFD_SP_4_3 = 0xf; // 15
		
		public const int FF_DEFAULT_QUANT_BIAS = 0xf423f; // 999999
		
		public const int SLICE_FLAG_CODED_ORDER = 0x1; // 1
		
		public const int SLICE_FLAG_ALLOW_FIELD = 0x2; // 2
		
		public const int SLICE_FLAG_ALLOW_PLANE = 0x4; // 4
		
		public const int FF_MB_DECISION_SIMPLE = 0x0; // 0
		
		public const int FF_MB_DECISION_BITS = 0x1; // 1
		
		public const int FF_MB_DECISION_RD = 0x2; // 2
		
		public const int FF_CODER_TYPE_VLC = 0x0; // 0
		
		public const int FF_CODER_TYPE_AC = 0x1; // 1
		
		public const int FF_CODER_TYPE_RAW = 0x2; // 2
		
		public const int FF_CODER_TYPE_RLE = 0x3; // 3
		
		public const int FF_CODER_TYPE_DEFLATE = 0x4; // 4
		
		public const int FF_BUG_AUTODETECT = 0x1; // 1
		
		public const int FF_BUG_OLD_MSMPEG4 = 0x2; // 2
		
		public const int FF_BUG_XVID_ILACE = 0x4; // 4
		
		public const int FF_BUG_UMP4 = 0x8; // 8
		
		public const int FF_BUG_NO_PADDING = 0x10; // 16
		
		public const int FF_BUG_AMV = 0x20; // 32
		
		public const int FF_BUG_AC_VLC = 0x0; // 0
		
		public const int FF_BUG_QPEL_CHROMA = 0x40; // 64
		
		public const int FF_BUG_STD_QPEL = 0x80; // 128
		
		public const int FF_BUG_QPEL_CHROMA2 = 0x100; // 256
		
		public const int FF_BUG_DIRECT_BLOCKSIZE = 0x200; // 512
		
		public const int FF_BUG_EDGE = 0x400; // 1024
		
		public const int FF_BUG_HPEL_CHROMA = 0x800; // 2048
		
		public const int FF_BUG_DC_CLIP = 0x1000; // 4096
		
		public const int FF_BUG_MS = 0x2000; // 8192
		
		public const int FF_BUG_TRUNCATED = 0x4000; // 16384
		
		public const int FF_COMPLIANCE_VERY_STRICT = 0x2; // 2
		
		public const int FF_COMPLIANCE_STRICT = 0x1; // 1
		
		public const int FF_COMPLIANCE_NORMAL = 0x0; // 0
		
		public const int FF_COMPLIANCE_UNOFFICIAL = -0x1; // (-1)
		
		public const int FF_COMPLIANCE_EXPERIMENTAL = -0x2; // (-2)
		
		public const int FF_EC_GUESS_MVS = 0x1; // 1
		
		public const int FF_EC_DEBLOCK = 0x2; // 2
		
		public const int FF_DEBUG_PICT_INFO = 0x1; // 1
		
		public const int FF_DEBUG_RC = 0x2; // 2
		
		public const int FF_DEBUG_BITSTREAM = 0x4; // 4
		
		public const int FF_DEBUG_MB_TYPE = 0x8; // 8
		
		public const int FF_DEBUG_QP = 0x10; // 16
		
		public const int FF_DEBUG_MV = 0x20; // 32
		
		public const int FF_DEBUG_DCT_COEFF = 0x40; // 64
		
		public const int FF_DEBUG_SKIP = 0x80; // 128
		
		public const int FF_DEBUG_STARTCODE = 0x100; // 256
		
		public const int FF_DEBUG_PTS = 0x200; // 512
		
		public const int FF_DEBUG_ER = 0x400; // 1024
		
		public const int FF_DEBUG_MMCO = 0x800; // 2048
		
		public const int FF_DEBUG_BUGS = 0x1000; // 4096
		
		public const int FF_DEBUG_VIS_QP = 0x2000; // 8192
		
		public const int FF_DEBUG_VIS_MB_TYPE = 0x4000; // 16384
		
		public const int FF_DEBUG_BUFFERS = 0x8000; // 32768
		
		public const int FF_DEBUG_THREADS = 0x10000; // 65536
		
		public const int FF_DEBUG_VIS_MV_P_FOR = 0x1; // 1
		
		public const int FF_DEBUG_VIS_MV_B_FOR = 0x2; // 2
		
		public const int FF_DEBUG_VIS_MV_B_BACK = 0x4; // 4
		...
		public const int FF_DCT_AUTO = 0x0; // 0
		
		public const int FF_DCT_FASTINT = 0x1; // 1
		
		public const int FF_DCT_INT = 0x2; // 2
		
		public const int FF_DCT_MMX = 0x3; // 3
		
		public const int FF_DCT_ALTIVEC = 0x5; // 5
		
		public const int FF_DCT_FAAN = 0x6; // 6
		
		public const int FF_IDCT_AUTO = 0x0; // 0
		
		public const int FF_IDCT_INT = 0x1; // 1
		
		public const int FF_IDCT_SIMPLE = 0x2; // 2
		
		public const int FF_IDCT_SIMPLEMMX = 0x3; // 3
		
		public const int FF_IDCT_ARM = 0x7; // 7
		
		public const int FF_IDCT_ALTIVEC = 0x8; // 8
		
		public const int FF_IDCT_SH4 = 0x9; // 9
		
		public const int FF_IDCT_SIMPLEARM = 0xa; // 10
		
		public const int FF_IDCT_IPP = 0xd; // 13
		
		public const int FF_IDCT_XVIDMMX = 0xe; // 14
		
		public const int FF_IDCT_SIMPLEARMV5TE = 0x10; // 16
		
		public const int FF_IDCT_SIMPLEARMV6 = 0x11; // 17
		
		public const int FF_IDCT_SIMPLEVIS = 0x12; // 18
		
		public const int FF_IDCT_FAAN = 0x14; // 20
		
		public const int FF_IDCT_SIMPLENEON = 0x16; // 22
		
		public const int FF_IDCT_SIMPLEALPHA = 0x17; // 23
		
		public const int FF_THREAD_FRAME = 0x1; // 1
		
		public const int FF_THREAD_SLICE = 0x2; // 2
		
		public const int FF_PROFILE_UNKNOWN = -0x63; // (-99)
		
		public const int FF_PROFILE_RESERVED = -0x64; // (-100)
		
		public const int FF_PROFILE_AAC_MAIN = 0x0; // 0
		
		public const int FF_PROFILE_AAC_LOW = 0x1; // 1
		
		public const int FF_PROFILE_AAC_SSR = 0x2; // 2
		
		public const int FF_PROFILE_AAC_LTP = 0x3; // 3
		
		public const int FF_PROFILE_AAC_HE = 0x4; // 4
		
		public const int FF_PROFILE_AAC_HE_V2 = 0x1c; // 28
		
		public const int FF_PROFILE_AAC_LD = 0x16; // 22
		
		public const int FF_PROFILE_AAC_ELD = 0x26; // 38
		
		public const int FF_PROFILE_DTS = 0x14; // 20
		
		public const int FF_PROFILE_DTS_ES = 0x1e; // 30
		
		public const int FF_PROFILE_DTS_96_24 = 0x28; // 40
		
		public const int FF_PROFILE_DTS_HD_HRA = 0x32; // 50
		
		public const int FF_PROFILE_DTS_HD_MA = 0x3c; // 60
		
		public const int FF_PROFILE_MPEG2_422 = 0x0; // 0
		
		public const int FF_PROFILE_MPEG2_HIGH = 0x1; // 1
		
		public const int FF_PROFILE_MPEG2_SS = 0x2; // 2
		
		public const int FF_PROFILE_MPEG2_SNR_SCALABLE = 0x3; // 3
		
		public const int FF_PROFILE_MPEG2_MAIN = 0x4; // 4
		
		public const int FF_PROFILE_MPEG2_SIMPLE = 0x5; // 5
		
		public const int FF_PROFILE_H264_CONSTRAINED = 0x200; // (1 << 9)
		
		public const int FF_PROFILE_H264_INTRA = 0x800; // (1 << 11)
		
		public const int FF_PROFILE_H264_BASELINE = 0x42; // 66
		
		public const int FF_PROFILE_H264_CONSTRAINED_BASELINE = 0x42; // (66 | FF_PROFILE_H264_CONSTRAINED)
		
		public const int FF_PROFILE_H264_MAIN = 0x4d; // 77
		
		public const int FF_PROFILE_H264_EXTENDED = 0x58; // 88
		
		public const int FF_PROFILE_H264_HIGH = 0x64; // 100
		
		public const int FF_PROFILE_H264_HIGH_10 = 0x6e; // 110
		
		public const int FF_PROFILE_H264_HIGH_10_INTRA = 0x6e; // (110 | FF_PROFILE_H264_INTRA)
		
		public const int FF_PROFILE_H264_HIGH_422 = 0x7a; // 122
		
		public const int FF_PROFILE_H264_HIGH_422_INTRA = 0x7a; // (122 | FF_PROFILE_H264_INTRA)
		
		public const int FF_PROFILE_H264_HIGH_444 = 0x90; // 144
		
		public const int FF_PROFILE_H264_HIGH_444_PREDICTIVE = 0xf4; // 244
		
		public const int FF_PROFILE_H264_HIGH_444_INTRA = 0xf4; // (244 | FF_PROFILE_H264_INTRA)
		
		public const int FF_PROFILE_H264_CAVLC_444 = 0x2c; // 44
		
		public const int FF_PROFILE_VC1_SIMPLE = 0x0; // 0
		
		public const int FF_PROFILE_VC1_MAIN = 0x1; // 1
		
		public const int FF_PROFILE_VC1_COMPLEX = 0x2; // 2
		
		public const int FF_PROFILE_VC1_ADVANCED = 0x3; // 3
		
		public const int FF_PROFILE_MPEG4_SIMPLE = 0x0; // 0
		
		public const int FF_PROFILE_MPEG4_SIMPLE_SCALABLE = 0x1; // 1
		
		public const int FF_PROFILE_MPEG4_CORE = 0x2; // 2
		
		public const int FF_PROFILE_MPEG4_MAIN = 0x3; // 3
		
		public const int FF_PROFILE_MPEG4_N_BIT = 0x4; // 4
		
		public const int FF_PROFILE_MPEG4_SCALABLE_TEXTURE = 0x5; // 5
		
		public const int FF_PROFILE_MPEG4_SIMPLE_FACE_ANIMATION = 0x6; // 6
		
		public const int FF_PROFILE_MPEG4_BASIC_ANIMATED_TEXTURE = 0x7; // 7
		
		public const int FF_PROFILE_MPEG4_HYBRID = 0x8; // 8
		
		public const int FF_PROFILE_MPEG4_ADVANCED_REAL_TIME = 0x9; // 9
		
		public const int FF_PROFILE_MPEG4_CORE_SCALABLE = 0xa; // 10
		
		public const int FF_PROFILE_MPEG4_ADVANCED_CODING = 0xb; // 11
		
		public const int FF_PROFILE_MPEG4_ADVANCED_CORE = 0xc; // 12
		
		public const int FF_PROFILE_MPEG4_ADVANCED_SCALABLE_TEXTURE = 0xd; // 13
		
		public const int FF_PROFILE_MPEG4_SIMPLE_STUDIO = 0xe; // 14
		...
		public const int FF_SUB_CHARENC_MODE_AUTOMATIC = 0x0; // 0
		
		public const int FF_SUB_CHARENC_MODE_PRE_DECODER = 0x1; // 1
		
		public const int AV_SUBTITLE_FLAG_FORCED = 0x1; // 1
		
		public const int AV_PARSER_PTS_NB = 0x4; // 4
		
		public const int PARSER_FLAG_COMPLETE_FRAMES = 0x1; // 1
		
		public const int PARSER_FLAG_ONCE = 0x2; // 2
		
		public const int PARSER_FLAG_FETCHED_OFFSET = 0x4; // 4
		
		public const int PARSER_FLAG_USE_CODEC_TS = 0x1000; // 4096
		
		public const int FF_LOSS_RESOLUTION = 0x1; // 1
		
		public const int FF_LOSS_DEPTH = 0x2; // 2
		
		public const int FF_LOSS_COLORSPACE = 0x4; // 4
		
		public const int FF_LOSS_ALPHA = 0x8; // 8
		
		public const int FF_LOSS_COLORQUANT = 0x10; // 16
		
		public const int FF_LOSS_CHROMA = 0x20; // 32
		
		public const int LIBAVDEVICE_VERSION_MAJOR = 0x37; // 55
		
		public const int LIBAVDEVICE_VERSION_MINOR = 0x0; // 0
		
		public const int LIBAVDEVICE_VERSION_MICRO = 0x64; // 100
		...
		public const int AVIO_SEEKABLE_NORMAL = 0x1; // 1
		
		public const int AVSEEK_SIZE = 0x10000; // 65536
		
		public const int AVSEEK_FORCE = 0x20000; // 131072
		
		public const int AVIO_FLAG_READ = 0x1; // 1
		
		public const int AVIO_FLAG_WRITE = 0x2; // 2
		
		public const int AVIO_FLAG_READ_WRITE = 0x0; // (AVIO_FLAG_READ | AVIO_FLAG_WRITE)
		
		public const int AVIO_FLAG_NONBLOCK = 0x8; // 8
		
		public const int AVIO_FLAG_DIRECT = 0x8000; // 32768
		
		public const int AVPROBE_SCORE_MAX = 0x64; // 100
		
		public const int AVPROBE_SCORE_RETRY = 0x0; // (AVPROBE_SCORE_MAX / 4)
		
		public const int AVPROBE_PADDING_SIZE = 0x20; // 32
		
		public const int AVFMT_NOFILE = 0x1; // 1
		
		public const int AVFMT_NEEDNUMBER = 0x2; // 2
		
		public const int AVFMT_SHOW_IDS = 0x8; // 8
		
		public const int AVFMT_RAWPICTURE = 0x20; // 32
		
		public const int AVFMT_GLOBALHEADER = 0x40; // 64
		
		public const int AVFMT_NOTIMESTAMPS = 0x80; // 128
		
		public const int AVFMT_GENERIC_INDEX = 0x100; // 256
		
		public const int AVFMT_TS_DISCONT = 0x200; // 512
		
		public const int AVFMT_VARIABLE_FPS = 0x400; // 1024
		
		public const int AVFMT_NODIMENSIONS = 0x800; // 2048
		
		public const int AVFMT_NOSTREAMS = 0x1000; // 4096
		
		public const int AVFMT_NOBINSEARCH = 0x2000; // 8192
		
		public const int AVFMT_NOGENSEARCH = 0x4000; // 16384
		
		public const int AVFMT_NO_BYTE_SEEK = 0x8000; // 32768
		...
		public const int AVINDEX_KEYFRAME = 0x1; // 1
		
		public const int AV_DISPOSITION_DEFAULT = 0x1; // 1
		
		public const int AV_DISPOSITION_DUB = 0x2; // 2
		
		public const int AV_DISPOSITION_ORIGINAL = 0x4; // 4
		
		public const int AV_DISPOSITION_COMMENT = 0x8; // 8
		
		public const int AV_DISPOSITION_LYRICS = 0x10; // 16
		
		public const int AV_DISPOSITION_KARAOKE = 0x20; // 32
		
		public const int AV_DISPOSITION_FORCED = 0x40; // 64
		
		public const int AV_DISPOSITION_HEARING_IMPAIRED = 0x80; // 128
		
		public const int AV_DISPOSITION_VISUAL_IMPAIRED = 0x100; // 256
		
		public const int AV_DISPOSITION_CLEAN_EFFECTS = 0x200; // 512
		
		public const int AV_DISPOSITION_ATTACHED_PIC = 0x400; // 1024
		
		public const int AV_PTS_WRAP_IGNORE = 0x0; // 0
		
		public const int AV_PTS_WRAP_ADD_OFFSET = 0x1; // 1
		
		public const int AV_PTS_WRAP_SUB_OFFSET = -0x1; // (-1)
		
		public const int MAX_STD_TIMEBASES = 0x2d6; // ((60 * 12) + 6)
		
		public const int MAX_PROBE_PACKETS = 0x9c4; // 2500
		
		public const int MAX_REORDER_DELAY = 0x10; // 16
		
		public const int AV_PROGRAM_RUNNING = 0x1; // 1
		
		public const int AVFMTCTX_NOHEADER = 0x1; // 1
		
		public const int AVFMT_FLAG_GENPTS = 0x1; // 1
		
		public const int AVFMT_FLAG_IGNIDX = 0x2; // 2
		
		public const int AVFMT_FLAG_NONBLOCK = 0x4; // 4
		
		public const int AVFMT_FLAG_IGNDTS = 0x8; // 8
		
		public const int AVFMT_FLAG_NOFILLIN = 0x10; // 16
		
		public const int AVFMT_FLAG_NOPARSE = 0x20; // 32
		
		public const int AVFMT_FLAG_NOBUFFER = 0x40; // 64
		
		public const int AVFMT_FLAG_CUSTOM_IO = 0x80; // 128
		
		public const int AVFMT_FLAG_DISCARD_CORRUPT = 0x100; // 256
		
		public const int AVFMT_FLAG_MP4A_LATM = 0x8000; // 32768
		
		public const int AVFMT_FLAG_SORT_DTS = 0x10000; // 65536
		
		public const int AVFMT_FLAG_PRIV_OPT = 0x20000; // 131072
		
		public const int AVFMT_FLAG_KEEP_SIDE_DATA = 0x40000; // 262144
		
		public const int FF_FDEBUG_TS = 0x1; // 1
		
		public const int RAW_PACKET_BUFFER_SIZE = 0x2625a0; // 2500000
		
		public const int AVSEEK_FLAG_BACKWARD = 0x1; // 1
		
		public const int AVSEEK_FLAG_BYTE = 0x2; // 2
		
		public const int AVSEEK_FLAG_ANY = 0x4; // 4
		
		public const int AVSEEK_FLAG_FRAME = 0x8; // 8
		...
		public const int AV_PERM_WRITE = 0x2; // 2
		
		public const int AV_PERM_PRESERVE = 0x4; // 4
		
		public const int AV_PERM_REUSE = 0x8; // 8
		
		public const int AV_PERM_REUSE2 = 0x10; // 16
		
		public const int AV_PERM_NEG_LINESIZES = 0x20; // 32
		
		public const int AV_PERM_ALIGN = 0x40; // 64
		...
		public const int PP_QUALITY_MAX = 0x6; // 6
		
		public const long PP_CPU_CAPS_MMX = 0x80000000L; // 2147483648L
		
		public const int PP_CPU_CAPS_MMX2 = 0x20000000; // 536870912
		
		public const int PP_CPU_CAPS_3DNOW = 0x40000000; // 1073741824
		
		public const int PP_CPU_CAPS_ALTIVEC = 0x10000000; // 268435456
		
		public const int PP_CPU_CAPS_AUTO = 0x80000; // 524288
		
		public const int PP_FORMAT = 0x8; // 8
		...
		public const int PP_PICT_TYPE_QP2 = 0x10; // 16
		
		public const int LIBSWRESAMPLE_VERSION_MAJOR = 0x0; // 0
		
		public const int LIBSWRESAMPLE_VERSION_MINOR = 0x11; // 17
		
		public const int LIBSWRESAMPLE_VERSION_MICRO = 0x66; // 102
		
		public const int LIBSWRESAMPLE_BUILD = 0x0; // LIBSWRESAMPLE_VERSION_INT
		
		public const int SWR_CH_MAX = 0x20; // 32
		
		public const int SWR_FLAG_RESAMPLE = 0x1; // 1
		
		public const int LIBSWSCALE_VERSION_MAJOR = 0x2; // 2
		
		public const int LIBSWSCALE_VERSION_MINOR = 0x2; // 2
		
		public const int LIBSWSCALE_VERSION_MICRO = 0x64; // 100
		...
		public const int SWS_FAST_BILINEAR = 0x1; // 1
		
		public const int SWS_BILINEAR = 0x2; // 2
		
		public const int SWS_BICUBIC = 0x4; // 4
		
		public const int SWS_X = 0x8; // 8
		
		public const int SWS_POINT = 0x10; // 16
		
		public const int SWS_AREA = 0x20; // 32
		
		public const int SWS_BICUBLIN = 0x40; // 64
		
		public const int SWS_GAUSS = 0x80; // 128
		
		public const int SWS_SINC = 0x100; // 256
		
		public const int SWS_LANCZOS = 0x200; // 512
		
		public const int SWS_SPLINE = 0x400; // 1024
		
		public const int SWS_SRC_V_CHR_DROP_MASK = 0x30000; // 196608
		
		public const int SWS_SRC_V_CHR_DROP_SHIFT = 0x10; // 16
		
		public const int SWS_PARAM_DEFAULT = 0x1e240; // 123456
		
		public const int SWS_PRINT_INFO = 0x1000; // 4096
		
		public const int SWS_FULL_CHR_H_INT = 0x2000; // 8192
		
		public const int SWS_FULL_CHR_H_INP = 0x4000; // 16384
		
		public const int SWS_DIRECT_BGR = 0x8000; // 32768
		
		public const int SWS_ACCURATE_RND = 0x40000; // 262144
		
		public const int SWS_BITEXACT = 0x80000; // 524288
		
		public const int SWS_ERROR_DIFFUSION = 0x800000; // 8388608
		
		public const long SWS_CPU_CAPS_MMX = 0x80000000L; // 2147483648L
		
		public const int SWS_CPU_CAPS_MMXEXT = 0x20000000; // 536870912
		
		public const int SWS_CPU_CAPS_MMX2 = 0x20000000; // 536870912
		
		public const int SWS_CPU_CAPS_3DNOW = 0x40000000; // 1073741824
		
		public const int SWS_CPU_CAPS_ALTIVEC = 0x10000000; // 268435456
		
		public const int SWS_CPU_CAPS_BFIN = 0x1000000; // 16777216
		
		public const int SWS_CPU_CAPS_SSE2 = 0x2000000; // 33554432
		
		public const float SWS_MAX_REDUCE_CUTOFF = 0.002000f; // 0.002
		
		public const int SWS_CS_ITU709 = 0x1; // 1
		
		public const int SWS_CS_FCC = 0x4; // 4
		
		public const int SWS_CS_ITU601 = 0x5; // 5
		
		public const int SWS_CS_ITU624 = 0x5; // 5
		
		public const int SWS_CS_SMPTE170M = 0x5; // 5
		
		public const int SWS_CS_SMPTE240M = 0x7; // 7
		
		public const int SWS_CS_DEFAULT = 0x5; // 5
		...
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		public struct AVFilterBufferRefAudioProps
		{
			public ulong channel_layout;
			public int nb_samples;
			public int sample_rate;
		...
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		public struct AVFilterBufferRefVideoProps
		{
			public int w;
			public int h;
			public AVRational sample_aspect_ratio;
		...
		[DllImport("avutil-52", EntryPoint="avutil_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avutil_version();
		
		[DllImport("avutil-52", EntryPoint="avutil_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avutil_configuration();
		
		[DllImport("avutil-52", EntryPoint="avutil_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avutil_license();
		
		[DllImport("avutil-52", EntryPoint="av_get_media_type_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String av_get_media_type_string(AVMediaType media_type);
		
		[DllImport("avutil-52", EntryPoint="av_get_picture_type_char", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern byte av_get_picture_type_char(AVPictureType pict_type);
		
		[DllImport("avutil-52", EntryPoint="av_log2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_log2(int v);
		
		[DllImport("avutil-52", EntryPoint="av_log2_16bit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_log2_16bit(int v);
		
		[DllImport("avutil-52", EntryPoint="av_strerror", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_strerror(int errnum, String errbuf, uint errbuf_size);
		
		[DllImport("avutil-52", EntryPoint="av_malloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void* av_malloc(uint size);
		
		[DllImport("avutil-52", EntryPoint="av_realloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void* av_realloc(void* ptr, uint size);
		
		[DllImport("avutil-52", EntryPoint="av_realloc_f", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void* av_realloc_f(void* ptr, uint nelem, uint elsize);
		
		[DllImport("avutil-52", EntryPoint="av_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_free(void* ptr);
		
		[DllImport("avutil-52", EntryPoint="av_mallocz", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void* av_mallocz(uint size);
		
		[DllImport("avutil-52", EntryPoint="av_calloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void* av_calloc(uint nmemb, uint size);
		
		[DllImport("avutil-52", EntryPoint="av_strdup", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String av_strdup(String s);
		
		[DllImport("avutil-52", EntryPoint="av_freep", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_freep(void* ptr);
		
		[DllImport("avutil-52", EntryPoint="av_dynarray_add", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_dynarray_add(void* tab_ptr, int* nb_ptr, void* elem);
		
		[DllImport("avutil-52", EntryPoint="av_max_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_max_alloc(uint max);
		
		[DllImport("avutil-52", EntryPoint="av_memcpy_backptr", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_memcpy_backptr(byte* dst, int back, int cnt);
		
		[DllImport("avutil-52", EntryPoint="av_reduce", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_reduce(int* dst_num, int* dst_den, long num, long den, long max);
		
		[DllImport("avutil-52", EntryPoint="av_mul_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVRational av_mul_q(AVRational b, AVRational c);
		
		[DllImport("avutil-52", EntryPoint="av_div_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVRational av_div_q(AVRational b, AVRational c);
		
		[DllImport("avutil-52", EntryPoint="av_add_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVRational av_add_q(AVRational b, AVRational c);
		
		[DllImport("avutil-52", EntryPoint="av_sub_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVRational av_sub_q(AVRational b, AVRational c);
		
		[DllImport("avutil-52", EntryPoint="av_d2q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVRational av_d2q(double d, int max);
		
		[DllImport("avutil-52", EntryPoint="av_nearer_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_nearer_q(AVRational q, AVRational q1, AVRational q2);
		
		[DllImport("avutil-52", EntryPoint="av_find_nearest_q_idx", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_find_nearest_q_idx(AVRational q, AVRational* q_list);
		
		[DllImport("avutil-52", EntryPoint="av_gcd", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_gcd(long a, long b);
		
		[DllImport("avutil-52", EntryPoint="av_rescale", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_rescale(long a, long b, long c);
		
		[DllImport("avutil-52", EntryPoint="av_rescale_rnd", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_rescale_rnd(long a, long b, long c, AVRounding p3);
		
		[DllImport("avutil-52", EntryPoint="av_rescale_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_rescale_q(long a, AVRational bq, AVRational cq);
		
		[DllImport("avutil-52", EntryPoint="av_rescale_q_rnd", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_rescale_q_rnd(long a, AVRational bq, AVRational cq, AVRounding p3);
		
		[DllImport("avutil-52", EntryPoint="av_compare_ts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_compare_ts(long ts_a, AVRational tb_a, long ts_b, AVRational tb_b);
		
		[DllImport("avutil-52", EntryPoint="av_compare_mod", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_compare_mod(ulong a, ulong b, ulong mod);
		
		[DllImport("avutil-52", EntryPoint="av_rescale_delta", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avutil-52", EntryPoint="av_int2dbl", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern double av_int2dbl(long v);
		
		[DllImport("avutil-52", EntryPoint="av_int2flt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern float av_int2flt(int v);
		
		[DllImport("avutil-52", EntryPoint="av_ext2dbl", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern double av_ext2dbl(AVExtFloat ext);
		
		[DllImport("avutil-52", EntryPoint="av_dbl2int", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_dbl2int(double d);
		
		[DllImport("avutil-52", EntryPoint="av_flt2int", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_flt2int(float d);
		
		[DllImport("avutil-52", EntryPoint="av_dbl2ext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVExtFloat av_dbl2ext(double d);
		
		[DllImport("avutil-52", EntryPoint="av_log", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_log(void* avcl, int level, String fmt);
		
		[DllImport("avutil-52", EntryPoint="av_vlog", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_vlog(void* avcl, int level, String fmt, void* p3);
		
		[DllImport("avutil-52", EntryPoint="av_log_get_level", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_log_get_level();
		
		[DllImport("avutil-52", EntryPoint="av_log_set_level", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_log_set_level(int p0);
		
		[DllImport("avutil-52", EntryPoint="av_log_set_callback", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_log_set_callback(IntPtr None);
		
		[DllImport("avutil-52", EntryPoint="av_log_default_callback", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_log_default_callback(void* ptr, int level, String fmt, void* vl);
		
		[DllImport("avutil-52", EntryPoint="av_default_item_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String av_default_item_name(void* ctx);
		
		[DllImport("avutil-52", EntryPoint="av_default_get_category", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVClassCategory av_default_get_category(void* ptr);
		
		[DllImport("avutil-52", EntryPoint="av_log_format_line", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avutil-52", EntryPoint="av_get_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVSampleFormat av_get_sample_fmt(String name);
		
		[DllImport("avutil-52", EntryPoint="av_get_alt_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVSampleFormat av_get_alt_sample_fmt(AVSampleFormat sample_fmt, int planar);
		
		[DllImport("avutil-52", EntryPoint="av_get_packed_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVSampleFormat av_get_packed_sample_fmt(AVSampleFormat sample_fmt);
		
		[DllImport("avutil-52", EntryPoint="av_get_planar_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVSampleFormat av_get_planar_sample_fmt(AVSampleFormat sample_fmt);
		
		[DllImport("avutil-52", EntryPoint="av_get_sample_fmt_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String av_get_sample_fmt_string(String buf, int buf_size, AVSampleFormat sample_fmt);
		
		[DllImport("avutil-52", EntryPoint="av_get_bits_per_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_bits_per_sample_fmt(AVSampleFormat sample_fmt);
		
		[DllImport("avutil-52", EntryPoint="av_get_bytes_per_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_bytes_per_sample(AVSampleFormat sample_fmt);
		
		[DllImport("avutil-52", EntryPoint="av_sample_fmt_is_planar", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_sample_fmt_is_planar(AVSampleFormat sample_fmt);
		
		[DllImport("avutil-52", EntryPoint="av_samples_get_buffer_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avutil-52", EntryPoint="av_samples_fill_arrays", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avutil-52", EntryPoint="av_samples_set_silence", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avutil-52", EntryPoint="av_buffer_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBufferRef* av_buffer_alloc(int size);
		
		[DllImport("avutil-52", EntryPoint="av_buffer_allocz", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBufferRef* av_buffer_allocz(int size);
		
		[DllImport("avutil-52", EntryPoint="av_buffer_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBufferRef* av_buffer_create(byte* data, int size, IntPtr free, void* opaque, int flags);
		
		[DllImport("avutil-52", EntryPoint="av_buffer_default_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_buffer_default_free(void* opaque, byte* data);
		
		[DllImport("avutil-52", EntryPoint="av_buffer_ref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBufferRef* av_buffer_ref(AVBufferRef* buf);
		
		[DllImport("avutil-52", EntryPoint="av_buffer_unref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avutil-52", EntryPoint="av_buffer_realloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_buffer_realloc(AVBufferRef** buf, int size);
		
		[DllImport("avutil-52", EntryPoint="av_buffer_pool_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBufferPool* av_buffer_pool_init(int size, IntPtr alloc);
		
		[DllImport("avutil-52", EntryPoint="av_buffer_pool_uninit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_buffer_pool_uninit(AVBufferPool** pool);
		
		[DllImport("avutil-52", EntryPoint="av_buffer_pool_get", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBufferRef* av_buffer_pool_get(AVBufferPool* pool);
		
		[DllImport("avutil-52", EntryPoint="av_get_cpu_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_cpu_flags();
		
		[DllImport("avutil-52", EntryPoint="av_force_cpu_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_force_cpu_flags(int flags);
		
		[DllImport("avutil-52", EntryPoint="av_set_cpu_flags_mask", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_set_cpu_flags_mask(int mask);
		
		[DllImport("avutil-52", EntryPoint="av_parse_cpu_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_parse_cpu_flags(String s);
		
		[DllImport("avutil-52", EntryPoint="av_parse_cpu_caps", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_parse_cpu_caps(int* flags, String s);
		
		[DllImport("avutil-52", EntryPoint="ff_get_cpu_flags_x86", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int ff_get_cpu_flags_x86();
		
		[DllImport("avutil-52", EntryPoint="av_get_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern ulong av_get_channel_layout(String name);
		
		[DllImport("avutil-52", EntryPoint="av_get_channel_layout_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_get_channel_layout_string(String buf, int buf_size, int nb_channels, ulong channel_layout);
		
		[DllImport("avutil-52", EntryPoint="av_bprint_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_bprint_channel_layout(AVBPrint* bp, int nb_channels, ulong channel_layout);
		
		[DllImport("avutil-52", EntryPoint="av_get_channel_layout_nb_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_channel_layout_nb_channels(ulong channel_layout);
		
		[DllImport("avutil-52", EntryPoint="av_get_default_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_get_default_channel_layout(int nb_channels);
		
		[DllImport("avutil-52", EntryPoint="av_get_channel_layout_channel_index", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_channel_layout_channel_index(ulong channel_layout, ulong channel);
		
		[DllImport("avutil-52", EntryPoint="av_channel_layout_extract_channel", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern ulong av_channel_layout_extract_channel(ulong channel_layout, int index);
		
		[DllImport("avutil-52", EntryPoint="av_get_channel_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String av_get_channel_name(ulong channel);
		
		[DllImport("avutil-52", EntryPoint="av_get_channel_description", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String av_get_channel_description(ulong channel);
		
		[DllImport("avutil-52", EntryPoint="av_get_standard_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_standard_channel_layout(int index, ulong* layout, byte** name);
		
		[DllImport("avutil-52", EntryPoint="av_dict_get", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVDictionaryEntry* av_dict_get(AVDictionary* m, String key, AVDictionaryEntry* prev, int flags);
		
		[DllImport("avutil-52", EntryPoint="av_dict_count", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_dict_count(AVDictionary* m);
		
		[DllImport("avutil-52", EntryPoint="av_dict_set", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_dict_set(AVDictionary** pm, String key, String value, int flags);
		
		[DllImport("avutil-52", EntryPoint="av_dict_parse_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_dict_parse_string(AVDictionary** pm, String str, String key_val_sep, String pairs_sep, int flags);
		
		[DllImport("avutil-52", EntryPoint="av_dict_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_dict_copy(AVDictionary** dst, AVDictionary* src, int flags);
		
		[DllImport("avutil-52", EntryPoint="av_dict_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_dict_free(AVDictionary** m);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_best_effort_timestamp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_frame_get_best_effort_timestamp(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_best_effort_timestamp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_best_effort_timestamp(AVFrame* frame, long val);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_pkt_duration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_frame_get_pkt_duration(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_pkt_duration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_pkt_duration(AVFrame* frame, long val);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_pkt_pos", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_frame_get_pkt_pos(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_pkt_pos", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_pkt_pos(AVFrame* frame, long val);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long av_frame_get_channel_layout(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_channel_layout(AVFrame* frame, long val);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_get_channels(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_channels(AVFrame* frame, int val);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_sample_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_get_sample_rate(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_sample_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_sample_rate(AVFrame* frame, int val);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_metadata", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVDictionary* av_frame_get_metadata(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_metadata", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_metadata(AVFrame* frame, AVDictionary* val);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_decode_error_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_get_decode_error_flags(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_decode_error_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_decode_error_flags(AVFrame* frame, int val);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_pkt_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_get_pkt_size(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_pkt_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_set_pkt_size(AVFrame* frame, int val);
		
		[DllImport("avutil-52", EntryPoint="avpriv_frame_get_metadatap", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVDictionary** avpriv_frame_get_metadatap(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_qp_table", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern sbyte* av_frame_get_qp_table(AVFrame* f, int* stride, int* type);
		
		[DllImport("avutil-52", EntryPoint="av_frame_set_qp_table", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_set_qp_table(AVFrame* f, AVBufferRef* buf, int stride, int type);
		
		[DllImport("avutil-52", EntryPoint="av_frame_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVFrame* av_frame_alloc();
		
		[DllImport("avutil-52", EntryPoint="av_frame_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_free(AVFrame** frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_ref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_ref(AVFrame* dst, AVFrame* src);
		
		[DllImport("avutil-52", EntryPoint="av_frame_clone", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVFrame* av_frame_clone(AVFrame* src);
		
		[DllImport("avutil-52", EntryPoint="av_frame_unref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_unref(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_move_ref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_frame_move_ref(AVFrame* dst, AVFrame* src);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_get_buffer(AVFrame* frame, int align);
		
		[DllImport("avutil-52", EntryPoint="av_frame_is_writable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_is_writable(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_make_writable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_make_writable(AVFrame* frame);
		
		[DllImport("avutil-52", EntryPoint="av_frame_copy_props", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_frame_copy_props(AVFrame* dst, AVFrame* src);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_plane_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBufferRef* av_frame_get_plane_buffer(AVFrame* frame, int plane);
		
		[DllImport("avutil-52", EntryPoint="av_frame_new_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVFrameSideData* av_frame_new_side_data(AVFrame* frame, AVFrameSideDataType type, int size);
		
		[DllImport("avutil-52", EntryPoint="av_frame_get_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVFrameSideData* av_frame_get_side_data(AVFrame* frame, AVFrameSideDataType type);
		
		[DllImport("avcodec-55", EntryPoint="av_codec_get_pkt_timebase", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVRational av_codec_get_pkt_timebase(AVCodecContext* avctx);
		
		[DllImport("avcodec-55", EntryPoint="av_codec_set_pkt_timebase", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_codec_set_pkt_timebase(AVCodecContext* avctx, AVRational val);
		
		[DllImport("avcodec-55", EntryPoint="av_codec_get_codec_descriptor", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecDescriptor* av_codec_get_codec_descriptor(AVCodecContext* avctx);
		
		[DllImport("avcodec-55", EntryPoint="av_codec_set_codec_descriptor", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_codec_set_codec_descriptor(AVCodecContext* avctx, AVCodecDescriptor* desc);
		
		[DllImport("avcodec-55", EntryPoint="av_codec_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodec* av_codec_next(AVCodec* c);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_version();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avcodec_configuration();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avcodec_license();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_register", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_register(AVCodec* codec);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_register_all", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_register_all();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_alloc_context3", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecContext* avcodec_alloc_context3(AVCodec* codec);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_context_defaults3", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_get_context_defaults3(AVCodecContext* s, AVCodec* codec);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVClass* avcodec_get_class();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_frame_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVClass* avcodec_get_frame_class();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_subtitle_rect_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVClass* avcodec_get_subtitle_rect_class();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_copy_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_copy_context(AVCodecContext* dest, AVCodecContext* src);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_alloc_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVFrame* avcodec_alloc_frame();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_frame_defaults", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_get_frame_defaults(AVFrame* frame);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_free_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_free_frame(AVFrame** frame);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_open2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_open2(AVCodecContext* avctx, AVCodec* codec, AVDictionary** options);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_close(AVCodecContext* avctx);
		
		[DllImport("avcodec-55", EntryPoint="avsubtitle_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avsubtitle_free(AVSubtitle* sub);
		
		[DllImport("avcodec-55", EntryPoint="av_destruct_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_destruct_packet(AVPacket* pkt);
		
		[DllImport("avcodec-55", EntryPoint="av_init_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_init_packet(AVPacket* pkt);
		
		[DllImport("avcodec-55", EntryPoint="av_new_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_new_packet(AVPacket* pkt, int size);
		
		[DllImport("avcodec-55", EntryPoint="av_shrink_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_shrink_packet(AVPacket* pkt, int size);
		
		[DllImport("avcodec-55", EntryPoint="av_grow_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_grow_packet(AVPacket* pkt, int grow_by);
		
		[DllImport("avcodec-55", EntryPoint="av_packet_from_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_packet_from_data(AVPacket* pkt, byte* data, int size);
		
		[DllImport("avcodec-55", EntryPoint="av_dup_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_dup_packet(AVPacket* pkt);
		
		[DllImport("avcodec-55", EntryPoint="av_copy_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_copy_packet(AVPacket* dst, AVPacket* src);
		
		[DllImport("avcodec-55", EntryPoint="av_free_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_free_packet(AVPacket* pkt);
		
		[DllImport("avcodec-55", EntryPoint="av_packet_new_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern byte* av_packet_new_side_data(AVPacket* pkt, AVPacketSideDataType type, int size);
		
		[DllImport("avcodec-55", EntryPoint="av_packet_shrink_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_packet_shrink_side_data(AVPacket* pkt, AVPacketSideDataType type, int size);
		
		[DllImport("avcodec-55", EntryPoint="av_packet_get_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern byte* av_packet_get_side_data(AVPacket* pkt, AVPacketSideDataType type, int* size);
		
		[DllImport("avcodec-55", EntryPoint="av_packet_merge_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_packet_merge_side_data(AVPacket* pkt);
		
		[DllImport("avcodec-55", EntryPoint="av_packet_split_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_packet_split_side_data(AVPacket* pkt);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_find_decoder", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodec* avcodec_find_decoder(AVCodecID id);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_find_decoder_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodec* avcodec_find_decoder_by_name(String name);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_default_get_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_default_get_buffer(AVCodecContext* s, AVFrame* pic);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_default_release_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_default_release_buffer(AVCodecContext* s, AVFrame* pic);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_default_reget_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_default_reget_buffer(AVCodecContext* s, AVFrame* pic);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_default_get_buffer2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_default_get_buffer2(AVCodecContext* s, AVFrame* frame, int flags);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_edge_width", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_get_edge_width();
		
		[DllImport("avcodec-55", EntryPoint="avcodec_align_dimensions", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_align_dimensions(AVCodecContext* s, int* width, int* height);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_align_dimensions2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_align_dimensions2(AVCodecContext* s, int* width, int* height, int* linesize_align);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_decode_audio3", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_decode_audio3(AVCodecContext* avctx, short* samples, int* frame_size_ptr, AVPacket* avpkt);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_decode_audio4", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_decode_audio4(AVCodecContext* avctx, AVFrame* frame, int* got_frame_ptr, AVPacket* avpkt);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_decode_video2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_decode_video2(AVCodecContext* avctx, AVFrame* picture, int* got_picture_ptr, AVPacket* avpkt);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_decode_subtitle2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_decode_subtitle2(AVCodecContext* avctx, AVSubtitle* sub, int* got_sub_ptr, AVPacket* avpkt);
		
		[DllImport("avcodec-55", EntryPoint="av_parser_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecParser* av_parser_next(AVCodecParser* c);
		
		[DllImport("avcodec-55", EntryPoint="av_register_codec_parser", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_register_codec_parser(AVCodecParser* parser);
		
		[DllImport("avcodec-55", EntryPoint="av_parser_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecParserContext* av_parser_init(int codec_id);
		
		[DllImport("avcodec-55", EntryPoint="av_parser_parse2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="av_parser_change", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="av_parser_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_parser_close(AVCodecParserContext* s);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_find_encoder", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodec* avcodec_find_encoder(AVCodecID id);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_find_encoder_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodec* avcodec_find_encoder_by_name(String name);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_encode_audio", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_encode_audio(AVCodecContext* avctx, byte* buf, int buf_size, short* samples);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_encode_audio2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_encode_audio2(AVCodecContext* avctx, AVPacket* avpkt, AVFrame* frame, int* got_packet_ptr);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_encode_video", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_encode_video(AVCodecContext* avctx, byte* buf, int buf_size, AVFrame* pict);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_encode_video2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_encode_video2(AVCodecContext* avctx, AVPacket* avpkt, AVFrame* frame, int* got_packet_ptr);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_encode_subtitle", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_encode_subtitle(AVCodecContext* avctx, byte* buf, int buf_size, AVSubtitle* sub);
		
		[DllImport("avcodec-55", EntryPoint="av_audio_resample_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="audio_resample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int audio_resample(ReSampleContext* s, short* output, short* input, int nb_samples);
		
		[DllImport("avcodec-55", EntryPoint="audio_resample_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void audio_resample_close(ReSampleContext* s);
		
		[DllImport("avcodec-55", EntryPoint="av_resample_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="av_resample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="av_resample_compensate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_resample_compensate(AVResampleContext* c, int sample_delta, int compensation_distance);
		
		[DllImport("avcodec-55", EntryPoint="av_resample_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_resample_close(AVResampleContext* c);
		
		[DllImport("avcodec-55", EntryPoint="avpicture_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avpicture_alloc(AVPicture* picture, AVPixelFormat pix_fmt, int width, int height);
		
		[DllImport("avcodec-55", EntryPoint="avpicture_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avpicture_free(AVPicture* picture);
		
		[DllImport("avcodec-55", EntryPoint="avpicture_fill", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avpicture_fill(AVPicture* picture, byte* ptr, AVPixelFormat pix_fmt, int width, int height);
		
		[DllImport("avcodec-55", EntryPoint="avpicture_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="avpicture_get_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avpicture_get_size(AVPixelFormat pix_fmt, int width, int height);
		
		[DllImport("avcodec-55", EntryPoint="avpicture_deinterlace", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avpicture_deinterlace(AVPicture* dst, AVPicture* src, AVPixelFormat pix_fmt, int width, int height);
		
		[DllImport("avcodec-55", EntryPoint="av_picture_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_picture_copy(AVPicture* dst, AVPicture* src, AVPixelFormat pix_fmt, int width, int height);
		
		[DllImport("avcodec-55", EntryPoint="av_picture_crop", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_picture_crop(AVPicture* dst, AVPicture* src, AVPixelFormat pix_fmt, int top_band, int left_band);
		
		[DllImport("avcodec-55", EntryPoint="av_picture_pad", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="avcodec_get_chroma_sub_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_get_chroma_sub_sample(AVPixelFormat pix_fmt, int* h_shift, int* v_shift);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_pix_fmt_to_codec_tag", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_pix_fmt_to_codec_tag(AVPixelFormat pix_fmt);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_pix_fmt_loss", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_get_pix_fmt_loss(AVPixelFormat dst_pix_fmt, AVPixelFormat src_pix_fmt, int has_alpha);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_find_best_pix_fmt_of_list", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="avcodec_find_best_pix_fmt_of_2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="avcodec_find_best_pix_fmt2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="avcodec_default_get_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVPixelFormat avcodec_default_get_format(AVCodecContext* s, AVPixelFormat* fmt);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_set_dimensions", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_set_dimensions(AVCodecContext* s, int width, int height);
		
		[DllImport("avcodec-55", EntryPoint="av_get_codec_tag_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern uint av_get_codec_tag_string(String buf, uint buf_size, int codec_tag);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_string(String buf, int buf_size, AVCodecContext* enc, int encode);
		
		[DllImport("avcodec-55", EntryPoint="av_get_profile_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String av_get_profile_name(AVCodec* codec, int profile);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_default_execute", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_default_execute(AVCodecContext* c, IntPtr func, void* arg, int* ret, int count, int size);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_default_execute2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_default_execute2(AVCodecContext* c, IntPtr func, void* arg, int* ret, int count);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_fill_audio_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="avcodec_flush_buffers", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avcodec_flush_buffers(AVCodecContext* avctx);
		
		[DllImport("avcodec-55", EntryPoint="av_get_bits_per_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_bits_per_sample(AVCodecID codec_id);
		
		[DllImport("avcodec-55", EntryPoint="av_get_pcm_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecID av_get_pcm_codec(AVSampleFormat fmt, int be);
		
		[DllImport("avcodec-55", EntryPoint="av_get_exact_bits_per_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_exact_bits_per_sample(AVCodecID codec_id);
		
		[DllImport("avcodec-55", EntryPoint="av_get_audio_frame_duration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_audio_frame_duration(AVCodecContext* avctx, int frame_bytes);
		
		[DllImport("avcodec-55", EntryPoint="av_register_bitstream_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_register_bitstream_filter(AVBitStreamFilter* bsf);
		
		[DllImport("avcodec-55", EntryPoint="av_bitstream_filter_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBitStreamFilterContext* av_bitstream_filter_init(String name);
		
		[DllImport("avcodec-55", EntryPoint="av_bitstream_filter_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avcodec-55", EntryPoint="av_bitstream_filter_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_bitstream_filter_close(AVBitStreamFilterContext* bsf);
		
		[DllImport("avcodec-55", EntryPoint="av_bitstream_filter_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVBitStreamFilter* av_bitstream_filter_next(AVBitStreamFilter* f);
		
		[DllImport("avcodec-55", EntryPoint="av_fast_realloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void* av_fast_realloc(void* ptr, int* size, uint min_size);
		
		[DllImport("avcodec-55", EntryPoint="av_fast_malloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_fast_malloc(void* ptr, int* size, uint min_size);
		
		[DllImport("avcodec-55", EntryPoint="av_fast_padded_malloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_fast_padded_malloc(void* ptr, int* size, uint min_size);
		
		[DllImport("avcodec-55", EntryPoint="av_fast_padded_mallocz", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_fast_padded_mallocz(void* ptr, int* size, uint min_size);
		
		[DllImport("avcodec-55", EntryPoint="av_xiphlacing", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_xiphlacing(byte* s, int v);
		
		[DllImport("avcodec-55", EntryPoint="av_log_missing_feature", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_log_missing_feature(void* avc, String feature, int want_sample);
		
		[DllImport("avcodec-55", EntryPoint="av_log_ask_for_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_log_ask_for_sample(void* avc, String msg);
		
		[DllImport("avcodec-55", EntryPoint="av_register_hwaccel", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_register_hwaccel(AVHWAccel* hwaccel);
		
		[DllImport("avcodec-55", EntryPoint="av_hwaccel_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVHWAccel* av_hwaccel_next(AVHWAccel* hwaccel);
		
		[DllImport("avcodec-55", EntryPoint="av_lockmgr_register", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_lockmgr_register(IntPtr cb);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_type", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVMediaType avcodec_get_type(AVCodecID codec_id);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_get_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avcodec_get_name(AVCodecID id);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_is_open", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avcodec_is_open(AVCodecContext* s);
		
		[DllImport("avcodec-55", EntryPoint="av_codec_is_encoder", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_codec_is_encoder(AVCodec* codec);
		
		[DllImport("avcodec-55", EntryPoint="av_codec_is_decoder", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_codec_is_decoder(AVCodec* codec);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_descriptor_get", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecDescriptor* avcodec_descriptor_get(AVCodecID id);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_descriptor_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecDescriptor* avcodec_descriptor_next(AVCodecDescriptor* prev);
		
		[DllImport("avcodec-55", EntryPoint="avcodec_descriptor_get_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecDescriptor* avcodec_descriptor_get_by_name(String name);
		
		[DllImport("avformat-55", EntryPoint="avio_check", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_check(String url, int flags);
		
		[DllImport("avformat-55", EntryPoint="avio_alloc_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avformat-55", EntryPoint="avio_w8", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_w8(AVIOContext* s, int b);
		
		[DllImport("avformat-55", EntryPoint="avio_write", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_write(AVIOContext* s, byte* buf, int size);
		
		[DllImport("avformat-55", EntryPoint="avio_wl64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_wl64(AVIOContext* s, ulong val);
		
		[DllImport("avformat-55", EntryPoint="avio_wb64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_wb64(AVIOContext* s, ulong val);
		
		[DllImport("avformat-55", EntryPoint="avio_wl32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_wl32(AVIOContext* s, int val);
		
		[DllImport("avformat-55", EntryPoint="avio_wb32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_wb32(AVIOContext* s, int val);
		
		[DllImport("avformat-55", EntryPoint="avio_wl24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_wl24(AVIOContext* s, int val);
		
		[DllImport("avformat-55", EntryPoint="avio_wb24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_wb24(AVIOContext* s, int val);
		
		[DllImport("avformat-55", EntryPoint="avio_wl16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_wl16(AVIOContext* s, int val);
		
		[DllImport("avformat-55", EntryPoint="avio_wb16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_wb16(AVIOContext* s, int val);
		
		[DllImport("avformat-55", EntryPoint="avio_put_str", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_put_str(AVIOContext* s, String str);
		
		[DllImport("avformat-55", EntryPoint="avio_put_str16le", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_put_str16le(AVIOContext* s, String str);
		
		[DllImport("avformat-55", EntryPoint="avio_seek", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long avio_seek(AVIOContext* s, long offset, int whence);
		
		[DllImport("avformat-55", EntryPoint="avio_skip", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long avio_skip(AVIOContext* s, long offset);
		
		[DllImport("avformat-55", EntryPoint="avio_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long avio_size(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="url_feof", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int url_feof(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_printf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_printf(AVIOContext* s, String fmt);
		
		[DllImport("avformat-55", EntryPoint="avio_flush", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avio_flush(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_read", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_read(AVIOContext* s, byte* buf, int size);
		
		[DllImport("avformat-55", EntryPoint="avio_r8", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_r8(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_rl16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_rl16(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_rl24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_rl24(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_rl32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_rl32(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_rl64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern ulong avio_rl64(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_rb16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_rb16(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_rb24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_rb24(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_rb32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_rb32(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_rb64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern ulong avio_rb64(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_get_str", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_get_str(AVIOContext* pb, int maxlen, String buf, int buflen);
		
		[DllImport("avformat-55", EntryPoint="avio_get_str16le", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_get_str16le(AVIOContext* pb, int maxlen, String buf, int buflen);
		
		[DllImport("avformat-55", EntryPoint="avio_get_str16be", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_get_str16be(AVIOContext* pb, int maxlen, String buf, int buflen);
		
		[DllImport("avformat-55", EntryPoint="avio_open", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_open(AVIOContext** s, String url, int flags);
		
		[DllImport("avformat-55", EntryPoint="avio_open2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_open2(AVIOContext** s, String url, int flags, AVIOInterruptCB* int_cb, AVDictionary** options);
		
		[DllImport("avformat-55", EntryPoint="avio_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_close(AVIOContext* s);
		
		[DllImport("avformat-55", EntryPoint="avio_closep", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_closep(AVIOContext** s);
		
		[DllImport("avformat-55", EntryPoint="avio_open_dyn_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_open_dyn_buf(AVIOContext** s);
		
		[DllImport("avformat-55", EntryPoint="avio_close_dyn_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_close_dyn_buf(AVIOContext* s, byte** pbuffer);
		
		[DllImport("avformat-55", EntryPoint="avio_enum_protocols", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avio_enum_protocols(void** opaque, int output);
		
		[DllImport("avformat-55", EntryPoint="avio_pause", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avio_pause(AVIOContext* h, int pause);
		
		[DllImport("avformat-55", EntryPoint="avio_seek_time", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long avio_seek_time(AVIOContext* h, int stream_index, long timestamp, int flags);
		
		[DllImport("avformat-55", EntryPoint="av_get_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_packet(AVIOContext* s, AVPacket* pkt, int size);
		
		[DllImport("avformat-55", EntryPoint="av_append_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_append_packet(AVIOContext* s, AVPacket* pkt, int size);
		
		[DllImport("avformat-55", EntryPoint="av_stream_get_r_frame_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVRational av_stream_get_r_frame_rate(AVStream* s);
		
		[DllImport("avformat-55", EntryPoint="av_stream_set_r_frame_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_stream_set_r_frame_rate(AVStream* s, AVRational r);
		
		[DllImport("avformat-55", EntryPoint="av_fmt_ctx_get_duration_estimation_method", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVDurationEstimationMethod av_fmt_ctx_get_duration_estimation_method(AVFormatContext* ctx);
		
		[DllImport("avformat-55", EntryPoint="avformat_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_version();
		
		[DllImport("avformat-55", EntryPoint="avformat_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avformat_configuration();
		
		[DllImport("avformat-55", EntryPoint="avformat_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avformat_license();
		
		[DllImport("avformat-55", EntryPoint="av_register_all", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_register_all();
		
		[DllImport("avformat-55", EntryPoint="av_register_input_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_register_input_format(AVInputFormat* format);
		
		[DllImport("avformat-55", EntryPoint="av_register_output_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_register_output_format(AVOutputFormat* format);
		
		[DllImport("avformat-55", EntryPoint="avformat_network_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_network_init();
		
		[DllImport("avformat-55", EntryPoint="avformat_network_deinit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_network_deinit();
		
		[DllImport("avformat-55", EntryPoint="av_iformat_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVInputFormat* av_iformat_next(AVInputFormat* f);
		
		[DllImport("avformat-55", EntryPoint="av_oformat_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVOutputFormat* av_oformat_next(AVOutputFormat* f);
		
		[DllImport("avformat-55", EntryPoint="avformat_alloc_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVFormatContext* avformat_alloc_context();
		
		[DllImport("avformat-55", EntryPoint="avformat_free_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avformat_free_context(AVFormatContext* s);
		
		[DllImport("avformat-55", EntryPoint="avformat_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVClass* avformat_get_class();
		
		[DllImport("avformat-55", EntryPoint="avformat_new_stream", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVStream* avformat_new_stream(AVFormatContext* s, AVCodec* c);
		
		[DllImport("avformat-55", EntryPoint="av_new_program", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVProgram* av_new_program(AVFormatContext* s, int id);
		
		[DllImport("avformat-55", EntryPoint="avformat_alloc_output_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVFormatContext* avformat_alloc_output_context(String format, AVOutputFormat* oformat, String filename);
		
		[DllImport("avformat-55", EntryPoint="avformat_alloc_output_context2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avformat-55", EntryPoint="av_find_input_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVInputFormat* av_find_input_format(String short_name);
		
		[DllImport("avformat-55", EntryPoint="av_probe_input_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVInputFormat* av_probe_input_format(AVProbeData* pd, int is_opened);
		
		[DllImport("avformat-55", EntryPoint="av_probe_input_format2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVInputFormat* av_probe_input_format2(AVProbeData* pd, int is_opened, int* score_max);
		
		[DllImport("avformat-55", EntryPoint="av_probe_input_format3", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVInputFormat* av_probe_input_format3(AVProbeData* pd, int is_opened, int* score_ret);
		
		[DllImport("avformat-55", EntryPoint="av_probe_input_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avformat-55", EntryPoint="avformat_open_input", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_open_input(AVFormatContext** ps, String filename, AVInputFormat* fmt, AVDictionary** options);
		
		[DllImport("avformat-55", EntryPoint="av_demuxer_open", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_demuxer_open(AVFormatContext* ic);
		
		[DllImport("avformat-55", EntryPoint="av_find_stream_info", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_find_stream_info(AVFormatContext* ic);
		
		[DllImport("avformat-55", EntryPoint="avformat_find_stream_info", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_find_stream_info(AVFormatContext* ic, AVDictionary** options);
		
		[DllImport("avformat-55", EntryPoint="av_find_program_from_stream", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVProgram* av_find_program_from_stream(AVFormatContext* ic, AVProgram* last, int s);
		
		[DllImport("avformat-55", EntryPoint="av_find_best_stream", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avformat-55", EntryPoint="av_read_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_read_packet(AVFormatContext* s, AVPacket* pkt);
		
		[DllImport("avformat-55", EntryPoint="av_read_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_read_frame(AVFormatContext* s, AVPacket* pkt);
		
		[DllImport("avformat-55", EntryPoint="av_seek_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_seek_frame(AVFormatContext* s, int stream_index, long timestamp, int flags);
		
		[DllImport("avformat-55", EntryPoint="avformat_seek_file", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_seek_file(AVFormatContext* s, int stream_index, long min_ts, long ts, long max_ts, int flags);
		
		[DllImport("avformat-55", EntryPoint="av_read_play", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_read_play(AVFormatContext* s);
		
		[DllImport("avformat-55", EntryPoint="av_read_pause", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_read_pause(AVFormatContext* s);
		
		[DllImport("avformat-55", EntryPoint="av_close_input_file", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_close_input_file(AVFormatContext* s);
		
		[DllImport("avformat-55", EntryPoint="avformat_close_input", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avformat_close_input(AVFormatContext** s);
		
		[DllImport("avformat-55", EntryPoint="av_new_stream", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVStream* av_new_stream(AVFormatContext* s, int id);
		
		[DllImport("avformat-55", EntryPoint="av_set_pts_info", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_set_pts_info(AVStream* s, int pts_wrap_bits, int pts_num, int pts_den);
		
		[DllImport("avformat-55", EntryPoint="avformat_write_header", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_write_header(AVFormatContext* s, AVDictionary** options);
		
		[DllImport("avformat-55", EntryPoint="av_write_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_write_frame(AVFormatContext* s, AVPacket* pkt);
		
		[DllImport("avformat-55", EntryPoint="av_interleaved_write_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_interleaved_write_frame(AVFormatContext* s, AVPacket* pkt);
		
		[DllImport("avformat-55", EntryPoint="av_write_trailer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_write_trailer(AVFormatContext* s);
		
		[DllImport("avformat-55", EntryPoint="av_guess_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVOutputFormat* av_guess_format(String short_name, String filename, String mime_type);
		
		[DllImport("avformat-55", EntryPoint="av_guess_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avformat-55", EntryPoint="av_get_output_timestamp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_output_timestamp(AVFormatContext* s, int stream, long* dts, long* wall);
		
		[DllImport("avformat-55", EntryPoint="av_hex_dump", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_hex_dump(void* f, byte* buf, int size);
		
		[DllImport("avformat-55", EntryPoint="av_hex_dump_log", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_hex_dump_log(void* avcl, int level, byte* buf, int size);
		
		[DllImport("avformat-55", EntryPoint="av_pkt_dump2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_pkt_dump2(void* f, AVPacket* pkt, int dump_payload, AVStream* st);
		
		[DllImport("avformat-55", EntryPoint="av_pkt_dump_log2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_pkt_dump_log2(void* avcl, int level, AVPacket* pkt, int dump_payload, AVStream* st);
		
		[DllImport("avformat-55", EntryPoint="av_codec_get_id", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecID av_codec_get_id(AVCodecTag** tags, int tag);
		
		[DllImport("avformat-55", EntryPoint="av_codec_get_tag", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_codec_get_tag(AVCodecTag** tags, AVCodecID id);
		
		[DllImport("avformat-55", EntryPoint="av_codec_get_tag2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_codec_get_tag2(AVCodecTag** tags, AVCodecID id, int* tag);
		
		[DllImport("avformat-55", EntryPoint="av_find_default_stream_index", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_find_default_stream_index(AVFormatContext* s);
		
		[DllImport("avformat-55", EntryPoint="av_index_search_timestamp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_index_search_timestamp(AVStream* st, long timestamp, int flags);
		
		[DllImport("avformat-55", EntryPoint="av_add_index_entry", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_add_index_entry(AVStream* st, long pos, long timestamp, int size, int distance, int flags);
		
		[DllImport("avformat-55", EntryPoint="av_url_split", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avformat-55", EntryPoint="av_dump_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void av_dump_format(AVFormatContext* ic, int index, String url, int is_output);
		
		[DllImport("avformat-55", EntryPoint="av_get_frame_filename", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_get_frame_filename(String buf, int buf_size, String path, int number);
		
		[DllImport("avformat-55", EntryPoint="av_filename_number_test", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_filename_number_test(String filename);
		
		[DllImport("avformat-55", EntryPoint="av_sdp_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_sdp_create(AVFormatContext** ac, int n_files, String buf, int size);
		
		[DllImport("avformat-55", EntryPoint="av_match_ext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int av_match_ext(String filename, String extensions);
		
		[DllImport("avformat-55", EntryPoint="avformat_query_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_query_codec(AVOutputFormat* ofmt, AVCodecID codec_id, int std_compliance);
		
		[DllImport("avformat-55", EntryPoint="avformat_get_riff_video_tags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVCodecTag* avformat_get_riff_video_tags();
		
		[DllImport("avformat-55", EntryPoint="avformat_get_riff_audio_tags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avformat-55", EntryPoint="avformat_queue_attached_pictures", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avformat_queue_attached_pictures(AVFormatContext* s);
		
		[DllImport("avdevice-55", EntryPoint="avdevice_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avdevice_version();
		
		[DllImport("avdevice-55", EntryPoint="avdevice_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avdevice_configuration();
		
		[DllImport("avdevice-55", EntryPoint="avdevice_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String avdevice_license();
		
		[DllImport("avdevice-55", EntryPoint="avdevice_register_all", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avdevice_register_all();
		
		[DllImport("avfilter-3", EntryPoint="avfilter_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avfilter_version();
		
		[DllImport("avfilter-3", EntryPoint="avfilter_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_ref_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVFilterBufferRef* avfilter_ref_buffer(AVFilterBufferRef* @ref, int pmask);
		
		[DllImport("avfilter-3", EntryPoint="avfilter_unref_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avfilter_unref_buffer(AVFilterBufferRef* @ref);
		
		[DllImport("avfilter-3", EntryPoint="avfilter_unref_bufferp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_pad_get_type", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVMediaType avfilter_pad_get_type(AVFilterPad* pads, int pad_idx);
		
		[DllImport("avfilter-3", EntryPoint="avfilter_link", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avfilter_link(AVFilterContext* src, int srcpad, AVFilterContext* dst, int dstpad);
		
		[DllImport("avfilter-3", EntryPoint="avfilter_link_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avfilter_link_free(AVFilterLink** link);
		
		[DllImport("avfilter-3", EntryPoint="avfilter_link_get_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avfilter_link_get_channels(AVFilterLink* link);
		
		[DllImport("avfilter-3", EntryPoint="avfilter_link_set_closed", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avfilter_link_set_closed(AVFilterLink* link, int closed);
		
		[DllImport("avfilter-3", EntryPoint="avfilter_config_links", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int avfilter_config_links(AVFilterContext* filter);
		
		[DllImport("avfilter-3", EntryPoint="avfilter_get_video_buffer_ref_from_arrays", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_get_audio_buffer_ref_from_arrays", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_get_audio_buffer_ref_from_arrays_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_process_command", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_register_all", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avfilter_register_all();
		
		[DllImport("avfilter-3", EntryPoint="avfilter_uninit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void avfilter_uninit();
		
		[DllImport("avfilter-3", EntryPoint="avfilter_register", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_open", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_insert_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("avfilter-3", EntryPoint="avfilter_copy_frame_props", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("postproc-52", EntryPoint="postproc_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String postproc_configuration();
		
		[DllImport("postproc-52", EntryPoint="postproc_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String postproc_license();
		
		[DllImport("postproc-52", EntryPoint="pp_postprocess", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("postproc-52", EntryPoint="pp_get_mode_by_name_and_quality", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern pp_mode* pp_get_mode_by_name_and_quality(String name, int quality);
		
		[DllImport("postproc-52", EntryPoint="pp_free_mode", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void pp_free_mode(pp_mode* mode);
		
		[DllImport("postproc-52", EntryPoint="pp_get_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern pp_context* pp_get_context(int width, int height, int flags);
		
		[DllImport("postproc-52", EntryPoint="pp_free_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void pp_free_context(pp_context* ppContext);
		
		[DllImport("swresample-0", EntryPoint="swr_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern AVClass* swr_get_class();
		
		[DllImport("swresample-0", EntryPoint="swr_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern SwrContext* swr_alloc();
		
		[DllImport("swresample-0", EntryPoint="swr_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swr_init(SwrContext* s);
		
		[DllImport("swresample-0", EntryPoint="swr_alloc_set_opts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("swresample-0", EntryPoint="swr_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void swr_free(SwrContext** s);
		
		[DllImport("swresample-0", EntryPoint="swr_convert", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swr_convert(SwrContext* s, byte** @out, int out_count, byte** @in, int in_count);
		
		[DllImport("swresample-0", EntryPoint="swr_next_pts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long swr_next_pts(SwrContext* s, long pts);
		
		[DllImport("swresample-0", EntryPoint="swr_set_compensation", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swr_set_compensation(SwrContext* s, int sample_delta, int compensation_distance);
		
		[DllImport("swresample-0", EntryPoint="swr_set_channel_mapping", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swr_set_channel_mapping(SwrContext* s, int* channel_map);
		
		[DllImport("swresample-0", EntryPoint="swr_set_matrix", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swr_set_matrix(SwrContext* s, double* matrix, int stride);
		
		[DllImport("swresample-0", EntryPoint="swr_drop_output", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swr_drop_output(SwrContext* s, int count);
		
		[DllImport("swresample-0", EntryPoint="swr_inject_silence", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swr_inject_silence(SwrContext* s, int count);
		
		[DllImport("swresample-0", EntryPoint="swr_get_delay", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern long swr_get_delay(SwrContext* s, long @base);
		
		[DllImport("swresample-0", EntryPoint="swresample_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swresample_version();
		
		[DllImport("swresample-0", EntryPoint="swresample_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String swresample_configuration();
		
		[DllImport("swresample-0", EntryPoint="swresample_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String swresample_license();
		
		[DllImport("swscale-2", EntryPoint="swscale_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int swscale_version();
		
		[DllImport("swscale-2", EntryPoint="swscale_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String swscale_configuration();
		
		[DllImport("swscale-2", EntryPoint="swscale_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern String swscale_license();
		
		[DllImport("swscale-2", EntryPoint="sws_getCoefficients", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int* sws_getCoefficients(int colorspace);
		
		[DllImport("swscale-2", EntryPoint="sws_isSupportedInput", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int sws_isSupportedInput(AVPixelFormat pix_fmt);
		
		[DllImport("swscale-2", EntryPoint="sws_isSupportedOutput", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int sws_isSupportedOutput(AVPixelFormat pix_fmt);
		
		[DllImport("swscale-2", EntryPoint="sws_alloc_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern SwsContext* sws_alloc_context();
		
		[DllImport("swscale-2", EntryPoint="sws_init_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern int sws_init_context(SwsContext* sws_context, SwsFilter* srcFilter, SwsFilter* dstFilter);
		
		[DllImport("swscale-2", EntryPoint="sws_freeContext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_freeContext(SwsContext* swsContext);
		
		[DllImport("swscale-2", EntryPoint="sws_getContext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("swscale-2", EntryPoint="sws_scale", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("swscale-2", EntryPoint="sws_setColorspaceDetails", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("swscale-2", EntryPoint="sws_getColorspaceDetails", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("swscale-2", EntryPoint="sws_allocVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern SwsVector* sws_allocVec(int length);
		
		[DllImport("swscale-2", EntryPoint="sws_getGaussianVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern SwsVector* sws_getGaussianVec(double variance, double quality);
		
		[DllImport("swscale-2", EntryPoint="sws_getConstVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern SwsVector* sws_getConstVec(double c, int length);
		
		[DllImport("swscale-2", EntryPoint="sws_getIdentityVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern SwsVector* sws_getIdentityVec();
		
		[DllImport("swscale-2", EntryPoint="sws_scaleVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_scaleVec(SwsVector* a, double scalar);
		
		[DllImport("swscale-2", EntryPoint="sws_normalizeVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_normalizeVec(SwsVector* a, double height);
		
		[DllImport("swscale-2", EntryPoint="sws_convVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_convVec(SwsVector* a, SwsVector* b);
		
		[DllImport("swscale-2", EntryPoint="sws_addVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_addVec(SwsVector* a, SwsVector* b);
		
		[DllImport("swscale-2", EntryPoint="sws_subVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_subVec(SwsVector* a, SwsVector* b);
		
		[DllImport("swscale-2", EntryPoint="sws_shiftVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_shiftVec(SwsVector* a, int shift);
		
		[DllImport("swscale-2", EntryPoint="sws_cloneVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern SwsVector* sws_cloneVec(SwsVector* a);
		
		[DllImport("swscale-2", EntryPoint="sws_printVec2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_printVec2(SwsVector* a, AVClass* log_ctx, int log_level);
		
		[DllImport("swscale-2", EntryPoint="sws_freeVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_freeVec(SwsVector* a);
		
		[DllImport("swscale-2", EntryPoint="sws_getDefaultFilter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("swscale-2", EntryPoint="sws_freeFilter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_freeFilter(SwsFilter* filter);
		
		[DllImport("swscale-2", EntryPoint="sws_getCachedContext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		[DllImport("swscale-2", EntryPoint="sws_convertPalette8ToPacked32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_convertPalette8ToPacked32(byte* src, byte* dst, int num_pixels, byte* palette);
		
		[DllImport("swscale-2", EntryPoint="sws_convertPalette8ToPacked24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern void sws_convertPalette8ToPacked24(byte* src, byte* dst, int num_pixels, byte* palette);
		
		[DllImport("swscale-2", EntryPoint="sws_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
