...
namespace FFmpeg.AutoGen.New
{
    ...
    public unsafe static partial class ffmpeg
    {
        ...
        // public static  AV_CODEC_PROP_INTRA_ONLY = (1 << 0);
        // public static  AV_CODEC_PROP_LOSSY = (1 << 1);
        // public static  AV_CODEC_PROP_LOSSLESS = (1 << 2);
        // public static  AV_CODEC_PROP_REORDER = (1 << 3);
        // public static  AV_CODEC_PROP_BITMAP_SUB = (1 << 16);
        // public static  AV_CODEC_PROP_TEXT_SUB = (1 << 17);
        ...
        // public static  AV_CODEC_FLAG_UNALIGNED = (1 <<  0);
        // public static  AV_CODEC_FLAG_QSCALE = (1 <<  1);
        // public static  AV_CODEC_FLAG_4MV = (1 <<  2);
        // public static  AV_CODEC_FLAG_OUTPUT_CORRUPT = (1 <<  3);
        // public static  AV_CODEC_FLAG_QPEL = (1 <<  4);
        // public static  AV_CODEC_FLAG_PASS1 = (1 <<  9);
        // public static  AV_CODEC_FLAG_PASS2 = (1 << 10);
        // public static  AV_CODEC_FLAG_LOOP_FILTER = (1 << 11);
        // public static  AV_CODEC_FLAG_GRAY = (1 << 13);
        // public static  AV_CODEC_FLAG_PSNR = (1 << 15);
        // public static  AV_CODEC_FLAG_TRUNCATED = (1 << 16);
        // public static  AV_CODEC_FLAG_INTERLACED_DCT = (1 << 18);
        // public static  AV_CODEC_FLAG_LOW_DELAY = (1 << 19);
        // public static  AV_CODEC_FLAG_GLOBAL_HEADER = (1 << 22);
        // public static  AV_CODEC_FLAG_BITEXACT = (1 << 23);
        // public static  AV_CODEC_FLAG_AC_PRED = (1 << 24);
        // public static  AV_CODEC_FLAG_INTERLACED_ME = (1 << 29);
        // public static  AV_CODEC_FLAG_CLOSED_GOP = (1U << 31);
        // public static  AV_CODEC_FLAG2_FAST = (1 <<  0);
        // public static  AV_CODEC_FLAG2_NO_OUTPUT = (1 <<  2);
        // public static  AV_CODEC_FLAG2_LOCAL_HEADER = (1 <<  3);
        // public static  AV_CODEC_FLAG2_DROP_FRAME_TIMECODE = (1 << 13);
        // public static  AV_CODEC_FLAG2_CHUNKS = (1 << 15);
        // public static  AV_CODEC_FLAG2_IGNORE_CROP = (1 << 16);
        // public static  AV_CODEC_FLAG2_SHOW_ALL = (1 << 22);
        // public static  AV_CODEC_FLAG2_EXPORT_MVS = (1 << 28);
        // public static  AV_CODEC_FLAG2_SKIP_MANUAL = (1 << 29);
        // public static  AV_CODEC_FLAG2_RO_FLUSH_NOOP = (1 << 30);
        // public static  AV_CODEC_CAP_DRAW_HORIZ_BAND = (1 <<  0);
        // public static  AV_CODEC_CAP_DR1 = (1 <<  1);
        // public static  AV_CODEC_CAP_TRUNCATED = (1 <<  3);
        // public static  AV_CODEC_CAP_DELAY = (1 <<  5);
        // public static  AV_CODEC_CAP_SMALL_LAST_FRAME = (1 <<  6);
        // public static  AV_CODEC_CAP_HWACCEL_VDPAU = (1 <<  7);
        // public static  AV_CODEC_CAP_SUBFRAMES = (1 <<  8);
        // public static  AV_CODEC_CAP_EXPERIMENTAL = (1 <<  9);
        // public static  AV_CODEC_CAP_CHANNEL_CONF = (1 << 10);
        // public static  AV_CODEC_CAP_FRAME_THREADS = (1 << 12);
        // public static  AV_CODEC_CAP_SLICE_THREADS = (1 << 13);
        // public static  AV_CODEC_CAP_PARAM_CHANGE = (1 << 14);
        // public static  AV_CODEC_CAP_AUTO_THREADS = (1 << 15);
        // public static  AV_CODEC_CAP_VARIABLE_FRAME_SIZE = (1 << 16);
        // public static  AV_CODEC_CAP_AVOID_PROBING = (1 << 17);
        public static int AV_CODEC_CAP_INTRA_ONLY = 1073741824;
        public static int AV_CODEC_CAP_LOSSLESS = -2147483648;
        // public static  CODEC_FLAG_UNALIGNED = AV_CODEC_FLAG_UNALIGNED;
        // public static  CODEC_FLAG_QSCALE = AV_CODEC_FLAG_QSCALE;
        // public static  CODEC_FLAG_4MV = AV_CODEC_FLAG_4MV;
        // public static  CODEC_FLAG_OUTPUT_CORRUPT = AV_CODEC_FLAG_OUTPUT_CORRUPT;
        // public static  CODEC_FLAG_QPEL = AV_CODEC_FLAG_QPEL;
        public static int CODEC_FLAG_GMC = 32;
        public static int CODEC_FLAG_MV0 = 64;
        public static int CODEC_FLAG_INPUT_PRESERVED = 256;
        // public static  CODEC_FLAG_PASS1 = AV_CODEC_FLAG_PASS1;
        // public static  CODEC_FLAG_PASS2 = AV_CODEC_FLAG_PASS2;
        // public static  CODEC_FLAG_GRAY = AV_CODEC_FLAG_GRAY;
        public static int CODEC_FLAG_EMU_EDGE = 16384;
        // public static  CODEC_FLAG_PSNR = AV_CODEC_FLAG_PSNR;
        // public static  CODEC_FLAG_TRUNCATED = AV_CODEC_FLAG_TRUNCATED;
        public static int CODEC_FLAG_NORMALIZE_AQP = 131072;
        // public static  CODEC_FLAG_INTERLACED_DCT = AV_CODEC_FLAG_INTERLACED_DCT;
        // public static  CODEC_FLAG_LOW_DELAY = AV_CODEC_FLAG_LOW_DELAY;
        // public static  CODEC_FLAG_GLOBAL_HEADER = AV_CODEC_FLAG_GLOBAL_HEADER;
        // public static  CODEC_FLAG_BITEXACT = AV_CODEC_FLAG_BITEXACT;
        // public static  CODEC_FLAG_AC_PRED = AV_CODEC_FLAG_AC_PRED;
        // public static  CODEC_FLAG_LOOP_FILTER = AV_CODEC_FLAG_LOOP_FILTER;
        // public static  CODEC_FLAG_INTERLACED_ME = AV_CODEC_FLAG_INTERLACED_ME;
        // public static  CODEC_FLAG_CLOSED_GOP = AV_CODEC_FLAG_CLOSED_GOP;
        // public static  CODEC_FLAG2_FAST = AV_CODEC_FLAG2_FAST;
        // public static  CODEC_FLAG2_NO_OUTPUT = AV_CODEC_FLAG2_NO_OUTPUT;
        // public static  CODEC_FLAG2_LOCAL_HEADER = AV_CODEC_FLAG2_LOCAL_HEADER;
        // public static  CODEC_FLAG2_DROP_FRAME_TIMECODE = AV_CODEC_FLAG2_DROP_FRAME_TIMECODE;
        // public static  CODEC_FLAG2_IGNORE_CROP = AV_CODEC_FLAG2_IGNORE_CROP;
        // public static  CODEC_FLAG2_CHUNKS = AV_CODEC_FLAG2_CHUNKS;
        // public static  CODEC_FLAG2_SHOW_ALL = AV_CODEC_FLAG2_SHOW_ALL;
        // public static  CODEC_FLAG2_EXPORT_MVS = AV_CODEC_FLAG2_EXPORT_MVS;
        // public static  CODEC_FLAG2_SKIP_MANUAL = AV_CODEC_FLAG2_SKIP_MANUAL;
        // public static  CODEC_CAP_DRAW_HORIZ_BAND = AV_CODEC_CAP_DRAW_HORIZ_BAND;
        // public static  CODEC_CAP_DR1 = AV_CODEC_CAP_DR1;
        // public static  CODEC_CAP_TRUNCATED = AV_CODEC_CAP_TRUNCATED;
        public static int CODEC_CAP_HWACCEL = 16;
        // public static  CODEC_CAP_DELAY = AV_CODEC_CAP_DELAY;
        // public static  CODEC_CAP_SMALL_LAST_FRAME = AV_CODEC_CAP_SMALL_LAST_FRAME;
        // public static  CODEC_CAP_HWACCEL_VDPAU = AV_CODEC_CAP_HWACCEL_VDPAU;
        // public static  CODEC_CAP_SUBFRAMES = AV_CODEC_CAP_SUBFRAMES;
        // public static  CODEC_CAP_EXPERIMENTAL = AV_CODEC_CAP_EXPERIMENTAL;
        // public static  CODEC_CAP_CHANNEL_CONF = AV_CODEC_CAP_CHANNEL_CONF;
        public static int CODEC_CAP_NEG_LINESIZES = 2048;
        // public static  CODEC_CAP_FRAME_THREADS = AV_CODEC_CAP_FRAME_THREADS;
        // public static  CODEC_CAP_SLICE_THREADS = AV_CODEC_CAP_SLICE_THREADS;
        // public static  CODEC_CAP_PARAM_CHANGE = AV_CODEC_CAP_PARAM_CHANGE;
        // public static  CODEC_CAP_AUTO_THREADS = AV_CODEC_CAP_AUTO_THREADS;
        // public static  CODEC_CAP_VARIABLE_FRAME_SIZE = AV_CODEC_CAP_VARIABLE_FRAME_SIZE;
        // public static  CODEC_CAP_INTRA_ONLY = AV_CODEC_CAP_INTRA_ONLY;
        // public static  CODEC_CAP_LOSSLESS = AV_CODEC_CAP_LOSSLESS;
        public static int HWACCEL_CODEC_CAP_EXPERIMENTAL = 512;
        public static int MB_TYPE_INTRA4x4 = 1;
        public static int MB_TYPE_INTRA16x16 = 2;
        public static int MB_TYPE_INTRA_PCM = 4;
        public static int MB_TYPE_16x16 = 8;
        public static int MB_TYPE_16x8 = 16;
        public static int MB_TYPE_8x16 = 32;
        public static int MB_TYPE_8x8 = 64;
        public static int MB_TYPE_INTERLACED = 128;
        public static int MB_TYPE_DIRECT2 = 256;
        public static int MB_TYPE_ACPRED = 512;
        public static int MB_TYPE_GMC = 1024;
        public static int MB_TYPE_SKIP = 2048;
        public static int MB_TYPE_P0L0 = 4096;
        public static int MB_TYPE_P1L0 = 8192;
        public static int MB_TYPE_P0L1 = 16384;
        public static int MB_TYPE_P1L1 = 32768;
        // public static  MB_TYPE_L0 = (MB_TYPE_P0L0 | MB_TYPE_P1L0);
        // public static  MB_TYPE_L1 = (MB_TYPE_P0L1 | MB_TYPE_P1L1);
        // public static  MB_TYPE_L0L1 = (MB_TYPE_L0   | MB_TYPE_L1);
        public static int MB_TYPE_QUANT = 65536;
        public static int MB_TYPE_CBP = 131072;
        ...
        // public static  AV_GET_BUFFER_FLAG_REF = (1 << 0);
        ...
        public static int SLICE_FLAG_CODED_ORDER = 1;
        public static int SLICE_FLAG_ALLOW_FIELD = 2;
        public static int SLICE_FLAG_ALLOW_PLANE = 4;
        ...
        public static int FF_DEBUG_DCT_COEFF = 64;
        public static int FF_DEBUG_SKIP = 128;
        public static int FF_DEBUG_STARTCODE = 256;
        public static int FF_DEBUG_PTS = 512;
        public static int FF_DEBUG_ER = 1024;
        public static int FF_DEBUG_MMCO = 2048;
        public static int FF_DEBUG_BUGS = 4096;
        public static int FF_DEBUG_VIS_QP = 8192;
        public static int FF_DEBUG_VIS_MB_TYPE = 16384;
        public static int FF_DEBUG_BUFFERS = 32768;
        public static int FF_DEBUG_THREADS = 65536;
        public static int FF_DEBUG_GREEN_MD = 8388608;
        public static int FF_DEBUG_NOMC = 16777216;
        public static int FF_DEBUG_VIS_MV_P_FOR = 1;
        public static int FF_DEBUG_VIS_MV_B_FOR = 2;
        public static int FF_DEBUG_VIS_MV_B_BACK = 4;
        // public static  AV_EF_CRCCHECK = (1<<0);
        // public static  AV_EF_BITSTREAM = (1<<1);
        // public static  AV_EF_BUFFER = (1<<2);
        // public static  AV_EF_EXPLODE = (1<<3);
        // public static  AV_EF_IGNORE_ERR = (1<<15);
        // public static  AV_EF_CAREFUL = (1<<16);
        // public static  AV_EF_COMPLIANT = (1<<17);
        // public static  AV_EF_AGGRESSIVE = (1<<18);
        ...
        // public static  FF_PROFILE_H264_CONSTRAINED = (1<<9);
        // public static  FF_PROFILE_H264_INTRA = (1<<11);
        public static int FF_PROFILE_H264_BASELINE = 66;
        // public static  FF_PROFILE_H264_CONSTRAINED_BASELINE = (66|FF_PROFILE_H264_CONSTRAINED);
        ...
        // public static  FF_PROFILE_H264_HIGH_10_INTRA = (110|FF_PROFILE_H264_INTRA);
        public static int FF_PROFILE_H264_MULTIVIEW_HIGH = 118;
        public static int FF_PROFILE_H264_HIGH_422 = 122;
        // public static  FF_PROFILE_H264_HIGH_422_INTRA = (122|FF_PROFILE_H264_INTRA);
        ...
        // public static  FF_PROFILE_H264_HIGH_444_INTRA = (244|FF_PROFILE_H264_INTRA);
        ...
        public static int FF_CODEC_PROPERTY_CLOSED_CAPTIONS = 2;
        public static int FF_SUB_TEXT_FMT_ASS = 0;
        public static int FF_SUB_TEXT_FMT_ASS_WITH_TIMINGS = 1;
        // public static  AV_HWACCEL_FLAG_IGNORE_LEVEL = (1 << 0);
        // public static  AV_HWACCEL_FLAG_ALLOW_HIGH_DEPTH = (1 << 1);
        public static int AV_SUBTITLE_FLAG_FORCED = 1;
        public static int AV_PARSER_PTS_NB = 4;
        public static int PARSER_FLAG_COMPLETE_FRAMES = 1;
        public static int PARSER_FLAG_ONCE = 2;
        public static int PARSER_FLAG_FETCHED_OFFSET = 4;
        public static int PARSER_FLAG_USE_CODEC_TS = 4096;
        public static int AV_CPU_FLAG_FORCE = -2147483648;
        public static int AV_CPU_FLAG_MMX = 1;
        public static int AV_CPU_FLAG_MMXEXT = 2;
        public static int AV_CPU_FLAG_MMX2 = 2;
        public static int AV_CPU_FLAG_3DNOW = 4;
        public static int AV_CPU_FLAG_SSE = 8;
        public static int AV_CPU_FLAG_SSE2 = 16;
        public static int AV_CPU_FLAG_SSE2SLOW = 1073741824;
        public static int AV_CPU_FLAG_3DNOWEXT = 32;
        public static int AV_CPU_FLAG_SSE3 = 64;
        public static int AV_CPU_FLAG_SSE3SLOW = 536870912;
        public static int AV_CPU_FLAG_SSSE3 = 128;
        public static int AV_CPU_FLAG_ATOM = 268435456;
        public static int AV_CPU_FLAG_SSE4 = 256;
        public static int AV_CPU_FLAG_SSE42 = 512;
        public static int AV_CPU_FLAG_AESNI = 524288;
        public static int AV_CPU_FLAG_AVX = 16384;
        public static int AV_CPU_FLAG_AVXSLOW = 134217728;
        public static int AV_CPU_FLAG_XOP = 1024;
        public static int AV_CPU_FLAG_FMA4 = 2048;
        public static int AV_CPU_FLAG_CMOV = 4096;
        public static int AV_CPU_FLAG_AVX2 = 32768;
        public static int AV_CPU_FLAG_FMA3 = 65536;
        public static int AV_CPU_FLAG_BMI1 = 131072;
        public static int AV_CPU_FLAG_BMI2 = 262144;
        public static int AV_CPU_FLAG_ALTIVEC = 1;
        public static int AV_CPU_FLAG_VSX = 2;
        public static int AV_CPU_FLAG_POWER8 = 4;
        // public static  AV_CPU_FLAG_ARMV5TE = (1 << 0);
        // public static  AV_CPU_FLAG_ARMV6 = (1 << 1);
        // public static  AV_CPU_FLAG_ARMV6T2 = (1 << 2);
        // public static  AV_CPU_FLAG_VFP = (1 << 3);
        // public static  AV_CPU_FLAG_VFPV3 = (1 << 4);
        // public static  AV_CPU_FLAG_NEON = (1 << 5);
        // public static  AV_CPU_FLAG_ARMV8 = (1 << 6);
        // public static  AV_CPU_FLAG_VFP_VM = (1 << 7);
        // public static  AV_CPU_FLAG_SETEND = (1 <<16);
        ...
        // public static  FF_API_VIMA_DECODER = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_AUDIO_CONVERT = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_AVCODEC_RESAMPLE = FF_API_AUDIO_CONVERT;
        // public static  FF_API_GETCHROMA = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_MISSING_SAMPLE = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_LOWRES = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_CAP_VDPAU = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_BUFS_VDPAU = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_VOXWARE = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_SET_DIMENSIONS = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_DEBUG_MV = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_AC_VLC = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_OLD_MSMPEG4 = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_ASPECT_EXTENDED = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_ARCH_ALPHA = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_ERROR_RATE = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_QSCALE_TYPE = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_MB_TYPE = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_MAX_BFRAMES = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_NEG_LINESIZES = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_EMU_EDGE = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_ARCH_SH4 = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_ARCH_SPARC = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_UNUSED_MEMBERS = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_IDCT_XVIDMMX = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_INPUT_PRESERVED = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_NORMALIZE_AQP = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_GMC = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_MV0 = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_CODEC_NAME = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_AFD = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_VISMV = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_AUDIOENC_DELAY = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_VAAPI_CONTEXT = (LIBAVCODEC_VERSION_MAJOR < 58);
        // public static  FF_API_AVCTX_TIMEBASE = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_MPV_OPT = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_STREAM_CODEC_TAG = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_QUANT_BIAS = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_RC_STRATEGY = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_CODED_FRAME = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_MOTION_EST = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_WITHOUT_PREFIX = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_SIDEDATA_ONLY_PKT = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_VDPAU_PROFILE = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_CONVERGENCE_DURATION = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_AVPICTURE = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_AVPACKET_OLD_API = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_RTP_CALLBACK = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_VBV_DELAY = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_CODER_TYPE = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_STAT_BITS = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_PRIVATE_OPT = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_ASS_TIMING = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_OLD_BSF = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_COPY_CONTEXT = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_GET_CONTEXT_DEFAULTS = (LIBAVCODEC_VERSION_MAJOR < 59);
        // public static  FF_API_NVENC_OLD_NAME = (LIBAVCODEC_VERSION_MAJOR < 59);
