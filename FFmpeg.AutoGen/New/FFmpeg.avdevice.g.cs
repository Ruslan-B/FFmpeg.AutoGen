...
namespace FFmpeg.AutoGen.New
{
    ...
    public unsafe static partial class ffmpeg
    {
        ...
        // public static  AV_OPT_FLAG_FILTERING_PARAM = (1<<16);
        // public static  AV_OPT_SEARCH_CHILDREN = (1 << 0);
        // public static  AV_OPT_SEARCH_FAKE_OBJ = (1 << 1);
        // public static  AV_OPT_ALLOW_NULL = (1 << 2);
        // public static  AV_OPT_MULTI_COMPONENT_RANGE = (1 << 12);
        public static int AV_OPT_SERIALIZE_SKIP_DEFAULTS = 1;
        public static int AV_OPT_SERIALIZE_OPT_FLAGS_EXACT = 2;
