...
public static unsafe partial class DynamicallyLoadedBindings
{
    ...
    public unsafe static void Initialize()
    {
        ...
        {
            vectors.av_alpha_mode_from_name = FunctionResolver.GetFunctionDelegate<vectors.av_alpha_mode_from_name_delegate>("avutil", "av_alpha_mode_from_name", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
            return vectors.av_alpha_mode_from_name(@name);
        };
        
        vectors.av_alpha_mode_name = (AVAlphaMode @mode) =>
        {
            vectors.av_alpha_mode_name = FunctionResolver.GetFunctionDelegate<vectors.av_alpha_mode_name_delegate>("avutil", "av_alpha_mode_name", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.av_buffersink_get_alpha_mode = FunctionResolver.GetFunctionDelegate<vectors.av_buffersink_get_alpha_mode_delegate>("avfilter", "av_buffersink_get_alpha_mode", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.av_buffersink_get_side_data = FunctionResolver.GetFunctionDelegate<vectors.av_buffersink_get_side_data_delegate>("avfilter", "av_buffersink_get_side_data", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.av_buffersrc_get_status = FunctionResolver.GetFunctionDelegate<vectors.av_buffersrc_get_status_delegate>("avfilter", "av_buffersrc_get_status", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.av_container_fifo_alloc_avpacket = FunctionResolver.GetFunctionDelegate<vectors.av_container_fifo_alloc_avpacket_delegate>("avcodec", "av_container_fifo_alloc_avpacket", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        vectors.av_dynamic_hdr_smpte2094_app5_create_side_data = (AVFrame* @frame) =>
        {
        ...
        vectors.av_dynamic_hdr_smpte2094_app5_from_t35 = (AVDynamicHDRSmpte2094App5* @s, byte* @data, ulong @size) =>
        {
        ...
        vectors.av_dynamic_hdr_smpte2094_app5_to_t35 = (AVDynamicHDRSmpte2094App5* @s, byte** @data, ulong* @size) =>
        {
        ...
        {
            vectors.av_frame_side_data_remove_by_props = FunctionResolver.GetFunctionDelegate<vectors.av_frame_side_data_remove_by_props_delegate>("avutil", "av_frame_side_data_remove_by_props", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.av_mime_codec_str = FunctionResolver.GetFunctionDelegate<vectors.av_mime_codec_str_delegate>("avformat", "av_mime_codec_str", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.av_packet_side_data_from_frame = FunctionResolver.GetFunctionDelegate<vectors.av_packet_side_data_from_frame_delegate>("avcodec", "av_packet_side_data_from_frame", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.av_packet_side_data_to_frame = FunctionResolver.GetFunctionDelegate<vectors.av_packet_side_data_to_frame_delegate>("avcodec", "av_packet_side_data_to_frame", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        vectors.av_parser_init = (AVCodecID @codec_id) =>
        {
        ...
        vectors.av_program_add_stream_index2 = (AVFormatContext* @ac, int @progid, uint @idx) =>
        {
        ...
        vectors.av_program_copy = (AVFormatContext* @dst, AVFormatContext* @src, int @progid, int @flags) =>
        {
        ...
        {
            vectors.avcodec_receive_frame_flags = FunctionResolver.GetFunctionDelegate<vectors.avcodec_receive_frame_flags_delegate>("avcodec", "avcodec_receive_frame_flags", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.avfilter_link_get_hw_frames_ctx = FunctionResolver.GetFunctionDelegate<vectors.avfilter_link_get_hw_frames_ctx_delegate>("avfilter", "avfilter_link_get_hw_frames_ctx", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.avformat_receive_command_reply = FunctionResolver.GetFunctionDelegate<vectors.avformat_receive_command_reply_delegate>("avformat", "avformat_receive_command_reply", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.avformat_send_command = FunctionResolver.GetFunctionDelegate<vectors.avformat_send_command_delegate>("avformat", "avformat_send_command", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.sws_frame_setup = FunctionResolver.GetFunctionDelegate<vectors.sws_frame_setup_delegate>("swscale", "sws_frame_setup", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.sws_free_context = FunctionResolver.GetFunctionDelegate<vectors.sws_free_context_delegate>("swscale", "sws_free_context", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.sws_is_noop = FunctionResolver.GetFunctionDelegate<vectors.sws_is_noop_delegate>("swscale", "sws_is_noop", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
        ...
        {
            vectors.sws_test_colorspace = FunctionResolver.GetFunctionDelegate<vectors.sws_test_colorspace_delegate>("swscale", "sws_test_colorspace", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
            return vectors.sws_test_colorspace(@colorspace, @output);
        };
        
        vectors.sws_test_format = (AVPixelFormat @format, int @output) =>
        {
            vectors.sws_test_format = FunctionResolver.GetFunctionDelegate<vectors.sws_test_format_delegate>("swscale", "sws_test_format", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
            return vectors.sws_test_format(@format, @output);
        };
        
        vectors.sws_test_frame = (AVFrame* @frame, int @output) =>
        {
            vectors.sws_test_frame = FunctionResolver.GetFunctionDelegate<vectors.sws_test_frame_delegate>("swscale", "sws_test_frame", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
            return vectors.sws_test_frame(@frame, @output);
        };
        
        vectors.sws_test_hw_format = (AVPixelFormat @format) =>
        {
            vectors.sws_test_hw_format = FunctionResolver.GetFunctionDelegate<vectors.sws_test_hw_format_delegate>("swscale", "sws_test_hw_format", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
            return vectors.sws_test_hw_format(@format);
        };
        
        vectors.sws_test_primaries = (AVColorPrimaries @primaries, int @output) =>
        {
            vectors.sws_test_primaries = FunctionResolver.GetFunctionDelegate<vectors.sws_test_primaries_delegate>("swscale", "sws_test_primaries", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
            return vectors.sws_test_primaries(@primaries, @output);
        };
        
        vectors.sws_test_transfer = (AVColorTransferCharacteristic @trc, int @output) =>
        {
            vectors.sws_test_transfer = FunctionResolver.GetFunctionDelegate<vectors.sws_test_transfer_delegate>("swscale", "sws_test_transfer", ThrowErrorIfFunctionNotFound) ?? delegate { throw new NotSupportedException(); };
