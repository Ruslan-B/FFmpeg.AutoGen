...
public unsafe struct double_array2x399 : IFixedArray<double_array399>
{
    public static readonly int Size = 2;
    public int Length => 2;
    ...
    {
        get { if (i >= 2) throw new ArgumentOutOfRangeException(); fixed (double_array399* p0 = &_0) { return *(p0 + i); } }
        set { if (i >= 2) throw new ArgumentOutOfRangeException(); fixed (double_array399* p0 = &_0) { *(p0 + i) = value;  } }
    }
    public double_array399[] ToArray()
    {
        fixed (double_array399* p0 = &_0) { var a = new double_array399[2]; for (uint i = 0; i < 2; i++) a[i] = *(p0 + i); return a; }
    }
    public void UpdateFrom(double_array399[] array)
    {
        fixed (double_array399* p0 = &_0) { uint i = 0; foreach(var value in array) { *(p0 + i++) = value; if (i >= 2) return; } }
    }
...
public unsafe struct int_array5 : IFixedArray<int>
{
...
public unsafe struct byte_array17 : IFixedArray<byte>
{
...
public unsafe struct long_array17 : IFixedArray<long>
{
    public static readonly int Size = 17;
    public int Length => 17;
    fixed long _[17];
...
public unsafe struct double_array399 : IFixedArray<double>
{
...
public unsafe struct byte_array1024 : IFixedArray<byte>
{
