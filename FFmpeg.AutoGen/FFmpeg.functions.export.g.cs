...
namespace FFmpeg.AutoGen
{
    public unsafe static partial class ffmpeg
    {
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bitstream_filter_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bitstream_filter_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #endif
    string @args, ref byte* @poutbuf, int* @poutbuf_size, byte* @buf, int @buf_size, int @keyframe);
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bitstream_filter_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bitstream_filter_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="ctx">a pointer into which the pointer to the newly-allocated context will be written. It must be freed with av_bsf_free() after the filtering is done.</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_bsf_alloc(AVBitStreamFilter* @filter, ref AVBSFContext* @ctx);
        
        /// <summary>Reset the internal bitstream filter state. Should be called e.g. when seeking.</summary>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_flush", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_bsf_free(AVBSFContext** @ctx);
        
        /// <summary>Free a bitstream filter context and everything associated with it; write NULL into the supplied pointer.</summary>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_bsf_free(ref AVBSFContext* @ctx);
        
        /// <summary>Returns a bitstream filter with the specified name or NULL if no such bitstream filter exists.</summary>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_get_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_get_null_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_bsf_get_null_filter(AVBSFContext** @bsf);
        
        /// <summary>Get null/pass-through bitstream filter.</summary>
        /// <param name="bsf">Pointer to be set to new instance of pass-through bitstream filter</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_get_null_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_bsf_get_null_filter(ref AVBSFContext* @bsf);
        
        /// <summary>Prepare the filter for use, after all the parameters and options have been set.</summary>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBitStreamFilter* av_bsf_iterate(void** @opaque);
        
        /// <summary>Iterate over all registered bitstream filters.</summary>
        /// <param name="opaque">a pointer where libavcodec will store the iteration state. Must point to NULL to start the iteration.</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBitStreamFilter* av_bsf_iterate(ref void* @opaque);
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_append", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_append2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #endif
    string @bsf_name, ref AVDictionary* @options);
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_finalize", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="bsf">Pointer to be set to newly created structure representing the chain of bitstream filters</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_finalize", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_bsf_list_finalize(ref AVBSFList* @lst, ref AVBSFContext* @bsf);
        
        /// <summary>Free list of bitstream filters.</summary>
        /// <param name="lst">Pointer to pointer returned by av_bsf_list_alloc()</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_bsf_list_free(AVBSFList** @lst);
        
        /// <summary>Free list of bitstream filters.</summary>
        /// <param name="lst">Pointer to pointer returned by av_bsf_list_alloc()</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_bsf_list_free(ref AVBSFList* @lst);
        ...
        /// <param name="bsf">Pointer to be set to newly created structure representing the chain of bitstream filters</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_parse_str", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #endif
    string @str, ref AVBSFContext* @bsf);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_bsf_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBitStreamFilter* av_bsf_next(void** @opaque);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_bsf_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBitStreamFilter* av_bsf_next(ref void* @opaque);
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_receive_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_bsf_send_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_bsf_send_packet(AVBSFContext* @ctx, AVPacket* @pkt);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_get_chroma_intra_matrix", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ushort* av_codec_get_chroma_intra_matrix(AVCodecContext* @avctx);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_get_codec_descriptor", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCodecDescriptor* av_codec_get_codec_descriptor(AVCodecContext* @avctx);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_get_codec_properties", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint av_codec_get_codec_properties(AVCodecContext* @avctx);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_get_lowres", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_codec_get_lowres(AVCodecContext* @avctx);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_get_max_lowres", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_get_pkt_timebase", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVRational av_codec_get_pkt_timebase(AVCodecContext* @avctx);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_get_seek_preroll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_codec_is_decoder", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_codec_is_encoder", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_codec_is_encoder(AVCodec* @codec);
        
        /// <summary>Iterate over all registered codecs.</summary>
        /// <param name="opaque">a pointer where libavcodec will store the iteration state. Must point to NULL to start the iteration.</param>
        [DllImport("avcodec-58", EntryPoint = "av_codec_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCodec* av_codec_next(AVCodec* @c);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_set_chroma_intra_matrix", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_codec_set_chroma_intra_matrix(AVCodecContext* @avctx, ushort* @val);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_set_codec_descriptor", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_codec_set_codec_descriptor(AVCodecContext* @avctx, AVCodecDescriptor* @desc);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_set_lowres", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_codec_set_lowres(AVCodecContext* @avctx, int @val);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_set_pkt_timebase", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_codec_set_pkt_timebase(AVCodecContext* @avctx, AVRational @val);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_codec_set_seek_preroll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_copy_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_copy_packet_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_cpb_properties_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCPBProperties* av_cpb_properties_alloc(ulong* @size);
        
        /// <summary>Allocate an AVD3D11VAContext.</summary>
        [DllImport("avcodec-58", EntryPoint = "av_d3d11va_alloc_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVD3D11VAContext* av_d3d11va_alloc_context();
        
        [Obsolete("Use av_packet_ref or av_packet_make_refcounted")]
        [DllImport("avcodec-58", EntryPoint = "av_dup_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_fast_padded_malloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_fast_padded_mallocz", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_free_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_get_audio_frame_duration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_get_audio_frame_duration2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_get_bits_per_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_get_codec_tag_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="codec_id">the codec</param>
        [DllImport("avcodec-58", EntryPoint = "av_get_exact_bits_per_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_get_pcm_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_get_profile_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_grow_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_hwaccel_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_init_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_lockmgr_register", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_new_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_add_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVPacket* av_packet_alloc();
        
        /// <summary>Create a new packet that references the same data as src.</summary>
        [DllImport("avcodec-58", EntryPoint = "av_packet_clone", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_copy_props", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="pkt">packet</param>
        [DllImport("avcodec-58", EntryPoint = "av_packet_free_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_from_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_get_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_make_refcounted", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_make_writable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_packet_make_writable(AVPacket* @pkt);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_packet_merge_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_move_ref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="type">side information type</param>
        /// <param name="size">side information size</param>
        [DllImport("avcodec-58", EntryPoint = "av_packet_new_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern byte* av_packet_new_side_data(AVPacket* @pkt, AVPacketSideDataType @type, int @size);
        
        [DllImport("avcodec-58", EntryPoint = "av_packet_pack_dictionary", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="src">Source packet</param>
        [DllImport("avcodec-58", EntryPoint = "av_packet_ref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_rescale_ts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_packet_shrink_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_packet_shrink_side_data(AVPacket* @pkt, AVPacketSideDataType @type, int @size);
        
        [DllImport("avcodec-58", EntryPoint = "av_packet_side_data_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string av_packet_side_data_name(AVPacketSideDataType @type);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_packet_split_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_packet_split_side_data(AVPacket* @pkt);
        
        [DllImport("avcodec-58", EntryPoint = "av_packet_unpack_dictionary", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_packet_unpack_dictionary(byte* @data, int @size, AVDictionary** @dict);
        
        [DllImport("avcodec-58", EntryPoint = "av_packet_unpack_dictionary", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_packet_unpack_dictionary(byte* @data, int @size, ref AVDictionary* @dict);
        
        /// <summary>Wipe the packet.</summary>
        /// <param name="pkt">The packet to be unreferenced.</param>
        [DllImport("avcodec-58", EntryPoint = "av_packet_unref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_parser_change", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("Use dump_extradata, remove_extra or extract_extradata bitstream filters instead.")]
        [DllImport("avcodec-58", EntryPoint = "av_parser_change", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_parser_change(AVCodecParserContext* @s, AVCodecContext* @avctx, ref byte* @poutbuf, int* @poutbuf_size, byte* @buf, int @buf_size, int @keyframe);
        
        [DllImport("avcodec-58", EntryPoint = "av_parser_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_parser_close(AVCodecParserContext* @s);
        
        [DllImport("avcodec-58", EntryPoint = "av_parser_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="opaque">a pointer where libavcodec will store the iteration state. Must point to NULL to start the iteration.</param>
        [DllImport("avcodec-58", EntryPoint = "av_parser_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCodecParser* av_parser_iterate(void** @opaque);
        
        /// <summary>Iterate over all registered codec parsers.</summary>
        /// <param name="opaque">a pointer where libavcodec will store the iteration state. Must point to NULL to start the iteration.</param>
        [DllImport("avcodec-58", EntryPoint = "av_parser_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCodecParser* av_parser_iterate(ref void* @opaque);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_parser_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_parser_parse2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="pos">input byte position in stream.</param>
        [DllImport("avcodec-58", EntryPoint = "av_parser_parse2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_parser_parse2(AVCodecParserContext* @s, AVCodecContext* @avctx, ref byte* @poutbuf, int* @poutbuf_size, byte* @buf, int @buf_size, long @pts, long @dts, long @pos);
        
        [Obsolete("av_image_copy() instead.")]
        [DllImport("avcodec-58", EntryPoint = "av_picture_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_picture_copy(AVPicture* @dst, AVPicture* @src, AVPixelFormat @pix_fmt, int @width, int @height);
        
        [Obsolete("unused")]
        [DllImport("avcodec-58", EntryPoint = "av_picture_crop", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_picture_crop(AVPicture* @dst, AVPicture* @src, AVPixelFormat @pix_fmt, int @top_band, int @left_band);
        
        [Obsolete("unused")]
        [DllImport("avcodec-58", EntryPoint = "av_picture_pad", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_register_bitstream_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_register_bitstream_filter(AVBitStreamFilter* @bsf);
        
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "av_register_codec_parser", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_register_hwaccel", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_shrink_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "av_xiphlacing", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_align_dimensions", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_align_dimensions2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_alloc_context3", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_chroma_pos_to_enum", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_copy_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_decode_audio4", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_decode_subtitle2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("Use avcodec_send_packet() and avcodec_receive_frame().")]
        [DllImport("avcodec-58", EntryPoint = "avcodec_decode_video2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avcodec_decode_video2(AVCodecContext* @avctx, AVFrame* @picture, int* @got_picture_ptr, AVPacket* @avpkt);
        
        [DllImport("avcodec-58", EntryPoint = "avcodec_default_execute", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_default_execute2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_default_get_buffer2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_default_get_encode_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avcodec_default_get_encode_buffer(AVCodecContext* @s, AVPacket* @pkt, int @flags);
        
        [DllImport("avcodec-58", EntryPoint = "avcodec_default_get_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_descriptor_get", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_descriptor_get_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_descriptor_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_encode_audio2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avcodec_encode_audio2(AVCodecContext* @avctx, AVPacket* @avpkt, AVFrame* @frame, int* @got_packet_ptr);
        
        [DllImport("avcodec-58", EntryPoint = "avcodec_encode_subtitle", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="got_packet_ptr">This field is set to 1 by libavcodec if the output packet is non-empty, and to 0 if it is empty. If the function returns an error, the packet can be assumed to be invalid, and the value of got_packet_ptr is undefined and should not be used.</param>
        [Obsolete("use avcodec_send_frame()/avcodec_receive_packet() instead. If allowed and required, set AVCodecContext.get_encode_buffer to a custom function to pass user supplied output buffers.")]
        [DllImport("avcodec-58", EntryPoint = "avcodec_encode_video2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="xpos">horizontal chroma sample position</param>
        /// <param name="ypos">vertical   chroma sample position</param>
        [DllImport("avcodec-58", EntryPoint = "avcodec_enum_to_chroma_pos", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_fill_audio_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_find_best_pix_fmt_of_2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_find_best_pix_fmt_of_list", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avcodec-58", EntryPoint = "avcodec_find_best_pix_fmt2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_find_decoder", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_find_decoder_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_find_encoder", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_find_encoder_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_flush_buffers", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_free_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avcodec_free_context(AVCodecContext** @avctx);
        
        /// <summary>Free the codec context and everything associated with it and write NULL to the provided pointer.</summary>
        [DllImport("avcodec-58", EntryPoint = "avcodec_free_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avcodec_free_context(ref AVCodecContext* @avctx);
        
        [Obsolete("Use av_pix_fmt_get_chroma_sub_sample")]
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_chroma_sub_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_context_defaults3", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_frame_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_hw_config", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_hw_frames_parameters", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="out_frames_ref">On success, set to a reference to an _uninitialized_ AVHWFramesContext, created from the given device_ref. Fields will be set to values required for decoding. Not changed if an error is returned.</param>
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_hw_frames_parameters", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avcodec_get_hw_frames_parameters(AVCodecContext* @avctx, AVBufferRef* @device_ref, AVPixelFormat @hw_pix_fmt, ref AVBufferRef* @out_frames_ref);
        
        /// <summary>Get the name of a codec.</summary>
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string avcodec_get_name(AVCodecID @id);
        
        [Obsolete("see av_get_pix_fmt_loss()")]
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_pix_fmt_loss", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_subtitle_rect_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVClass* avcodec_get_subtitle_rect_class();
        
        /// <summary>Get the type of the given codec.</summary>
        [DllImport("avcodec-58", EntryPoint = "avcodec_get_type", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_is_open", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avcodec_is_open(AVCodecContext* @s);
        
        /// <summary>Return the libavcodec license.</summary>
        [DllImport("avcodec-58", EntryPoint = "avcodec_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_open2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_parameters_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_parameters_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_parameters_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_parameters_from_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_parameters_to_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_pix_fmt_to_codec_tag", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="profile">the profile value for which a name is requested</param>
        [DllImport("avcodec-58", EntryPoint = "avcodec_profile_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_receive_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_receive_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_register", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avcodec_register(AVCodec* @codec);
        
        [Obsolete("Calling this function is unnecessary.")]
        [DllImport("avcodec-58", EntryPoint = "avcodec_register_all", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_send_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_send_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avcodec_send_packet(AVCodecContext* @avctx, AVPacket* @avpkt);
        
        [DllImport("avcodec-58", EntryPoint = "avcodec_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avcodec_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint avcodec_version();
        
        [Obsolete("unused")]
        [DllImport("avcodec-58", EntryPoint = "avpicture_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avpicture_fill", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avpicture_fill(AVPicture* @picture, byte* @ptr, AVPixelFormat @pix_fmt, int @width, int @height);
        
        [Obsolete("unused")]
        [DllImport("avcodec-58", EntryPoint = "avpicture_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avpicture_free(AVPicture* @picture);
        
        [Obsolete("use av_image_get_buffer_size() instead.")]
        [DllImport("avcodec-58", EntryPoint = "avpicture_get_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avpicture_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avcodec-58", EntryPoint = "avsubtitle_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avsubtitle_free(AVSubtitle* @sub);
        
        /// <summary>Audio input devices iterator.</summary>
        [DllImport("avdevice-58", EntryPoint = "av_input_audio_device_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avdevice-58", EntryPoint = "av_input_video_device_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avdevice-58", EntryPoint = "av_output_audio_device_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avdevice-58", EntryPoint = "av_output_video_device_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avdevice-58", EntryPoint = "avdevice_app_to_dev_control_message", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avdevice-58", EntryPoint = "avdevice_capabilities_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avdevice-58", EntryPoint = "avdevice_capabilities_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avdevice_capabilities_create(ref AVDeviceCapabilitiesQuery* @caps, AVFormatContext* @s, ref AVDictionary* @device_options);
        ...
        /// <param name="s">Context of the device.</param>
        [Obsolete("")]
        [DllImport("avdevice-58", EntryPoint = "avdevice_capabilities_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avdevice-58", EntryPoint = "avdevice_capabilities_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avdevice_capabilities_free(ref AVDeviceCapabilitiesQuery* @caps, AVFormatContext* @s);
        
        /// <summary>Return the libavdevice build-time configuration.</summary>
        [DllImport("avdevice-58", EntryPoint = "avdevice_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        /// <param name="data_size">size of message data.</param>
        [DllImport("avdevice-58", EntryPoint = "avdevice_dev_to_app_control_message", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avdevice-58", EntryPoint = "avdevice_free_list_devices", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avdevice_free_list_devices(AVDeviceInfoList** @device_list);
        
        /// <summary>Convenient function to free result of avdevice_list_devices().</summary>
        [DllImport("avdevice-58", EntryPoint = "avdevice_free_list_devices", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avdevice_free_list_devices(ref AVDeviceInfoList* @device_list);
        
        /// <summary>Return the libavdevice license.</summary>
        [DllImport("avdevice-58", EntryPoint = "avdevice_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avdevice-58", EntryPoint = "avdevice_list_devices", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="device_list">list of autodetected devices.</param>
        [DllImport("avdevice-58", EntryPoint = "avdevice_list_devices", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avdevice_list_devices(AVFormatContext* @s, ref AVDeviceInfoList* @device_list);
        ...
        /// <param name="device_list">list of autodetected devices</param>
        [DllImport("avdevice-58", EntryPoint = "avdevice_list_input_sources", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @device_name, AVDictionary* @device_options, ref AVDeviceInfoList* @device_list);
        ...
        [DllImport("avdevice-58", EntryPoint = "avdevice_list_output_sinks", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @device_name, AVDictionary* @device_options, ref AVDeviceInfoList* @device_list);
        ...
        [DllImport("avdevice-58", EntryPoint = "avdevice_register_all", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avdevice_register_all();
        
        /// <summary>Return the LIBAVDEVICE_VERSION_INT constant.</summary>
        [DllImport("avdevice-58", EntryPoint = "avdevice_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint avdevice_version();
        
        /// <summary>Create an AVABufferSinkParams structure.</summary>
        [Obsolete("")]
        [DllImport("avfilter-7", EntryPoint = "av_abuffersink_params_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVABufferSinkParams* av_abuffersink_params_alloc();
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ulong av_buffersink_get_channel_layout(AVFilterContext* @ctx);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffersink_get_channels(AVFilterContext* @ctx);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_frame_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffersink_get_frame_flags(AVFilterContext* @ctx, AVFrame* @frame, int @flags);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_frame_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVRational av_buffersink_get_frame_rate(AVFilterContext* @ctx);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_h", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffersink_get_h(AVFilterContext* @ctx);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_hw_frames_ctx", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBufferRef* av_buffersink_get_hw_frames_ctx(AVFilterContext* @ctx);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_sample_aspect_ratio", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVRational av_buffersink_get_sample_aspect_ratio(AVFilterContext* @ctx);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_sample_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_samples", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffersink_get_samples(AVFilterContext* @ctx, AVFrame* @frame, int @nb_samples);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_time_base", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_type", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVMediaType av_buffersink_get_type(AVFilterContext* @ctx);
        
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_get_w", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffersink_get_w(AVFilterContext* @ctx);
        
        /// <summary>Create an AVBufferSinkParams structure.</summary>
        [Obsolete("")]
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_params_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersink_set_frame_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersrc_add_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersrc_add_frame_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersrc_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersrc_get_nb_failed_requests", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersrc_parameters_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersrc_parameters_set", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_buffersrc_write_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "av_filter_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_config_links", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_get_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVClass* avfilter_get_class();
        
        /// <summary>Allocate a filter graph.</summary>
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_alloc_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_config", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_create_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @args, void* @opaque, AVFilterGraph* @graph_ctx);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_dump", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @options);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_get_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_parse", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @filters, AVFilterInOut* @inputs, AVFilterInOut* @outputs, void* @log_ctx);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_parse_ptr", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @filters, ref AVFilterInOut* @inputs, ref AVFilterInOut* @outputs, void* @log_ctx);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_parse2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @filters, ref AVFilterInOut* @inputs, ref AVFilterInOut* @outputs);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_queue_command", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @arg, int @flags, double @ts);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_request_oldest", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_send_command", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @arg, byte* @res, int @res_len, int @flags);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_graph_set_auto_convert", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_init_dict", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="options">An AVDictionary filled with options for this filter. On return this parameter will be destroyed and replaced with a dict containing options that were not found. This dictionary must be freed by the caller. May be NULL, then this function is equivalent to avfilter_init_str() with the second parameter set to NULL.</param>
        [DllImport("avfilter-7", EntryPoint = "avfilter_init_dict", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avfilter_init_dict(AVFilterContext* @ctx, ref AVDictionary* @options);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_init_str", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @args);
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_inout_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_inout_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_insert_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_link", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_link_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_link_get_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_link_set_closed", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avfilter_link_set_closed(AVFilterLink* @link, int @closed);
        
        /// <summary>Iterate over all registered filters.</summary>
        [Obsolete("")]
        [DllImport("avfilter-7", EntryPoint = "avfilter_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_pad_count", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_pad_get_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        /// <param name="pads">an array of AVFilterPads</param>
        /// <param name="pad_idx">index of the pad in the array; it is the caller&apos;s responsibility to ensure the index is valid</param>
        [DllImport("avfilter-7", EntryPoint = "avfilter_pad_get_type", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avfilter-7", EntryPoint = "avfilter_process_command", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @arg, byte* @res, int @res_len, int @flags);
        ...
        [Obsolete("")]
        [DllImport("avfilter-7", EntryPoint = "avfilter_register", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avfilter-7", EntryPoint = "avfilter_register_all", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avfilter_register_all();
        
        /// <summary>Return the LIBAVFILTER_VERSION_INT constant.</summary>
        [DllImport("avfilter-7", EntryPoint = "avfilter_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_add_index_entry", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_append_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_apply_bitstream_filters", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_codec_get_id", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="tag">codec tag to match to a codec ID</param>
        [DllImport("avformat-58", EntryPoint = "av_codec_get_id", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCodecID av_codec_get_id(ref AVCodecTag* @tags, uint @tag);
        ...
        [DllImport("avformat-58", EntryPoint = "av_codec_get_tag", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="id">codec ID to match to a codec tag</param>
        [DllImport("avformat-58", EntryPoint = "av_codec_get_tag", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint av_codec_get_tag(ref AVCodecTag* @tags, AVCodecID @id);
        ...
        [DllImport("avformat-58", EntryPoint = "av_codec_get_tag2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="tag">A pointer to the found tag</param>
        [DllImport("avformat-58", EntryPoint = "av_codec_get_tag2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_codec_get_tag2(ref AVCodecTag* @tags, AVCodecID @id, uint* @tag);
        ...
        [DllImport("avformat-58", EntryPoint = "av_demuxer_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVInputFormat* av_demuxer_iterate(void** @opaque);
        
        /// <summary>Iterate over all registered demuxers.</summary>
        /// <param name="opaque">a pointer where libavformat will store the iteration state. Must point to NULL to start the iteration.</param>
        [DllImport("avformat-58", EntryPoint = "av_demuxer_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVInputFormat* av_demuxer_iterate(ref void* @opaque);
        
        [Obsolete("Use an AVDictionary to pass options to a demuxer.")]
        [DllImport("avformat-58", EntryPoint = "av_demuxer_open", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_dump_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url, int @is_output);
        ...
        [DllImport("avformat-58", EntryPoint = "av_filename_number_test", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @filename);
        ...
        [DllImport("avformat-58", EntryPoint = "av_find_best_stream", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">flags; none are currently defined</param>
        [DllImport("avformat-58", EntryPoint = "av_find_best_stream", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_find_best_stream(AVFormatContext* @ic, AVMediaType @type, int @wanted_stream_nb, int @related_stream, ref AVCodec* @decoder_ret, int @flags);
        
        [DllImport("avformat-58", EntryPoint = "av_find_default_stream_index", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_find_input_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @short_name);
        ...
        [DllImport("avformat-58", EntryPoint = "av_find_program_from_stream", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_fmt_ctx_get_duration_estimation_method", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVDurationEstimationMethod av_fmt_ctx_get_duration_estimation_method(AVFormatContext* @ctx);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_audio_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCodec* av_format_get_audio_codec(AVFormatContext* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_control_message_cb", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern av_format_get_control_message_cb_func av_format_get_control_message_cb(AVFormatContext* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_data_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCodec* av_format_get_data_codec(AVFormatContext* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_metadata_header_padding", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_format_get_metadata_header_padding(AVFormatContext* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_opaque", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void* av_format_get_opaque(AVFormatContext* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_open_cb", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_probe_score", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_format_get_probe_score(AVFormatContext* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_subtitle_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVCodec* av_format_get_subtitle_codec(AVFormatContext* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_get_video_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_format_inject_global_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_format_inject_global_side_data(AVFormatContext* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_set_audio_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_format_set_audio_codec(AVFormatContext* @s, AVCodec* @c);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_set_control_message_cb", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_set_data_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_format_set_data_codec(AVFormatContext* @s, AVCodec* @c);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_set_metadata_header_padding", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_format_set_metadata_header_padding(AVFormatContext* @s, int @c);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_set_opaque", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_format_set_opaque(AVFormatContext* @s, void* @opaque);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_set_open_cb", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_format_set_open_cb(AVFormatContext* @s, av_format_set_open_cb_callback_func @callback);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_set_subtitle_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_format_set_subtitle_codec(AVFormatContext* @s, AVCodec* @c);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_format_set_video_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_format_set_video_codec(AVFormatContext* @s, AVCodec* @c);
        
        [DllImport("avformat-58", EntryPoint = "av_get_frame_filename", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @path, int @number);
        ...
        [DllImport("avformat-58", EntryPoint = "av_get_frame_filename2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @path, int @number, int @flags);
        ...
        [DllImport("avformat-58", EntryPoint = "av_get_output_timestamp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_get_packet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_guess_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @mime_type, AVMediaType @type);
        ...
        [DllImport("avformat-58", EntryPoint = "av_guess_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @mime_type);
        ...
        [DllImport("avformat-58", EntryPoint = "av_guess_frame_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_guess_sample_aspect_ratio", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_hex_dump", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="buf">buffer</param>
        /// <param name="size">buffer size</param>
        [DllImport("avformat-58", EntryPoint = "av_hex_dump_log", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_iformat_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_index_search_timestamp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_interleaved_write_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_interleaved_write_uncoded_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_match_ext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @extensions);
        ...
        /// <param name="opaque">a pointer where libavformat will store the iteration state. Must point to NULL to start the iteration.</param>
        [DllImport("avformat-58", EntryPoint = "av_muxer_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVOutputFormat* av_muxer_iterate(void** @opaque);
        
        /// <summary>Iterate over all registered muxers.</summary>
        /// <param name="opaque">a pointer where libavformat will store the iteration state. Must point to NULL to start the iteration.</param>
        [DllImport("avformat-58", EntryPoint = "av_muxer_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVOutputFormat* av_muxer_iterate(ref void* @opaque);
        
        [DllImport("avformat-58", EntryPoint = "av_new_program", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_oformat_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_pkt_dump_log2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="dump_payload">True if the payload must be displayed, too.</param>
        /// <param name="st">AVStream that the packet belongs to</param>
        [DllImport("avformat-58", EntryPoint = "av_pkt_dump2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_probe_input_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url, void* @logctx, uint @offset, uint @max_probe_size);
        ...
        [DllImport("avformat-58", EntryPoint = "av_probe_input_buffer2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url, void* @logctx, uint @offset, uint @max_probe_size);
        ...
        [DllImport("avformat-58", EntryPoint = "av_probe_input_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_probe_input_format2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_probe_input_format3", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVInputFormat* av_probe_input_format3(AVProbeData* @pd, int @is_opened, int* @score_ret);
        
        [DllImport("avformat-58", EntryPoint = "av_program_add_stream_index", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_read_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_read_pause", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_read_play", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_register_all", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_register_all();
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_register_input_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_register_input_format(AVInputFormat* @format);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_register_output_format", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_sdp_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_seek_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="size">side information size</param>
        [DllImport("avformat-58", EntryPoint = "av_stream_add_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_stream_get_codec_timebase", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_stream_get_end_pts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern long av_stream_get_end_pts(AVStream* @st);
        
        [DllImport("avformat-58", EntryPoint = "av_stream_get_parser", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_stream_get_r_frame_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVRational av_stream_get_r_frame_rate(AVStream* @s);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_stream_get_recommended_encoder_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="type">desired side information type</param>
        /// <param name="size">If supplied, *size will be set to the size of the side data or to zero if the desired side data is not present.</param>
        [DllImport("avformat-58", EntryPoint = "av_stream_get_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="type">desired side information type</param>
        /// <param name="size">side information size</param>
        [DllImport("avformat-58", EntryPoint = "av_stream_new_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern byte* av_stream_new_side_data(AVStream* @stream, AVPacketSideDataType @type, int @size);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_stream_set_r_frame_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_stream_set_r_frame_rate(AVStream* @s, AVRational @r);
        
        [Obsolete("")]
        [DllImport("avformat-58", EntryPoint = "av_stream_set_recommended_encoder_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_url_split", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url);
        ...
        [DllImport("avformat-58", EntryPoint = "av_write_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="s">media file handle</param>
        [DllImport("avformat-58", EntryPoint = "av_write_trailer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_write_trailer(AVFormatContext* @s);
        
        /// <summary>Write an uncoded frame to an output media file.</summary>
        [DllImport("avformat-58", EntryPoint = "av_write_uncoded_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "av_write_uncoded_frame_query", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_alloc_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_alloc_output_context2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @filename);
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_close_input", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_find_stream_info", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="options">If non-NULL, an ic.nb_streams long array of pointers to dictionaries, where i-th member contains options for codec corresponding to i-th stream. On return each dictionary will be filled with options that were not found.</param>
        [DllImport("avformat-58", EntryPoint = "avformat_find_stream_info", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avformat_find_stream_info(AVFormatContext* @ic, ref AVDictionary* @options);
        ...
        /// <param name="s">media file handle</param>
        [DllImport("avformat-58", EntryPoint = "avformat_flush", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_free_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_get_mov_audio_tags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_get_mov_video_tags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_get_riff_audio_tags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_get_riff_video_tags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_init_output", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="options">An AVDictionary filled with AVFormatContext and muxer-private options. On return this parameter will be destroyed and replaced with a dict containing options that were not found. May be NULL.</param>
        [DllImport("avformat-58", EntryPoint = "avformat_init_output", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avformat_init_output(AVFormatContext* @s, ref AVDictionary* @options);
        
        /// <summary>Return the libavformat license.</summary>
        [DllImport("avformat-58", EntryPoint = "avformat_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_match_stream_specifier", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @spec);
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_network_deinit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_network_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_new_stream", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_open_input", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url, AVInputFormat* @fmt, ref AVDictionary* @options);
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_query_codec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avformat_query_codec(AVOutputFormat* @ofmt, AVCodecID @codec_id, int @std_compliance);
        
        [DllImport("avformat-58", EntryPoint = "avformat_queue_attached_pictures", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_seek_file", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_transfer_internal_stream_timing_info", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avformat_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="s">Media file handle, must be allocated with avformat_alloc_context(). Its oformat field must be set to the desired output format; Its pb field must be set to an already opened AVIOContext.</param>
        /// <param name="options">An AVDictionary filled with AVFormatContext and muxer-private options. On return this parameter will be destroyed and replaced with a dict containing options that were not found. May be NULL.</param>
        [DllImport("avformat-58", EntryPoint = "avformat_write_header", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="options">An AVDictionary filled with AVFormatContext and muxer-private options. On return this parameter will be destroyed and replaced with a dict containing options that were not found. May be NULL.</param>
        [DllImport("avformat-58", EntryPoint = "avformat_write_header", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avformat_write_header(AVFormatContext* @s, ref AVDictionary* @options);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_accept", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="c">the client context, must be unallocated</param>
        [DllImport("avformat-58", EntryPoint = "avio_accept", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_accept(AVIOContext* @s, ref AVIOContext* @c);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_alloc_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_check", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url, int @flags);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_close_dir", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_close_dir(AVIODirContext** @s);
        
        /// <summary>Close directory.</summary>
        /// <param name="s">directory read context.</param>
        [DllImport("avformat-58", EntryPoint = "avio_close_dir", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_close_dir(ref AVIODirContext* @s);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_close_dyn_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="pbuffer">pointer to a byte buffer</param>
        [DllImport("avformat-58", EntryPoint = "avio_close_dyn_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_close_dyn_buf(AVIOContext* @s, ref byte* @pbuffer);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_closep", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_closep(AVIOContext** @s);
        
        /// <summary>Close the resource accessed by the AVIOContext *s, free it and set the pointer pointing to it to NULL. This function can only be used if s was opened by avio_open().</summary>
        [DllImport("avformat-58", EntryPoint = "avio_closep", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_closep(ref AVIOContext* @s);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_context_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_context_free(AVIOContext** @s);
        
        /// <summary>Free the supplied IO context and everything associated with it.</summary>
        /// <param name="s">Double pointer to the IO context. This function will write NULL into s.</param>
        [DllImport("avformat-58", EntryPoint = "avio_context_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_context_free(ref AVIOContext* @s);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_enum_protocols", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_enum_protocols", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string avio_enum_protocols(ref void* @opaque, int @output);
        
        /// <summary>Similar to feof() but also returns nonzero on read errors.</summary>
        [DllImport("avformat-58", EntryPoint = "avio_feof", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_find_protocol_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    ...
    string @url);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_flush", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_free_directory_entry", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_free_directory_entry(AVIODirEntry** @entry);
        
        /// <summary>Free entry allocated by avio_read_dir().</summary>
        /// <param name="entry">entry to be freed.</param>
        [DllImport("avformat-58", EntryPoint = "avio_free_directory_entry", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_free_directory_entry(ref AVIODirEntry* @entry);
        ...
        /// <param name="s">IO context</param>
        /// <param name="pbuffer">pointer to a byte buffer</param>
        [DllImport("avformat-58", EntryPoint = "avio_get_dyn_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="pbuffer">pointer to a byte buffer</param>
        [DllImport("avformat-58", EntryPoint = "avio_get_dyn_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_get_dyn_buf(AVIOContext* @s, ref byte* @pbuffer);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_get_str", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_get_str(AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen);
        
        [DllImport("avformat-58", EntryPoint = "avio_get_str16be", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_get_str16le", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_handshake", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_open", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url, int @flags);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_open_dir", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url, ref AVDictionary* @options);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_open_dyn_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_open_dyn_buf(AVIOContext** @s);
        
        /// <summary>Open a write only memory stream.</summary>
        /// <param name="s">new IO context</param>
        [DllImport("avformat-58", EntryPoint = "avio_open_dyn_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_open_dyn_buf(ref AVIOContext* @s);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_open2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url, int @flags, AVIOInterruptCB* @int_cb, ref AVDictionary* @options);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_pause", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_print_string_array", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_printf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @fmt);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_protocol_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_put_str", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @str);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_put_str16be", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @str);
        ...
        /// <param name="s">the AVIOContext</param>
        /// <param name="str">NULL-terminated UTF-8 string</param>
        [DllImport("avformat-58", EntryPoint = "avio_put_str16le", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @str);
        ...
        /// <summary>@{</summary>
        [DllImport("avformat-58", EntryPoint = "avio_r8", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_r8(AVIOContext* @s);
        
        [DllImport("avformat-58", EntryPoint = "avio_rb16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint avio_rb16(AVIOContext* @s);
        
        [DllImport("avformat-58", EntryPoint = "avio_rb24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint avio_rb24(AVIOContext* @s);
        
        [DllImport("avformat-58", EntryPoint = "avio_rb32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint avio_rb32(AVIOContext* @s);
        
        [DllImport("avformat-58", EntryPoint = "avio_rb64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ulong avio_rb64(AVIOContext* @s);
        
        /// <summary>Read size bytes from AVIOContext into buf.</summary>
        [DllImport("avformat-58", EntryPoint = "avio_read", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_read_dir", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="next">next entry or NULL when no more entries.</param>
        [DllImport("avformat-58", EntryPoint = "avio_read_dir", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_read_dir(AVIODirContext* @s, ref AVIODirEntry* @next);
        ...
        [DllImport("avformat-58", EntryPoint = "avio_read_partial", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_read_to_bprint", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int avio_read_to_bprint(AVIOContext* @h, AVBPrint* @pb, ulong @max_size);
        
        [DllImport("avformat-58", EntryPoint = "avio_rl16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint avio_rl16(AVIOContext* @s);
        
        [DllImport("avformat-58", EntryPoint = "avio_rl24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint avio_rl24(AVIOContext* @s);
        
        [DllImport("avformat-58", EntryPoint = "avio_rl32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint avio_rl32(AVIOContext* @s);
        
        [DllImport("avformat-58", EntryPoint = "avio_rl64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern ulong avio_rl64(AVIOContext* @s);
        
        /// <summary>fseek() equivalent for AVIOContext.</summary>
        [DllImport("avformat-58", EntryPoint = "avio_seek", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_seek_time", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern long avio_size(AVIOContext* @s);
        
        /// <summary>Skip given number of bytes forward</summary>
        [DllImport("avformat-58", EntryPoint = "avio_skip", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern long avio_skip(AVIOContext* @s, long @offset);
        
        [DllImport("avformat-58", EntryPoint = "avio_w8", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_w8(AVIOContext* @s, int @b);
        
        [DllImport("avformat-58", EntryPoint = "avio_wb16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_wb16(AVIOContext* @s, uint @val);
        
        [DllImport("avformat-58", EntryPoint = "avio_wb24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_wb24(AVIOContext* @s, uint @val);
        
        [DllImport("avformat-58", EntryPoint = "avio_wb32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_wb32(AVIOContext* @s, uint @val);
        
        [DllImport("avformat-58", EntryPoint = "avio_wb64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_wb64(AVIOContext* @s, ulong @val);
        
        [DllImport("avformat-58", EntryPoint = "avio_wl16", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_wl16(AVIOContext* @s, uint @val);
        
        [DllImport("avformat-58", EntryPoint = "avio_wl24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_wl24(AVIOContext* @s, uint @val);
        
        [DllImport("avformat-58", EntryPoint = "avio_wl32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_wl32(AVIOContext* @s, uint @val);
        
        [DllImport("avformat-58", EntryPoint = "avio_wl64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void avio_wl64(AVIOContext* @s, ulong @val);
        
        [DllImport("avformat-58", EntryPoint = "avio_write", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avio_write_marker", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avformat-58", EntryPoint = "avpriv_io_delete", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url);
        ...
        [DllImport("avformat-58", EntryPoint = "avpriv_io_move", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url_dst);
        ...
        [DllImport("avutil-56", EntryPoint = "av_add_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_add_stable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_drain", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_peek", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="nb_samples">number of samples to peek</param>
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_peek", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_audio_fifo_peek(AVAudioFifo* @af, ref void* @data, int @nb_samples);
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_peek_at", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="offset">offset from current read position</param>
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_peek_at", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_audio_fifo_peek_at(AVAudioFifo* @af, ref void* @data, int @nb_samples, int @offset);
        
        /// <summary>Read data from an AVAudioFifo.</summary>
        /// <param name="af">AVAudioFifo to read from</param>
        /// <param name="data">audio data plane pointers</param>
        /// <param name="nb_samples">number of samples to read</param>
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_read", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="nb_samples">number of samples to read</param>
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_read", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_audio_fifo_read(AVAudioFifo* @af, ref void* @data, int @nb_samples);
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_realloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_reset", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="af">the AVAudioFifo to query</param>
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_space", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_audio_fifo_write", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_bprint_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_bprint_channel_layout(AVBPrint* @bp, int @nb_channels, ulong @channel_layout);
        
        [DllImport("avutil-56", EntryPoint = "av_buffer_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBufferRef* av_buffer_alloc(int @size);
        
        [DllImport("avutil-56", EntryPoint = "av_buffer_allocz", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBufferRef* av_buffer_allocz(int @size);
        
        [DllImport("avutil-56", EntryPoint = "av_buffer_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_default_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_get_opaque", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void* av_buffer_get_opaque(AVBufferRef* @buf);
        
        [DllImport("avutil-56", EntryPoint = "av_buffer_get_ref_count", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_is_writable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_make_writable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffer_make_writable(AVBufferRef** @buf);
        
        /// <summary>Create a writable reference from a given buffer reference, avoiding data copy if possible.</summary>
        /// <param name="buf">buffer reference to make writable. On success, buf is either left untouched, or it is unreferenced and a new writable AVBufferRef is written in its place. On failure, buf is left untouched.</param>
        [DllImport("avutil-56", EntryPoint = "av_buffer_make_writable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffer_make_writable(ref AVBufferRef* @buf);
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_pool_buffer_get_opaque", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_pool_get", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBufferRef* av_buffer_pool_get(AVBufferPool* @pool);
        
        [DllImport("avutil-56", EntryPoint = "av_buffer_pool_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBufferPool* av_buffer_pool_init(int @size, av_buffer_pool_init_alloc_func @alloc);
        
        [DllImport("avutil-56", EntryPoint = "av_buffer_pool_init2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_pool_uninit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_buffer_pool_uninit(AVBufferPool** @pool);
        
        /// <summary>Mark the pool as being available for freeing. It will actually be freed only once all the allocated buffers associated with the pool are released. Thus it is safe to call this function while some of the allocated buffers are still in use.</summary>
        /// <param name="pool">pointer to the pool to be freed. It will be set to NULL.</param>
        [DllImport("avutil-56", EntryPoint = "av_buffer_pool_uninit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_buffer_pool_uninit(ref AVBufferPool* @pool);
        
        [DllImport("avutil-56", EntryPoint = "av_buffer_realloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffer_realloc(AVBufferRef** @buf, int @size);
        
        [DllImport("avutil-56", EntryPoint = "av_buffer_realloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffer_realloc(ref AVBufferRef* @buf, int @size);
        
        /// <summary>Create a new reference to an AVBuffer.</summary>
        [DllImport("avutil-56", EntryPoint = "av_buffer_ref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_replace", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="src">A buffer reference to replace dst with. May be NULL, then this function is equivalent to av_buffer_unref(dst).</param>
        [DllImport("avutil-56", EntryPoint = "av_buffer_replace", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_buffer_replace(ref AVBufferRef* @dst, AVBufferRef* @src);
        ...
        [DllImport("avutil-56", EntryPoint = "av_buffer_unref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_buffer_unref(AVBufferRef** @buf);
        
        /// <summary>Free a given reference and automatically free the buffer if there are no more references to it.</summary>
        /// <param name="buf">the reference to be freed. The pointer is set to NULL on return.</param>
        [DllImport("avutil-56", EntryPoint = "av_buffer_unref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_buffer_unref(ref AVBufferRef* @buf);
        
        /// <summary>Non-inlined equivalent of av_mallocz_array().</summary>
        [DllImport("avutil-56", EntryPoint = "av_calloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_channel_layout_extract_channel", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_chroma_location_from_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_chroma_location_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_color_primaries_from_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_color_primaries_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_color_range_from_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_color_range_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_color_space_from_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_color_space_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_color_transfer_from_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_color_transfer_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_compare_mod", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_compare_ts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_content_light_metadata_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_content_light_metadata_create_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_cpu_count", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_cpu_count();
        
        /// <summary>Get the maximum data alignment that may be required by FFmpeg.</summary>
        [DllImport("avutil-56", EntryPoint = "av_cpu_max_align", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_d2q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVRational av_d2q(double @d, int @max);
        
        [DllImport("avutil-56", EntryPoint = "av_default_get_category", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_default_item_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_dict_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">flags to use when setting entries in *dst</param>
        [DllImport("avutil-56", EntryPoint = "av_dict_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_dict_copy(ref AVDictionary* @dst, AVDictionary* @src, int @flags);
        
        /// <summary>Get number of entries in dictionary.</summary>
        /// <param name="m">dictionary</param>
        [DllImport("avutil-56", EntryPoint = "av_dict_count", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_dict_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_dict_free(AVDictionary** @m);
        
        /// <summary>Free all the memory allocated for an AVDictionary struct and all keys and values.</summary>
        [DllImport("avutil-56", EntryPoint = "av_dict_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_dict_free(ref AVDictionary* @m);
        ...
        [DllImport("avutil-56", EntryPoint = "av_dict_get", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @key, AVDictionaryEntry* @prev, int @flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_dict_get_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="pairs_sep">character used to separate two pairs from each other</param>
        [DllImport("avutil-56", EntryPoint = "av_dict_get_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_dict_get_string(AVDictionary* @m, ref byte* @buffer, byte @key_val_sep, byte @pairs_sep);
        ...
        [DllImport("avutil-56", EntryPoint = "av_dict_parse_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @pairs_sep, int @flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_dict_set", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @value, int @flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_dict_set_int", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @key, long @value, int @flags);
        ...
        /// <param name="b">First rational</param>
        /// <param name="c">Second rational</param>
        [DllImport("avutil-56", EntryPoint = "av_div_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_dynamic_hdr_plus_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="frame">The frame which side data is added to.</param>
        [DllImport("avutil-56", EntryPoint = "av_dynamic_hdr_plus_create_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_dynarray_add", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_dynarray_add_nofree", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_dynarray2_add", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="elem_data">Pointer to the data of the element to add. If `NULL`, the space of the newly added element is allocated but left uninitialized.</param>
        [DllImport("avutil-56", EntryPoint = "av_dynarray2_add", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void* av_dynarray2_add(ref void* @tab_ptr, int* @nb_ptr, ulong @elem_size, byte* @elem_data);
        ...
        [DllImport("avutil-56", EntryPoint = "av_fast_malloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="size">Pointer to the size of buffer `*ptr`. `*size` is updated to the new allocated size, in particular 0 in case of failure.</param>
        /// <param name="min_size">Desired minimal size of buffer `*ptr`</param>
        [DllImport("avutil-56", EntryPoint = "av_fast_mallocz", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="size">Pointer to the size of buffer `ptr`. `*size` is updated to the new allocated size, in particular 0 in case of failure.</param>
        /// <param name="min_size">Desired minimal size of buffer `ptr`</param>
        [DllImport("avutil-56", EntryPoint = "av_fast_realloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_alloc_array", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_drain", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_fifo_free(AVFifoBuffer* @f);
        
        /// <summary>Free an AVFifoBuffer and reset pointer to NULL.</summary>
        /// <param name="f">AVFifoBuffer to free</param>
        [DllImport("avutil-56", EntryPoint = "av_fifo_freep", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_generic_peek", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="buf_size">number of bytes to read</param>
        /// <param name="func">generic read function</param>
        [DllImport("avutil-56", EntryPoint = "av_fifo_generic_peek_at", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="buf_size">number of bytes to read</param>
        /// <param name="func">generic read function</param>
        [DllImport("avutil-56", EntryPoint = "av_fifo_generic_read", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_generic_write", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_grow", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_realloc2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_reset", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="f">AVFifoBuffer to read from</param>
        [DllImport("avutil-56", EntryPoint = "av_fifo_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fifo_space", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="log_ctx">context used for logging</param>
        [DllImport("avutil-56", EntryPoint = "av_file_map", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @filename, ref byte* @bufptr, ulong* @size, int @log_offset, void* @log_ctx);
        ...
        [DllImport("avutil-56", EntryPoint = "av_file_unmap", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="src_pix_fmt">source pixel format</param>
        /// <param name="has_alpha">Whether the source pixel format alpha channel is used.</param>
        [DllImport("avutil-56", EntryPoint = "av_find_best_pix_fmt_of_2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_find_nearest_q_idx", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fopen_utf8", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @mode);
        ...
        [DllImport("avutil-56", EntryPoint = "av_force_cpu_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_fourcc_make_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_apply_cropping", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_clone", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVFrame* av_frame_clone(AVFrame* @src);
        
        /// <summary>Copy the frame data from src to dst.</summary>
        [DllImport("avutil-56", EntryPoint = "av_frame_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_frame_copy(AVFrame* @dst, AVFrame* @src);
        
        /// <summary>Copy only &quot;metadata&quot; fields from src to dst.</summary>
        [DllImport("avutil-56", EntryPoint = "av_frame_copy_props", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_best_effort_timestamp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_get_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_frame_get_buffer(AVFrame* @frame, int @align);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern long av_frame_get_channel_layout(AVFrame* @frame);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_frame_get_channels(AVFrame* @frame);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_color_range", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVColorRange av_frame_get_color_range(AVFrame* @frame);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_colorspace", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVColorSpace av_frame_get_colorspace(AVFrame* @frame);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_decode_error_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_frame_get_decode_error_flags(AVFrame* @frame);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_metadata", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVDictionary* av_frame_get_metadata(AVFrame* @frame);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_pkt_duration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern long av_frame_get_pkt_duration(AVFrame* @frame);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_pkt_pos", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern long av_frame_get_pkt_pos(AVFrame* @frame);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_pkt_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_get_plane_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVBufferRef* av_frame_get_plane_buffer(AVFrame* @frame, int @plane);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_qp_table", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern sbyte* av_frame_get_qp_table(AVFrame* @f, int* @stride, int* @type);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_get_sample_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_get_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_is_writable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_make_writable", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_move_ref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_new_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_new_side_data_from_buf", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_ref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_remove_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_remove_side_data(AVFrame* @frame, AVFrameSideDataType @type);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_best_effort_timestamp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_best_effort_timestamp(AVFrame* @frame, long @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_channel_layout(AVFrame* @frame, long @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_channels(AVFrame* @frame, int @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_color_range", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_color_range(AVFrame* @frame, AVColorRange @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_colorspace", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_colorspace(AVFrame* @frame, AVColorSpace @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_decode_error_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_decode_error_flags(AVFrame* @frame, int @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_metadata", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_metadata(AVFrame* @frame, AVDictionary* @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_pkt_duration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_pkt_duration(AVFrame* @frame, long @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_pkt_pos", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_pkt_pos(AVFrame* @frame, long @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_pkt_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_frame_set_pkt_size(AVFrame* @frame, int @val);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_qp_table", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_frame_set_qp_table(AVFrame* @f, AVBufferRef* @buf, int @stride, int @type);
        
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_frame_set_sample_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_side_data_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_frame_unref", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_freep", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_freep(void* @ptr);
        
        /// <summary>Compute the greatest common divisor of two integer operands.</summary>
        [DllImport("avutil-56", EntryPoint = "av_gcd", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_gcd_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_alt_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_bits_per_pixel", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_bytes_per_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_channel_description", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_channel_layout_channel_index", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_channel_layout_nb_channels", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_channel_layout_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_channel_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string av_get_channel_name(ulong @channel);
        
        /// <summary>Get the name of a colorspace.</summary>
        [DllImport("avutil-56", EntryPoint = "av_get_colorspace_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_cpu_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_get_cpu_flags();
        
        /// <summary>Return default channel layout for a given number of channels.</summary>
        [DllImport("avutil-56", EntryPoint = "av_get_default_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_extended_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, ulong* @channel_layout, int* @nb_channels);
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_media_type_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_packed_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_padded_bits_per_pixel", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_picture_type_char", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_pix_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        /// <param name="src_pix_fmt">source pixel format</param>
        /// <param name="has_alpha">Whether the source pixel format alpha channel is used.</param>
        [DllImport("avutil-56", EntryPoint = "av_get_pix_fmt_loss", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_pix_fmt_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_pix_fmt_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_planar_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_sample_fmt_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_sample_fmt_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_standard_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_get_time_base_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVRational av_get_time_base_q();
        
        /// <summary>Get the current time in microseconds.</summary>
        [DllImport("avutil-56", EntryPoint = "av_gettime", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_gettime_relative", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_gettime_relative_is_monotonic", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_ctx_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_ctx_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @device, AVDictionary* @opts, int @flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_ctx_create_derived", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">Currently unused; should be set to zero.</param>
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_ctx_create_derived", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_hwdevice_ctx_create_derived(ref AVBufferRef* @dst_ctx, AVHWDeviceType @type, AVBufferRef* @src_ctx, int @flags);
        ...
        /// <param name="flags">Currently unused; should be set to zero.</param>
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_ctx_create_derived_opts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">Currently unused; should be set to zero.</param>
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_ctx_create_derived_opts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_hwdevice_ctx_create_derived_opts(ref AVBufferRef* @dst_ctx, AVHWDeviceType @type, AVBufferRef* @src_ctx, AVDictionary* @options, int @flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_ctx_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_find_type_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_get_hwframe_constraints", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_get_type_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_hwconfig_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwdevice_iterate_types", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwframe_constraints_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_hwframe_constraints_free(AVHWFramesConstraints** @constraints);
        
        /// <summary>Free an AVHWFrameConstraints structure.</summary>
        /// <param name="constraints">The (filled or unfilled) AVHWFrameConstraints structure.</param>
        [DllImport("avutil-56", EntryPoint = "av_hwframe_constraints_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_hwframe_constraints_free(ref AVHWFramesConstraints* @constraints);
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwframe_ctx_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwframe_ctx_create_derived", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">Some combination of AV_HWFRAME_MAP_* flags, defining the mapping parameters to apply to frames which are allocated in the derived device.</param>
        [DllImport("avutil-56", EntryPoint = "av_hwframe_ctx_create_derived", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_hwframe_ctx_create_derived(ref AVBufferRef* @derived_frame_ctx, AVPixelFormat @format, AVBufferRef* @derived_device_ctx, AVBufferRef* @source_frame_ctx, int @flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwframe_ctx_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">currently unused, should be set to zero</param>
        [DllImport("avutil-56", EntryPoint = "av_hwframe_get_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_hwframe_map", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">currently unused, should be set to zero</param>
        [DllImport("avutil-56", EntryPoint = "av_hwframe_transfer_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">currently unused, should be set to zero</param>
        [DllImport("avutil-56", EntryPoint = "av_hwframe_transfer_get_formats", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="flags">currently unused, should be set to zero</param>
        [DllImport("avutil-56", EntryPoint = "av_hwframe_transfer_get_formats", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_hwframe_transfer_get_formats(AVBufferRef* @hwframe_ctx, AVHWFrameTransferDirection @dir, ref AVPixelFormat* @formats, int @flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_check_sar", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_check_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="log_offset">the offset to sum to the log level for logging with log_ctx</param>
        /// <param name="log_ctx">the parent logging context, it may be NULL</param>
        [DllImport("avutil-56", EntryPoint = "av_image_check_size2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_copy_plane", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_copy_to_buffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_copy_uc_from", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <summary>Copy image data located in uncacheable (e.g. GPU mapped) memory. Where available, this function will use special functionality for reading from such memory, which may result in greatly improved performance compared to plain av_image_copy().</summary>
        [DllImport("avutil-56", EntryPoint = "av_image_copy_uc_from", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_image_copy_uc_from(byte** @dst_data, long* @dst_linesizes, byte** @src_data, long* @src_linesizes, AVPixelFormat @pix_fmt, int @width, int @height);
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_fill_arrays", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="width">the width of the image in pixels</param>
        /// <param name="height">the height of the image in pixels</param>
        [DllImport("avutil-56", EntryPoint = "av_image_fill_black", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="height">the height of the image in pixels</param>
        [DllImport("avutil-56", EntryPoint = "av_image_fill_black", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_image_fill_black(byte** @dst_data, long* @dst_linesize, AVPixelFormat @pix_fmt, AVColorRange @range, int @width, int @height);
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_fill_linesizes", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_fill_max_pixsteps", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_image_fill_max_pixsteps(int_array4 @max_pixsteps, ref int_array4 @max_pixstep_comps, AVPixFmtDescriptor* @pixdesc);
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_fill_plane_sizes", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_image_fill_plane_sizes(ulong_array4 @size, AVPixelFormat @pix_fmt, int @height, long_array4 @linesizes);
        
        /// <summary>Fill plane sizes for an image with pixel format pix_fmt and height height.</summary>
        /// <param name="size">the array to be filled with the size of each image plane</param>
        /// <param name="linesizes">the array containing the linesize for each plane, should be filled by av_image_fill_linesizes()</param>
        [DllImport("avutil-56", EntryPoint = "av_image_fill_plane_sizes", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_image_fill_plane_sizes(ulong* @size, AVPixelFormat @pix_fmt, int @height, long* @linesizes);
        ...
        /// <param name="linesizes">the array containing the linesize for each plane, should be filled by av_image_fill_linesizes()</param>
        [DllImport("avutil-56", EntryPoint = "av_image_fill_pointers", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_image_fill_pointers(byte_ptrArray4 @data, AVPixelFormat @pix_fmt, int @height, byte* @ptr, int_array4 @linesizes);
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_get_buffer_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_image_get_linesize", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_int_list_length_for_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_log", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @fmt);
        ...
        [DllImport("avutil-56", EntryPoint = "av_log_default_callback", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @fmt, byte* @vl);
        ...
        [DllImport("avutil-56", EntryPoint = "av_log_format_line", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @fmt, byte* @vl, byte* @line, int @line_size, int* @print_prefix);
        ...
        /// <param name="print_prefix">used to store whether the prefix must be printed; must point to a persistent integer initially set to 1</param>
        [DllImport("avutil-56", EntryPoint = "av_log_format_line2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @fmt, byte* @vl, byte* @line, int @line_size, int* @print_prefix);
        ...
        [DllImport("avutil-56", EntryPoint = "av_log_get_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_log_get_flags();
        
        /// <summary>Get the current log level</summary>
        [DllImport("avutil-56", EntryPoint = "av_log_get_level", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="fmt">The format string (printf-compatible) that specifies how subsequent arguments are converted to output.</param>
        [DllImport("avutil-56", EntryPoint = "av_log_once", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @fmt);
        ...
        [DllImport("avutil-56", EntryPoint = "av_log_set_callback", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_log_set_callback(av_log_set_callback_callback_func @callback);
        
        [DllImport("avutil-56", EntryPoint = "av_log_set_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_log_set_flags(int @arg);
        
        /// <summary>Set the log level</summary>
        /// <param name="level">Logging level</param>
        [DllImport("avutil-56", EntryPoint = "av_log_set_level", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_log_set_level(int @level);
        
        [DllImport("avutil-56", EntryPoint = "av_log2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_log2(uint @v);
        
        [DllImport("avutil-56", EntryPoint = "av_log2_16bit", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_malloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_malloc_array", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="size">Size in bytes for the memory block to be allocated</param>
        [DllImport("avutil-56", EntryPoint = "av_mallocz", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void* av_mallocz(ulong @size);
        
        /// <summary>Allocate a memory block for an array with av_mallocz().</summary>
        /// <param name="nmemb">Number of elements</param>
        /// <param name="size">Size of the single element</param>
        [DllImport("avutil-56", EntryPoint = "av_mallocz_array", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_mastering_display_metadata_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="frame">The frame which side data is added to.</param>
        [DllImport("avutil-56", EntryPoint = "av_mastering_display_metadata_create_side_data", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_max_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_memcpy_backptr", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_memdup", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void* av_memdup(void* @p, ulong @size);
        
        /// <summary>Multiply two rationals.</summary>
        /// <param name="b">First rational</param>
        /// <param name="c">Second rational</param>
        [DllImport("avutil-56", EntryPoint = "av_mul_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_nearer_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_child_class_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVClass* av_opt_child_class_iterate(AVClass* @parent, void** @iter);
        
        /// <summary>Iterate over potential AVOptions-enabled children of parent.</summary>
        /// <param name="iter">a pointer where iteration state is stored.</param>
        [DllImport("avutil-56", EntryPoint = "av_opt_child_class_iterate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVClass* av_opt_child_class_iterate(AVClass* @parent, ref void* @iter);
        
        /// <summary>Iterate over potential AVOptions-enabled children of parent.</summary>
        /// <param name="prev">result of a previous call to this function or NULL</param>
        [Obsolete("use av_opt_child_class_iterate")]
        [DllImport("avutil-56", EntryPoint = "av_opt_child_class_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="prev">result of a previous call to this function or NULL</param>
        [DllImport("avutil-56", EntryPoint = "av_opt_child_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_opt_copy(void* @dest, void* @src);
        
        [DllImport("avutil-56", EntryPoint = "av_opt_eval_double", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @val, double* @double_out);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_eval_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @val, int* @flags_out);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_eval_float", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @val, float* @float_out);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_eval_int", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @val, int* @int_out);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_eval_int64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @val, long* @int64_out);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_eval_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @val, AVRational* @q_out);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_find", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @unit, int @opt_flags, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_find2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @unit, int @opt_flags, int @search_flags, ref void* @target_obj);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_flag_is_set", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @flag_name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_opt_free(void* @obj);
        
        /// <summary>Free an AVOptionRanges struct and set it to NULL.</summary>
        [DllImport("avutil-56", EntryPoint = "av_opt_freep_ranges", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_opt_freep_ranges(AVOptionRanges** @ranges);
        
        /// <summary>Free an AVOptionRanges struct and set it to NULL.</summary>
        [DllImport("avutil-56", EntryPoint = "av_opt_freep_ranges", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_opt_freep_ranges(ref AVOptionRanges* @ranges);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, ref byte* @out_val);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, long* @ch_layout);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_dict_val", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, ref AVDictionary* @out_val);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_double", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, double* @out_val);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_image_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, int* @w_out, int* @h_out);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_int", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, long* @out_val);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_key_value", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @pairs_sep, uint @flags, ref byte* @rkey, ref byte* @rval);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_pixel_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, AVPixelFormat* @out_fmt);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, AVRational* @out_val);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, AVSampleFormat* @out_fmt);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_get_video_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags, AVRational* @out_val);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_is_set_to_default", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_is_set_to_default_by_name", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVOption* av_opt_next(void* @obj, AVOption* @prev);
        
        /// <summary>@}</summary>
        [DllImport("avutil-56", EntryPoint = "av_opt_ptr", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_query_ranges", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @key, int @flags);
        ...
        /// <param name="flags">is a bitmask of flags, undefined flags should not be set and should be ignored AV_OPT_SEARCH_FAKE_OBJ indicates that the obj is a double pointer to a AVClass instead of a full instance AV_OPT_MULTI_COMPONENT_RANGE indicates that function may return more than one component,</param>
        [DllImport("avutil-56", EntryPoint = "av_opt_query_ranges_default", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @key, int @flags);
        ...
        /// <param name="key_val_sep">character used to separate key from value</param>
        /// <param name="pairs_sep">character used to separate two pairs from each other</param>
        [DllImport("avutil-56", EntryPoint = "av_opt_serialize", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="pairs_sep">character used to separate two pairs from each other</param>
        [DllImport("avutil-56", EntryPoint = "av_opt_serialize", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_opt_serialize(void* @obj, int @opt_flags, int @flags, ref byte* @buffer, byte @key_val_sep, byte @pairs_sep);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @val, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_bin", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, byte* @val, int @size, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_channel_layout", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, long @ch_layout, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_defaults", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_defaults2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_dict", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_dict_val", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, AVDictionary* @val, int @search_flags);
        ...
        /// <param name="options">options to process. This dictionary will be freed and replaced by a new one containing all options not found in obj. Of course this new dictionary needs to be freed by caller with av_dict_free().</param>
        /// <param name="search_flags">A combination of AV_OPT_SEARCH_*.</param>
        [DllImport("avutil-56", EntryPoint = "av_opt_set_dict2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_double", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, double @val, int @search_flags);
        ...
        /// <param name="key_val_sep">a 0-terminated list of characters used to separate key from value, for example &apos;=&apos;</param>
        /// <param name="pairs_sep">a 0-terminated list of characters used to separate two pairs from each other, for example &apos;:&apos; or &apos;,&apos;</param>
        [DllImport("avutil-56", EntryPoint = "av_opt_set_from_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @pairs_sep);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_image_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, int @w, int @h, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_int", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, long @val, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_pixel_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, AVPixelFormat @fmt, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, AVRational @val, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_sample_fmt", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, AVSampleFormat @fmt, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_set_video_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name, AVRational @val, int @search_flags);
        ...
        [DllImport("avutil-56", EntryPoint = "av_opt_show2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_parse_cpu_caps", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @s);
        ...
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_parse_cpu_flags", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @s);
        ...
        [DllImport("avutil-56", EntryPoint = "av_pix_fmt_count_planes", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_pix_fmt_desc_get", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_pix_fmt_desc_get_id", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="prev">previous descriptor. NULL to get the first descriptor.</param>
        [DllImport("avutil-56", EntryPoint = "av_pix_fmt_desc_next", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_pix_fmt_get_chroma_sub_sample", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="pix_fmt">the pixel format</param>
        [DllImport("avutil-56", EntryPoint = "av_pix_fmt_swap_endianness", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_q2intfloat", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint av_q2intfloat(AVRational @q);
        
        [DllImport("avutil-56", EntryPoint = "av_read_image_line", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_read_image_line2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="dst_element_size">size of elements in dst array (2 or 4 byte)</param>
        [DllImport("avutil-56", EntryPoint = "av_read_image_line2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_read_image_line2(void* @dst, byte** @data, int* @linesize, AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component, int @dst_element_size);
        ...
        [DllImport("avutil-56", EntryPoint = "av_realloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_realloc_array", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void* av_realloc_array(void* @ptr, ulong @nmemb, ulong @size);
        
        /// <summary>Allocate, reallocate, or free a block of memory.</summary>
        [DllImport("avutil-56", EntryPoint = "av_realloc_f", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_reallocp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="nmemb">Number of elements</param>
        /// <param name="size">Size of the single element</param>
        [DllImport("avutil-56", EntryPoint = "av_reallocp_array", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_reduce", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_rescale", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_rescale_delta", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_rescale_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_rescale_q_rnd", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_rescale_rnd", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_sample_fmt_is_planar", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_samples_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="align">buffer size alignment (0 = default, 1 = no alignment)</param>
        [DllImport("avutil-56", EntryPoint = "av_samples_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_samples_alloc(ref byte* @audio_data, int* @linesize, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align);
        ...
        [DllImport("avutil-56", EntryPoint = "av_samples_alloc_array_and_samples", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <summary>Allocate a data pointers array, samples buffer for nb_samples samples, and fill data pointers and linesize accordingly.</summary>
        [DllImport("avutil-56", EntryPoint = "av_samples_alloc_array_and_samples", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_samples_alloc_array_and_samples(ref byte** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align);
        ...
        [DllImport("avutil-56", EntryPoint = "av_samples_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="sample_fmt">audio sample format</param>
        [DllImport("avutil-56", EntryPoint = "av_samples_copy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_samples_copy(ref byte* @dst, ref byte* @src, int @dst_offset, int @src_offset, int @nb_samples, int @nb_channels, AVSampleFormat @sample_fmt);
        ...
        /// <param name="sample_fmt">the sample format</param>
        /// <param name="align">buffer size alignment (0 = default, 1 = no alignment)</param>
        [DllImport("avutil-56", EntryPoint = "av_samples_fill_arrays", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="align">buffer size alignment (0 = default, 1 = no alignment)</param>
        [DllImport("avutil-56", EntryPoint = "av_samples_fill_arrays", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_samples_fill_arrays(ref byte* @audio_data, int* @linesize, byte* @buf, int @nb_channels, int @nb_samples, AVSampleFormat @sample_fmt, int @align);
        ...
        /// <param name="sample_fmt">the sample format</param>
        /// <param name="align">buffer size alignment (0 = default, 1 = no alignment)</param>
        [DllImport("avutil-56", EntryPoint = "av_samples_get_buffer_size", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="nb_channels">number of audio channels</param>
        /// <param name="sample_fmt">audio sample format</param>
        [DllImport("avutil-56", EntryPoint = "av_samples_set_silence", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="sample_fmt">audio sample format</param>
        [DllImport("avutil-56", EntryPoint = "av_samples_set_silence", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_samples_set_silence(ref byte* @audio_data, int @offset, int @nb_samples, int @nb_channels, AVSampleFormat @sample_fmt);
        ...
        [Obsolete("")]
        [DllImport("avutil-56", EntryPoint = "av_set_cpu_flags_mask", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="key_val_sep">a 0-terminated list of characters used to separate key from value</param>
        /// <param name="pairs_sep">a 0-terminated list of characters used to separate two pairs from each other</param>
        [DllImport("avutil-56", EntryPoint = "av_set_options_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @pairs_sep);
        ...
        [DllImport("avutil-56", EntryPoint = "av_strdup", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @s);
        ...
        [DllImport("avutil-56", EntryPoint = "av_strerror", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_strndup", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @s, ulong @len);
        ...
        /// <param name="b">First rational</param>
        /// <param name="c">Second rational</param>
        [DllImport("avutil-56", EntryPoint = "av_sub_q", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_tempfile", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @prefix, ref byte* @filename, int @log_offset, void* @log_ctx);
        ...
        [DllImport("avutil-56", EntryPoint = "av_timecode_adjust_ntsc_framenum2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_timecode_check_frame_rate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_timecode_get_smpte", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_timecode_get_smpte_from_framenum", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_timecode_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="log_ctx">a pointer to an arbitrary struct of which the first field is a pointer to an AVClass struct (used for av_log)</param>
        [DllImport("avutil-56", EntryPoint = "av_timecode_init_from_components", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="log_ctx">a pointer to an arbitrary struct of which the first field is a pointer to an AVClass struct (used for av_log).</param>
        [DllImport("avutil-56", EntryPoint = "av_timecode_init_from_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @str, void* @log_ctx);
        ...
        [DllImport("avutil-56", EntryPoint = "av_timecode_make_mpeg_tc_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_timecode_make_smpte_tc_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_timecode_make_smpte_tc_string2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="buf">destination buffer, must be at least AV_TIMECODE_STR_SIZE long</param>
        /// <param name="framenum">frame number</param>
        [DllImport("avutil-56", EntryPoint = "av_timecode_make_string", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern byte* av_timecode_make_string(AVTimecode* @tc, byte* @buf, int @framenum);
        
        [DllImport("avutil-56", EntryPoint = "av_tree_destroy", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_tree_enumerate", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_tree_find", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void* av_tree_find(AVTreeNode* @root, void* @key, av_tree_find_cmp_func @cmp, void_ptrArray2 @next);
        ...
        [DllImport("avutil-56", EntryPoint = "av_tree_insert", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="next">Used to allocate and free AVTreeNodes. For insertion the user must set it to an allocated and zeroed object of at least av_tree_node_size bytes size. av_tree_insert() will set it to NULL if it has been consumed. For deleting elements *next is set to NULL by the user and av_tree_insert() will set it to the AVTreeNode which was used for the removed element. This allows the use of flat arrays, which have lower overhead compared to many malloced elements. You might want to define a function like:</param>
        [DllImport("avutil-56", EntryPoint = "av_tree_insert", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void* av_tree_insert(ref AVTreeNode* @rootp, void* @key, av_tree_insert_cmp_func @cmp, ref AVTreeNode* @next);
        
        /// <summary>Allocate an AVTreeNode.</summary>
        [DllImport("avutil-56", EntryPoint = "av_tree_node_alloc", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_usleep", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_version_info", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        ...
        /// <param name="fmt">The format string (printf-compatible) that specifies how subsequent arguments are converted to output.</param>
        /// <param name="vl">The arguments referenced by the format string.</param>
        [DllImport("avutil-56", EntryPoint = "av_vlog", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @fmt, byte* @vl);
        ...
        [DllImport("avutil-56", EntryPoint = "av_write_image_line", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("avutil-56", EntryPoint = "av_write_image_line2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="src_element_size">size of elements in src array (2 or 4 byte)</param>
        [DllImport("avutil-56", EntryPoint = "av_write_image_line2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void av_write_image_line2(void* @src, byte** @data, int* @linesize, AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @src_element_size);
        
        /// <summary>Return the libavutil build-time configuration.</summary>
        [DllImport("avutil-56", EntryPoint = "avutil_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string avutil_configuration();
        
        /// <summary>Return the libavutil license.</summary>
        [DllImport("avutil-56", EntryPoint = "avutil_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    ...
    string @name, int @quality);
        ...
        [DllImport("swresample-3", EntryPoint = "swr_alloc_set_opts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="log_ctx">parent logging context, can be NULL</param>
        [DllImport("swresample-3", EntryPoint = "swr_build_matrix", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_close", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_config_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_convert", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="in_count">number of input samples available in one channel</param>
        [DllImport("swresample-3", EntryPoint = "swr_convert", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int swr_convert(SwrContext* @s, ref byte* @out, int @out_count, ref byte* @in, int @in_count);
        ...
        [DllImport("swresample-3", EntryPoint = "swr_convert_frame", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_drop_output", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_free", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_get_delay", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_get_out_samples", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_init", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int swr_init(SwrContext* @s);
        
        /// <summary>Injects the specified number of silence samples.</summary>
        /// <param name="s">allocated Swr context</param>
        /// <param name="count">number of samples to be dropped</param>
        [DllImport("swresample-3", EntryPoint = "swr_inject_silence", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_is_initialized", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_next_pts", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_set_channel_mapping", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_set_compensation", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swr_set_matrix", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swresample-3", EntryPoint = "swresample_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string swresample_configuration();
        
        /// <summary>Return the swr license.</summary>
        [DllImport("swresample-3", EntryPoint = "swresample_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string swresample_license();
        
        /// <summary>Return the LIBSWRESAMPLE_VERSION_INT constant.</summary>
        [DllImport("swresample-3", EntryPoint = "swresample_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern uint swresample_version();
        
        [Obsolete("")]
        [DllImport("swscale-5", EntryPoint = "sws_addVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_alloc_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_allocVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SwsVector* sws_allocVec(int @length);
        
        [Obsolete("")]
        [DllImport("swscale-5", EntryPoint = "sws_cloneVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_convertPalette8ToPacked24", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="num_pixels">number of pixels to convert</param>
        /// <param name="palette">array with [256] entries, which must match color arrangement (RGB or BGR) of src</param>
        [DllImport("swscale-5", EntryPoint = "sws_convertPalette8ToPacked32", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void sws_convertPalette8ToPacked32(byte* @src, byte* @dst, int @num_pixels, byte* @palette);
        
        [Obsolete("")]
        [DllImport("swscale-5", EntryPoint = "sws_convVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_freeContext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void sws_freeContext(SwsContext* @swsContext);
        
        [DllImport("swscale-5", EntryPoint = "sws_freeFilter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void sws_freeFilter(SwsFilter* @filter);
        
        [DllImport("swscale-5", EntryPoint = "sws_freeVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_get_class", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern AVClass* sws_get_class();
        
        /// <summary>Check if context can be reused, otherwise reallocate a new one.</summary>
        [DllImport("swscale-5", EntryPoint = "sws_getCachedContext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_getCoefficients", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int* sws_getCoefficients(int @colorspace);
        
        /// <summary>Returns -1 if not supported</summary>
        [DllImport("swscale-5", EntryPoint = "sws_getColorspaceDetails", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <summary>Returns -1 if not supported</summary>
        [DllImport("swscale-5", EntryPoint = "sws_getColorspaceDetails", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int sws_getColorspaceDetails(SwsContext* @c, ref int* @inv_table, int* @srcRange, ref int* @table, int* @dstRange, int* @brightness, int* @contrast, int* @saturation);
        
        [Obsolete("")]
        [DllImport("swscale-5", EntryPoint = "sws_getConstVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_getContext", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_getDefaultFilter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_getGaussianVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SwsVector* sws_getGaussianVec(double @variance, double @quality);
        
        [Obsolete("")]
        [DllImport("swscale-5", EntryPoint = "sws_getIdentityVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern SwsVector* sws_getIdentityVec();
        
        /// <summary>Initialize the swscaler context sws_context.</summary>
        [DllImport("swscale-5", EntryPoint = "sws_init_context", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// <param name="pix_fmt">the pixel format</param>
        [DllImport("swscale-5", EntryPoint = "sws_isSupportedEndiannessConversion", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_isSupportedInput", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_isSupportedOutput", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_normalizeVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void sws_normalizeVec(SwsVector* @a, double @height);
        
        [Obsolete("")]
        [DllImport("swscale-5", EntryPoint = "sws_printVec2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_scale", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_scaleVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "sws_setColorspaceDetails", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("swscale-5", EntryPoint = "sws_shiftVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void sws_shiftVec(SwsVector* @a, int @shift);
        
        [Obsolete("")]
        [DllImport("swscale-5", EntryPoint = "sws_subVec", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("swscale-5", EntryPoint = "swscale_configuration", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string swscale_configuration();
        
        /// <summary>Return the libswscale license.</summary>
        [DllImport("swscale-5", EntryPoint = "swscale_license", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
        public static extern string swscale_license();
        
        /// <summary>Color conversion and scaling library.</summary>
        [DllImport("swscale-5", EntryPoint = "swscale_version", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
